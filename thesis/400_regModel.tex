...
\begin{align}
	...
	% \st: \quad & \sum_{o=1}^{n} P_{ot} C_{o\eta t} + P_{\eta t} I_{\eta t} = W_t L_{\eta t} + R_t K_{\eta t} + \Pi_{\eta t} \label{eq:reg-budget-constraint} \\
...
{\singlespacing
	...
	\begin{itemize}
		...
		\begin{enumerate}
			...
			%	\begin{align}
				%		\hat{Y}_t &= \int_{0}^{1} \hat{Y}_{jt} \dif j 
				%		\tag{\ref{eq:reg-ll-final-good-firm-bundle-rule}}
				%	\end{align}
