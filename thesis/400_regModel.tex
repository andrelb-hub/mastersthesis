...
\begin{align}
	...
	\quad & C_{\eta t} = C_{1\eta t}^{\omega_1} C_{2\eta t}^{1-\omega_1} \label{eq:reg-consumption-aggregation} \\
...
{\singlespacing
	...
	\begin{itemize}
		...
		\begin{enumerate}
			...
			\begin{align}
				P_{C\nu t} (C_{\eta t} + I_{\eta t}) = W_t L_{\eta t} + R_t K_{\eta t} + \Pi_{\nu t}
...
\begin{enumerate}
	\item Labor Supply:
	\begin{align}
		\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{-\sigma}} = \frac{W_t}{P_{C\nu t}} \implies \frac{\phi L_{\eta}^{\varphi}}{C_{\eta}^{-\sigma}} = \frac{W}{P} \label{eq:reg-ss-household-labor-supply}
	\end{align}
	...
	\begin{alignat}{2}
		...
		P^\ast &= \frac{\psi}{\psi-1} \cdot \frac{ Y_{\nu j} \Lambda_{\eta} / [1-\theta(1-R)]} {Y_{\nu j} / [1-\theta(1-R)]} &\implies \nonumber \\
...
\begin{align}
	...
	I = \delta K \implies I = \delta {\alpha_\nu} Y \frac{\Lambda}{R}
\end{align}
