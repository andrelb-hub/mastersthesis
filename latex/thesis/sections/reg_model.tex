...
\begin{align*}
	P_{\text{ss}}   &= 1; \\
	ZA1_{\text{ss}} &= 1; \\
	R_{\text{ss}}   &= \frac{1}{\beta} - 1; \\
	RK_{\text{ss}}  &= P_{\text{ss}} \left(\frac{1}{\beta} - (1 - \delta)\right); \\
	\Lambda_{\text{ss}} &= P_{\text{ss}} \frac{\psi - 1}{\psi}; \\
	W_{\text{ss}}   &= (1 - \alpha_1) \left(\Lambda_{\text{ss}} ZA1_{\text{ss}} \left(\frac{\alpha_1}{RK_{\text{ss}}}\right)^{\alpha_1}\right)^{\frac{1}{1 - \alpha_1}}; \\
	a1_{\text{ss}} &= \left(\frac{W_{\text{ss}}^{1 + \text{varp}} \omega_{11}^{\omega_{11}} (1 - \omega_{11})^{1 - \omega_{11}}}{\phi P_{\text{ss}} ((1 - \alpha) \Lambda_{\text{ss}})^{\text{varp}}}\right)^{\frac{1}{\sigma}}; \\
	a2_{\text{ss}} &= \left(\frac{W_{\text{ss}}^{1 + \text{varp}} \omega_{21}^{\omega_{21}} (1 - \omega_{21})^{1 - \omega_{21}}}{\phi P_{\text{ss}} ((1 - \alpha) \Lambda_{\text{ss}})^{\text{varp}}}\right)^{\frac{1}{\sigma}}; \\
	b1_{\text{ss}}  &= \delta \alpha_1 \Lambda_{\text{ss}} / RK_{\text{ss}}; \\
	b2_{\text{ss}}  &= \delta \alpha_2 \Lambda_{\text{ss}} / RK_{\text{ss}}; \\
	Y1_{\text{ss}}  &= \left(\frac{a1_{\text{ss}}}{1 - b1_{\text{ss}}}\right) \left(\frac{1}{\omega_{11}^{\omega_{11}} (1 - \omega_{11})^{1 - \omega_{11}}}\right)^{\frac{\sigma}{\sigma + \text{varp}}}; \\
	Y2_{\text{ss}}  &= \left(\frac{a2_{\text{ss}}}{1 - b2_{\text{ss}}}\right) \left(\frac{1}{\omega_{21}^{\omega_{21}} (1 - \omega_{21})^{1 - \omega_{21}}}\right)^{\frac{\sigma}{\sigma + \text{varp}}}; \\
\end{align*}

\begin{align*}
	I1_{\text{ss}}  &= b1_{\text{ss}} Y1_{\text{ss}}; \\
	I2_{\text{ss}}  &= b2_{\text{ss}} Y2_{\text{ss}}; \\
	C1_{\text{ss}}  &= a1_{\text{ss}} Y1_{\text{ss}}^{-\frac{\text{varp}}{\sigma}}; \\
	C2_{\text{ss}}  &= a2_{\text{ss}} Y2_{\text{ss}}^{-\frac{\text{varp}}{\sigma}}; \\
	E1_{\text{ss}}  &= \frac{P_{\text{ss}} C1_{\text{ss}}}{\omega_{11}^{\omega_{11}} (1 - \omega_{11})^{1 - \omega_{11}}}; \\
	E2_{\text{ss}}  &= \frac{P_{\text{ss}} C2_{\text{ss}}}{\omega_{21}^{\omega_{21}} (1 - \omega_{21})^{1 - \omega_{21}}}; \\
	C11_{\text{ss}} &= E1_{\text{ss}} \omega_{11} / P_{\text{ss}}; \\
	C21_{\text{ss}} &= E2_{\text{ss}} \omega_{21} / P_{\text{ss}}; \\
	C12_{\text{ss}} &= E1_{\text{ss}} (1 - \omega_{11}) / P_{\text{ss}}; \\
	C22_{\text{ss}} &= E2_{\text{ss}} (1 - \omega_{21}) / P_{\text{ss}}; \\
	K1_{\text{ss}}  &= \alpha_1 Y1_{\text{ss}} \Lambda_{\text{ss}} / RK_{\text{ss}}; \\
	K2_{\text{ss}}  &= \alpha_2 Y2_{\text{ss}} \Lambda_{\text{ss}} / RK_{\text{ss}}; \\
	L1_{\text{ss}}  &= (1 - \alpha_1) Y1_{\text{ss}} \Lambda_{\text{ss}} / W_{\text{ss}}; \\
	L2_{\text{ss}}  &= (1 - \alpha_2) Y2_{\text{ss}} \Lambda_{\text{ss}} / W_{\text{ss}};
\end{align*}
