...
\begin{alignat}{2}
	...
	C_{\eta \nu t} &= C_{\eta t} \left[ \frac{P_{\eta t}}{P_{\nu t}} \cdot \frac{1 -\omega_{\eta}}{\omega_{\eta}} \right]^{\omega_{\eta}} \label{eq:reg-C2-Cn}
\end{alignat}
...
\begin{alignat}{2}
	...
	C_{\eta \eta t} &= C_{\eta t} \left[ \frac{P_{\eta t}}{P_{\nu t}} \cdot \frac{1 -\omega_{\eta}}{\omega_{\eta}} \right]^{\omega_{\eta} -1} \label{eq:reg-C1-Cn}
\end{alignat}
...
\begin{align}
	...
	\te &= C_{\eta t} \left[ \frac{P_{\eta t}}{\omega_{\eta}} \right]^{\omega_{\eta}} \left[ \frac{P_{\nu t}}{1 -\omega_{\eta}} \right]^{1 -\omega_{\eta}} \label{eq:reg-price-eta-level}
\end{align}

Equation \ref{eq:reg-price-eta-level} show that the total expense with goods is proportional to the goods' prices $P_{\eta t}$ and $P_{\nu t}$.

Rewrite \ref{eq:reg-C2-Cn} in terms of \ref{eq:reg-price-eta-level}:
\begin{alignat}{2}
	C_{\eta \nu t} &= C_{\eta t} \left[ \frac{P_{\eta t}}{P_{\nu t}} \cdot \frac{1 -\omega_{\eta}}{\omega_{\eta}} \right]^{\omega_{\eta}} &\implies \tag{\ref{eq:reg-C2-Cn}} \\
	...
	C_{\eta \nu t} &= \te \frac{1 -\omega_{\eta}}{P_{\nu t}} \label{eq:reg-C2-Cn-2}
\end{alignat}

Rewrite \ref{eq:reg-C1-Cn} in terms of \ref{eq:reg-price-eta-level} and isolate $(\sfrac{\omega_{\eta}}{P_{\eta t} C_{\eta \eta t}})$:
	\begin{alignat}{2}
		C_{\eta \eta t} &= C_{\eta t} \left[ \frac{P_{\eta t}}{P_{\nu t}} \cdot \frac{1 -\omega_{\eta}}{\omega_{\eta}} \right]^{\omega_{\eta} -1} &\implies \tag{\ref{eq:reg-C1-Cn}} \\
		...
		\frac{\omega_{\eta}}{P_{\eta t} C_{\eta \eta t}} = \frac{1}{\te} \label{eq:reg-C1-Cn-2}
	\end{alignat}
...
\begin{align}
	P_t = \vartheta_{1} P_{1 t} + (1 -\vartheta_{1}) P_{2 t}
...
\begin{align}
	& Y_t = \sum_{\eta=1}^{2} Y_{\eta t} \label{eq:reg-market-clearing-condition-Yt} \\
	\text{where:} \quad & Y_{\eta t} = \sum_{\nu=1}^{2} C_{\eta \nu t} + I_{\eta t} \label{eq:reg-total-yn} \\
	& L_{\eta t} = \int_{0}^{1} L_{\eta jt} \dif j \label{eq:reg-market-clearing-condition-Yt-Lt}
\end{align}
...
{\singlespacing
	...
	\begin{enumerate}
		...
		\begin{align}
			C_{\eta \eta t} &= \te \frac{\omega_{\eta}}{P_{\eta t}} \tag{\ref{eq:reg-C1-Cn-2}}
		\end{align}

		\item Regional Consumption of good 2:
		\begin{align}
			C_{\eta \nu t} &= \te \frac{1 -\omega_{\eta}}{P_{\nu t}} \tag{\ref{eq:reg-C2-Cn-2}}
		\end{align}
...
\end{comment}
		...
		\begin{align}
			\te &= C_{\eta t} \left[ \frac{P_{\eta t}}{\omega_{\eta}} \right]^{\omega_{\eta}} \left[ \frac{P_{\nu t}}{1 -\omega_{\eta}} \right]^{1 -\omega_{\eta}} \tag{\ref{eq:reg-price-eta-level}}
		\end{align}
		...
		\begin{align}
			P_t = \vartheta_{1} P_{1 t} + (1 -\vartheta_{1}) P_{2 t} \tag{\ref{eq:national-price-level}}
		\end{align}
		...
		\begin{align}
			Y_t = \sum_{\eta=1}^{2} Y_{\eta t} \tag{\ref{eq:reg-market-clearing-condition-Yt}}
		\end{align}
...
\begin{enumerate}
	...
	\item Regional Consumption of good 1:
	\begin{align}
		C_{\eta \eta t} &= \te \frac{\omega_{\eta}}{P_{\eta t}} \implies \tag{\ref{eq:reg-C1-Cn-2}} \\
		C_{\eta \eta} &= \te \frac{\omega_{\eta}}{P_{\eta}} \label{eq:reg-ss-C1-Cn-2}
	\end{align}

	\item Regional Consumption of good 2:
	\begin{align}
		C_{\eta \nu t} &= \te \frac{1 -\omega_{\eta}}{P_{\nu t}} \implies \tag{\ref{eq:reg-C2-Cn-2}} \\
...
\end{comment}
	...
	\item Price Composition of Consumption Bundle:
	\begin{align}
		\te &= C_{\eta t} \left[ \frac{P_{\eta t}}{\omega_{\eta}} \right]^{\omega_{\eta}} \left[ \frac{P_{\nu t}}{1 -\omega_{\eta}} \right]^{1 -\omega_{\eta}} \implies \tag{\ref{eq:reg-price-eta-level}} 
		\\
	...
	\item National Price Level:
	\begin{align}
		P_t = \vartheta_{1} P_{1 t} + (1 -\vartheta_{1}) P_{2 t} \implies P = \vartheta_{1} P_{1} + (1 -\vartheta_{1}) P_{2} \label{eq:ss-national-price-level}
	\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	The results of \ref{eq:reg-ss-total-y1} and \ref{eq:reg-ss-total-y2} determines $C_{\eta}, I_{\eta} , C_{\eta \eta}, C_{\eta \nu}, K_{\eta}, L_{\eta}$ in \ref{eq:reg-ss-consumption}, \ref{eq:reg-ss-investment}, \ref{eq:reg-ss-C1-Cn-2}, \ref{eq:reg-ss-C2-Cn-2}, \ref{eq:reg-ss-int-good-firm-FOC-Kt-2} and \ref{eq:reg-ss-int-good-firm-FOC-Lt-2}, respectively.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Log-linearize \ref{eq:reg-gross-inflation-rate} and define the level deviation of regional inflation rate $\widetilde{\pi}_{\eta t}$:
	\begin{align}
		\pi_{\eta t} &= \frac{P_{\eta t}}{P_{\eta, t-1}} \tag{\ref{eq:regional-inflation}} \\
		\widetilde{\pi}_{\eta t} &= \hat{P}_{\eta t} - \hat{P}_{\eta, t-1}
...
\begin{comment}
	...
	\begin{alignat}{2}
		\frac{\psi}{\psi-1} &\E \sum_{s=0}^{\infty} \left\{ \frac{\theta^s Y_{\nu j,t+s} \Lambda_{\eta t+s}}{ (1 + R)^s \left( 1 + \frac{1}{1 + R} \sum_{k=0}^{s-1} \widetilde{R}_{t+k} \right)} \right\} & \implies \nonumber \\
	...
	\begin{alignat}{2}
		& \Lambda_{\eta t} = Z_{A\nu t}^{-1} \frac{R_{Kt}^{{\alpha_{\eta}}} W_t^{1-{\alpha_{\eta}}}}{ {\alpha_{\eta}}^{{\alpha_{\eta}}} (1-{\alpha_{\eta}})^{1-{\alpha_{\eta}}}} \implies \tag{\ref{eq:reg-int-good-firm-MC-2}} \\
		& \Lambda (1+ \hat{\Lambda}_t) = \frac{1}{Z_{A\eta}} \left( \frac{R}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W}{1-{\alpha_{\eta}}} \right)^{1-{\alpha_{\eta}}} (1- \hat{Z}_{A\nu t} + {\alpha_{\eta}} \hat{R}_t + (1- {\alpha_{\eta}}) \hat{W}_t ) \implies \nonumber \\
	...
	\begin{alignat}{2}
		\hat{\Lambda}_t &= {\alpha_{\eta}} \hat{R}_t + (1- {\alpha_{\eta}}) \hat{W}_t - \hat{Z}_{A\nu t} &\implies \nonumber \\
		\hat{P}_t + \hat{\lambda}_t &= {\alpha_{\eta}} \hat{R}_t + (1- {\alpha_{\eta}}) \hat{W}_t - \hat{Z}_{A\nu t} &\implies \nonumber \\
	...
	\begin{alignat}{2}
		Y_{\nu jt} &= Z_{A\nu t} K_{\nu jt}^{\alpha_{\eta}} L_{\eta jt}^{1-{\alpha_{\eta}}} &\implies \tag{\ref{eq:reg-int-good-firm-production-function}} \\
		Y_{j} (1+ \hat{Y}_{jt}) &= Z_{A\eta} K_{j}^{\alpha_{\eta}} L_{j}^{1-{\alpha_{\eta}}} (1+ \hat{Z}_{A\nu t} + {\alpha_{\eta}} \hat{K}_{jt} + (1-{\alpha_{\eta}}) \hat{L}_{jt}) \quad &\implies \nonumber \\
		\hat{Y}_{jt} &= \hat{Z}_{A\nu t} + {\alpha_{\eta}} \hat{K}_{jt} + (1-{\alpha_{\eta}}) \hat{L}_{jt} \label{eq:reg-ll-int-good-firm-production-function}
	\end{alignat}
	...
	\begin{alignat}{2}
		...
		\hat{Y}_t &= \int_{0}^{1} \left[ \hat{Z}_{A\nu t} + {\alpha_{\eta}} \hat{K}_{jt} + (1-{\alpha_{\eta}}) \hat{L}_{jt} \right] \dif j &\implies \nonumber \\
		\hat{Y}_t &= \hat{Z}_{A\nu t} + {\alpha_{\eta}} \int_{0}^{1} \hat{K}_{jt} \dif j + (1-{\alpha_{\eta}}) \int_{0}^{1} \hat{L}_{jt} \dif j \label{eq:reg-ll-final-goods-firm-bundle-rule-2}
	\end{alignat}
	...
	\begin{align}
		...
		\hat{Y}_t &= \hat{Z}_{A\nu t} + {\alpha_{\eta}} \int_{0}^{1} \hat{K}_{jt} \dif j + (1-{\alpha_{\eta}}) \int_{0}^{1} \hat{L}_{jt} \dif j \implies \\
		\hat{Y}_t &= \hat{Z}_{A\nu t} + {\alpha_{\eta}} \hat{K}_t + (1-{\alpha_{\eta}}) \hat{L}_t \label{eq:reg-ll-final-goods-firm-bundle-rule-3}
	\end{align}
	...
	\begin{alignat}{2}
		K_{\nu jt} &= {\alpha_{\eta}} Y_{\nu jt} \frac{\Lambda_{\eta t}}{R_{Kt}} &\implies \tag{\ref{eq:reg-int-good-firm-FOC-Kt}} \\
	...
	\begin{alignat}{2}
		L_{\eta jt} &= (1-{\alpha_{\eta}}) Y_{\nu jt} \frac{\Lambda_{\eta t}}{W_t} &\implies \tag{\ref{eq:reg-int-good-firm-FOC-Lt}} \\
	...
	\begin{alignat}{2}
		\ln{Z_{A\nu t}} &= (1-\rho_{A\eta})\ln{Z_{A\eta}} + \rho_{A\eta}\ln{Z_{A\nu,t-1}} + \varepsilon_{A\nu t} &\implies \tag{\ref{eq:reg-productivity-shock}} \\
		\ln{Z_{A\eta}} + \hat{Z}_{A\nu t} &= (1-\rho_{A\eta}) \ln{Z_{A\eta}} + \rho_{A\eta} (\ln{Z_{A\eta}} + \hat{Z}_{A,t-1}) + \varepsilon_{A\eta} \quad &\implies \nonumber \\
		\hat{Z}_{A\nu t} &= \rho_{A\eta} \hat{Z}_{A,t-1} + \varepsilon_{A\eta} \label{eq:reg-ll-productivity-shock}
	\end{alignat}
