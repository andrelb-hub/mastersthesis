...
\begin{align}
	P_t = \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t}
	\label{eq:national-price-level}
\end{align}

where $\theta_{P1}$ and $(1-\theta_{P1})$ are the price level weights in the national price level of regions $1$ and $2$, respectively.
...
\end{comment}
		...
		\begin{align}
			P_t = \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t} \tag{\ref{eq:national-price-level}}
		\end{align}
...
\end{comment}
	...
	\item National Price Level:
	\begin{align}
		P_t = \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t} \implies P = \theta_{P1} P_{1} + (1 -\theta_{P1}) P_{2} \label{eq:ss-national-price-level}
	\end{align}
...
For the steady state solution, all endogenous variables will be determined with respect to the parameters. It's assumed that the regional price and the productivity levels are normalized to one: $\langle \begin{smallmatrix} P_{1} & P_{2} & Z_{A1} & Z_{A2} \rangle \end{smallmatrix} = \vec{\bm{1}}$.\footnote{where $\vec{\bm{1}}$ is the unit vector.}
...
\begin{align}
	P &= \theta_{P1} P_{1} + (1 -\theta_{P1}) P_{2} \implies \theta_{P1} P_{1} + (1 -\theta_{P1}) P_{1} \implies \tag{\ref{eq:ss-national-price-level}} \\
	P &= P_{1} = P_{2}
\end{align}
...
\begin{align}
	\langle \begin{matrix} \pi & \pi_{\eta} \end{matrix} \rangle  = \vec{\bm{1}}
\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{align}
		\vec{\bm{1}} &= \langle \begin{matrix} P & P_{\eta} & Z_{A\eta} & Z_{M} & \pi & \pi_{\eta} \end{matrix} \rangle \label{eq:reg-unity-vector}
		\\
		...
		\\
		\Lambda_{\eta} &= P_{} \frac{\psi-1}{\psi} \tag{\ref{eq:reg-ss-marginal-cost}}
		\\
		...
		\\
		a_{\eta} &= \left[ \frac{W^{1 +\varphi} \omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}}{\phi P_{} \left[ (1 -\alpha_{\eta}) \Lambda_{\eta} \right]^{\varphi}} \right]^{\frac{1}{\sigma}} \tag{\ref{eq:reg-ss-a-eta}}
		\\
		...
		\\
		C_{\eta 1} &= \te \frac{\omega_{\eta 1}}{P_{1}} \tag{\ref{eq:reg-ss-C1-Cn-2}}
		\\
		C_{\eta 2} &= \te \frac{1 -\omega_{\eta 1}}{P_{2}} \tag{\ref{eq:reg-ss-C2-Cn-2}}
		\\
...
\begin{alignat}{2}
	...
	\hat{P}_{t} &= \theta_{P1} \hat{P}_{1t} + (1 -\theta_{P1}) \hat{P}_{2t} \label{eq:ll-national-price-level}
\end{alignat}
...
\end{comment}
		...
		\item National Price Level
		\begin{alignat}{2}
			\hat{P}_{t} &= \theta_{P1} \hat{P}_{1t} + (1 -\theta_{P1}) \hat{P}_{2t} \tag{\ref{eq:ll-national-price-level}}
		\end{alignat}
