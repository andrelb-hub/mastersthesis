...
{\singlespacing
	...
	\begin{itemize}
		...
		\item from the household problem: $C_{\eta t}, C_{\eta 1 t}, C_{\eta 2 t}, L_{\eta t}, B_{\eta t}, K_{\eta, t+1}, \te$;
...
\begin{align}
	...
	R_K &= P_{} \left[ \frac{1}{\beta} - (1-\delta) \right] \label{eq:reg-ss-RK}
\end{align}
...
\begin{align}
	...
	\Lambda_{\eta} &= P_{} \frac{\psi-1}{\psi} \label{eq:reg-ss-marginal-cost}
\end{align}
...
\end{align}
	...
	\begin{align}
		...
		& \text{where:} \quad a_{\eta} = \left[ \frac{W^{1 +\varphi} \omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}}{\phi P_{} \left[ (1 -\alpha_{\eta}) \Lambda_{\eta} \right]^{\varphi}} \right]^{\frac{1}{\sigma}} \label{eq:reg-ss-a-eta}
	\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{align}
		...
		\\
		a_{\eta} &= \left[ \frac{W^{1 +\varphi} \omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}}{\phi P_{\eta} \left[ (1 -\alpha_{\eta}) \Lambda_{\eta} \right]^{\varphi}} \right]^{\frac{1}{\sigma}} \tag{\ref{eq:reg-ss-a-eta}}
		\\
		...
		\\
		\te[] &= \frac{P_{\eta} C_{\eta}}{\omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}} \tag{\ref{eq:reg-ss-te}}
		\\
		C_{\eta 1} &= \te \frac{\omega_{\eta 1}}{P_{\eta}} \tag{\ref{eq:reg-ss-C1-Cn-2}}
		\\
		C_{\eta 2} &= \te \frac{1 -\omega_{\eta 1}}{P_{\nu}} \tag{\ref{eq:reg-ss-C2-Cn-2}}
		\\
...
Define the regional weights $\left[ \begin{smallmatrix} \theta_{Y1} & (1-\theta_{Y1}) \end{smallmatrix} \right] $ in the production total:
\begin{align}
	\begin{bmatrix}
		\theta_{Y1} & (1-\theta_{Y1})
	\end{bmatrix} \coloneq 
...
Define the consumption and investment weights $\left[ \begin{smallmatrix} \theta_{C\eta 1} & \theta_{C\eta 2} & (1 - \theta_{C\eta 1} - \theta_{C\eta 2}) \end{smallmatrix} \right] $ in the regional production:
\begin{align}
	\label{eq:reg-ss-C-I-weight-in-Y}
	\begin{bmatrix}
		\theta_{C\eta 1} & \theta_{C\eta 2} & (1 - \theta_{C\eta 1} - \theta_{C\eta 2})
	\end{bmatrix} \coloneq 
	\begin{bmatrix}
		\frac{C_{\eta 1}}{Y_{\eta}} & \frac{C_{\eta 2}}{Y_{\eta}} & \frac{I_{\eta}}{Y_{\eta}}
	\end{bmatrix}
\end{align}
...
\begin{itemize}
	...
	\[
	\begin{matrix}
		\hat{C}_{\eta} & \hat{C}_{\eta 1} & \hat{C}_{\eta 2} & \hat{L}_{\eta} & \hat{K}_{\eta} & \hat{\mathscr{E}}_{\eta} & \hat{Y} & \hat{Y}_{\eta} & \hat{P} & \hat{P}_{\eta} \\ \hat{I}_{\eta} & \hat{R} & \hat{R}_{K} & \hat{W} & \hat{\pi} & \hat{\pi}_{\eta} & \hat{\lambda}_{\eta} & \hat{Z}_{A\eta} & \hat{Z}_M &
	\end{matrix} 
	\]
