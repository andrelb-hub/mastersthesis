...
\begin{align}
	...
	\frac{K_{\eta jt}}{L_{\eta jt}} = \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_{\eta t}}{R_{Kt}} \label{eq_v5:reg-int-good-firm-TMRS}
\end{align}
...
\begin{alignat}{2}
	...
	K_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_{\eta t}}{R_{Kt}}\right]^{1-\alpha_{\eta}} \label{eq_v5:reg-int-good-firm-Kt-demand}
\end{alignat}
...
\begin{alignat}{2}
	...
	L_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_{\eta t}}{R_{Kt}}\right]^{-{\alpha_{\eta}}} \label{eq_v5:reg-int-good-firm-Lt-demand}
\end{alignat}
...
\begin{alignat}{2}
	...
	TC_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_{\eta t}}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \label{eq_v5:reg-int-good-firm-TC}
\end{alignat}
...
\begin{align}
	...
	\Lambda_{\eta jt} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_{\eta t}}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \label{eq_v5:reg-int-good-firm-MC}
\end{align}
...
The model is composed of the preview solutions, forming a square system of 34 variables and \colorbox{yellow}{32 (profit definition missing?)} equations, summarized as follows:
...
\begin{comment}
	...
	\item Labor Demand:
	\begin{align}
		L_{\eta jt} = (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{\eta t}} \tag{\ref{eq_v5:reg-int-good-firm-FOC-Lt}}
	\end{align}
	
	\begin{align}
		\Lambda_{\eta t} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_{\eta t}}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \tag{\ref{eq_v5:reg-int-good-firm-MC-2}}
	\end{align}
...
\end{comment}
	...
	\item Labor Demand:
	\begin{align}
		L_{\eta jt} = (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{\eta t}} \implies L_{\eta j} = (1 -{\alpha_{\eta}}) Y_{\eta j} \frac{\Lambda_{\eta}}{W} \label{eq_v5:reg-ss-int-good-firm-FOC-Lt}
	\end{align}
	
	\item Marginal Cost:
	\begin{align}
		\Lambda_{\eta t} &= \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_{\eta t}}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \implies \nonumber \\
