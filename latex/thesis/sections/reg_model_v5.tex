...
\subsection{Regional New Keynesian Model}\label{sec_v5:nk-model}
...
\subsubsection*{Regions}\label{sec_v5:regions}
...
\begin{align}
	\max_{C_{\eta t}, L_{\eta t}, B_{\eta t}, K_{\eta, t+1}}: \quad & U_{\eta}(C_{\eta t},L_{\eta t}) = \E \sum_{t=0}^{\infty} \beta^t \left(\frac{C_{\eta t}^{1-\sigma}}{1-\sigma} - \phi \frac{L_{\eta t}^{1+\varphi}}{1+\varphi} \right) \label{eq_v5:reg-utility-function-0} 
	\\
	\begin{split}
		\st: \quad & P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} + B_{\eta t} = \\ & \quad = W_t L_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t}
...
The maximization problem with restrictions can be transformed into one without restriction using the Lagrangian function $\mathcal{L}$ formed by \ref{eq_v5:reg-utility-function} and \ref{eq_v5:reg-budget-constraint}:
\begin{align}
	\begin{split}
	& \mathcal{L} = \mathbb{E}_t \sum_{t=0}^{\infty} \beta^t \left\{ \left( \frac{ \left[ C_{\eta 1 t}^{\omega_{\eta 1}} C_{\eta 2 t}^{1-\omega_{\eta 1}} \right]^{1 -\sigma}}{1 -\sigma} - \phi \frac{L_{\eta t}^{1+\varphi}}{1+\varphi} \right) \right. - \\ & \qquad - \mu_t \Big[ P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} + B_{\eta t} - \\ & \qquad \qquad \left. - ( W_t L_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t} ) \Big] \right\} \label{eq_v5:reg-household-lagrangian}
	\end{split}
\end{align}
...
\begin{align}
	C_{\eta 1 t}: \quad & \mu_t = \frac{\omega_{\eta 1} C_{\eta 1 t}^{\omega_{\eta 1} (1 -\sigma) -1} C_{\eta 2 t}^{(1 -\omega_{\eta 1})(1 -\sigma)}}{P_{1 t}} = \frac{\omega_{\eta 1}}{P_{1 t} C_{\eta 1 t}} C_{\eta t}^{1 -\sigma} \label{eq_v5:reg-FOC-C1-eta-t} 
	\\
	C_{\eta 2 t}: \quad & \mu_t = \frac{(1 -\omega_{\eta 1}) C_{\eta 1 t}^{\omega_{\eta 1} (1 -\sigma)} C_{\eta 2 t}^{(1 -\omega_{\eta 1})(1 -\sigma)-1}}{P_{2 t}} = \frac{(1 -\omega_{\eta 1})}{P_{2 t} C_{\eta 2 t}} C_{\eta t}^{1 -\sigma} \label{eq_v5:reg-FOC-C-2-eta-t} 
	\\
	L_{\eta t}: \quad & -\phi L_{\eta t}^{\varphi} +\mu_t W_t = 0 \implies \mu_t = \frac{\phi L_{\eta t}^{\varphi}}{W_t} \label{eq_v5:reg-household-FOC-Lt} 
	\\
	\begin{split}
	...
	\\
	\begin{split}
		\mu_t: \quad & P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} + B_{\eta t} = \\ & \qquad = W_t L_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t}
...
\begin{align}
	\te = P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} \label{eq_v5:reg-total-expense}
\end{align}
...
\begin{align}
	...
	\te &= C_{\eta t} \left[ \frac{P_{1 t}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2 t}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} \label{eq_v5:reg-total-expense-level}
\end{align}
...
\begin{alignat}{2}
	...
	C_{\eta 2 t} &= \te \frac{1 -\omega_{\eta 1}}{P_{2 t}} \label{eq_v5:reg-Cn-Cv-2}
\end{alignat}

Rewrite \ref{eq_v5:reg-Cn-Cn} in terms of \ref{eq_v5:reg-total-expense-level} and isolate $(\sfrac{\omega_{\eta 1}}{P_{1 t} C_{\eta 1 t}})$:
	\begin{alignat}{2}
		...
		\frac{\omega_{\eta 1}}{P_{1 t} C_{\eta 1 t}} = \frac{1}{\te} \label{eq_v5:reg-Cn-Cn-2}
	\end{alignat}
...
\begin{align}
	\mu_t &= \frac{\omega_{\eta 1}}{P_{1 t} C_{\eta 1 t}} C_{\eta t}^{1 -\sigma} \tag{\ref{eq_v5:reg-FOC-C1-eta-t}} \implies \\
	\mu_t &= \frac{ C_{\eta t}^{1-\sigma}}{ \te}  \label{eq_v5:reg-FOC-C1-eta-t2}
\end{align}
...
\begin{align}
	...
	\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{1-\sigma}} &= \frac{W_t}{\te} \label{eq_v5:reg-labor-supply}
\end{align}
...
Substitute $\mu_t$ and $\mu_{t+1}$ from equation \ref{eq_v5:reg-FOC-C1-eta-t2} in \ref{eq_v5:reg-FOC-Bt}:
\begin{alignat}{2}
	\mu_t &= \beta (1 + R_{t}) \E{ \mu_{t+1}} &\implies \tag{\ref{eq_v5:reg-FOC-Bt}} 
	\\
	\frac{ C_{\eta t}^{1-\sigma}}{ \te} &= \beta (1 + R_{t}) \E \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{ \te[t+1]} \right\} \label{eq_v5:reg-bonds-euler-equation}
\end{alignat}

Equation \ref{eq_v5:reg-bonds-euler-equation} is the Euler equation for the bonds return.

Substitute $\mu_t$ and $\mu_{t+1}$ from equation \ref{eq_v5:reg-FOC-C1-eta-t2} in \ref{eq_v5:reg-household-FOC-Kt}:
\begin{alignat}{2}
	\mu_t P_{\eta t} &= \beta \mathbb{E}_t \{ \mu_{t+1} [(1-\delta) P_{\eta, t+1} + R_{K,t+1}] \} &\implies \tag{\ref{eq_v5:reg-household-FOC-Kt}} 
	\\
	\frac{ C_{\eta t}^{1-\sigma}}{ \te} P_{\eta t} &= \beta \mathbb{E}_t \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{ \te[t+1]} [(1-\delta) P_{\eta, t+1} + R_{K,t+1}] \right\} \label{eq_v5:reg-capital-euler-equation}
\end{alignat}
...
\begin{alignat}{2}
	...
	& K_{\eta jt} = {\alpha_{}} Y_{\eta jt} \frac{\Lambda_{\eta jt}}{R_{Kt}} \label{eq_v5:reg-int-good-firm-FOC-Kt} \\
	L_{\eta jt}: \quad & W_t - \Lambda_{\eta jt} Z_{A\eta t} K_{\eta jt}^{\alpha_{}} (1-{\alpha_{}}) L_{\eta jt}^{-{\alpha_{}}} = 0 \quad &&\implies \nonumber \\ 
	& L_{\eta jt} = (1-{\alpha_{}}) Y_{\eta jt} \frac{\Lambda_{\eta jt}}{W_t} \label{eq_v5:reg-int-good-firm-FOC-Lt} \\
	\Lambda_{\eta jt}: \quad & Y_{\eta jt} = Z_{A\eta t} K_{\eta jt}^{\alpha_{}} L_{\eta jt}^{1-{\alpha_{}}} \tag{\ref{eq_v5:reg-int-good-firm-production-function}}
\end{alignat}

\subsubsection*{Solutions}

Divide equation \ref{eq_v5:reg-int-good-firm-FOC-Kt} by \ref{eq_v5:reg-int-good-firm-FOC-Lt}:
\begin{align}
	\frac{K_{\eta jt}}{L_{\eta jt}} = \frac{{\alpha_{}} Y_{\eta jt} \Lambda_{\eta jt} /R_{Kt}}{(1-{\alpha_{}}) Y_{\eta jt} \Lambda_{\eta jt} /W_t} \implies
	\frac{K_{\eta jt}}{L_{\eta jt}} = \left( \frac{{\alpha_{}}}{1-{\alpha_{}}} \right) \frac{W_t}{R_{Kt}} \label{eq_v5:reg-int-good-firm-TMRS}
\end{align}

Equation \ref{eq_v5:reg-int-good-firm-TMRS} demonstrates the relationship between the technical marginal rate of substitution (TMRS) and the economical marginal rate of substitution (EMRS). 

Substitute $L_{\eta jt}$ from equation \ref{eq_v5:reg-int-good-firm-TMRS} in \ref{eq_v5:reg-int-good-firm-production-function}:
\begin{alignat}{2}
	...
	K_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{}}}{1-{\alpha_{}}} \right) \frac{W_t}{R_{Kt}}\right]^{1-{\alpha_{}}} \label{eq_v5:reg-int-good-firm-Kt-demand}
\end{alignat}

Equation \ref{eq_v5:reg-int-good-firm-Kt-demand} is the intermediate-goods firm demand for capital. 

Substitute \ref{eq_v5:reg-int-good-firm-Kt-demand} in \ref{eq_v5:reg-int-good-firm-TMRS}:
\begin{alignat}{2}
	...
	L_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{}}}{1-{\alpha_{}}} \right) \frac{W_t}{R_{Kt}}\right]^{-{\alpha_{}}} \label{eq_v5:reg-int-good-firm-Lt-demand}
\end{alignat}

Equation \ref{eq_v5:reg-int-good-firm-Lt-demand} is the intermediate-goods firm demand for labor.

\subsubsection*{Total and Marginal Costs}

Calculate the total cost $TC$ using \ref{eq_v5:reg-int-good-firm-Kt-demand} and \ref{eq_v5:reg-int-good-firm-Lt-demand}:
\begin{alignat}{2}
	...
	TC_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W_t}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \label{eq_v5:reg-int-good-firm-TC}
\end{alignat}

%%%%%

Calculate the marginal cost $\Lambda$ using \ref{eq_v5:reg-int-good-firm-TC}: 
\begin{align}
	\Lambda_{\eta jt} & = \frac{\partial TC_{\eta jt}}{\partial Y_{\eta jt}} \implies 
	\Lambda_{\eta jt} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W_t}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \label{eq_v5:reg-int-good-firm-MC}
\end{align}
...
\begin{comment}
	\begin{align}
		...
		P_{t} &= \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t} %\label{eq_v5:national-price-level}
	\end{align}
...
\subsubsection*{Productivity Shock} \label{sec_v5:reg-productivity-shock}
...
\begin{align}
	\ln{Z_{A\eta t}} = (1-\rho_{A\eta})\ln{Z_{A\eta}} + \rho_{A\eta}\ln{Z_{A\eta,t-1}} + \varepsilon_{A\eta t} \label{eq_v5:reg-productivity-shock}
\end{align}

where $\rho_{A\eta} \in [0,1]$ and $\varepsilon_{A\eta t} \sim \mathscr{N}(0,\sigma_{A\eta})$.

\subsubsection*{Monetary Shock} \label{sec_v5:reg-monetary-shock}
...
\begin{align}
	\ln{Z_{Mt}} = (1-\rho_M)\ln{Z_{M}} + \rho_M\ln{Z_{M,t-1}} + \varepsilon_{Mt} \label{eq_v5:reg-monetary-shock}
\end{align}
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black]
	...
	\begin{align}
		...
		& \text{where:} \quad Y_{\eta t} = C_{\eta t} + I_{\eta t} \label{eq_v5:reg-regional-demand} \\
...
\begin{align}
	Y_{t} &= Y_{1 t} + Y_{2 t} \label{eq_v5:reg-market-clearing-condition-Yt} \\
	& \text{where:} \quad Y_{\eta t} = C_{\eta 1 t} + C_{\eta 2 t} + I_{\eta t} \label{eq_v5:reg-regional-demand} \\
	L_{\eta t} &= \int_{0}^{1} L_{\eta jt} \dif j \label{eq_v5:reg-market-clearing-condition-Lt}
\end{align}
...
{\singlespacing
	...
	\begin{enumerate}
		...
		\begin{align}
		\begin{split}
			& P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} + P_{\eta t} I_{\eta t} + B_{\eta t} = \\ & \quad = W_t L_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t}
		\end{split} \tag{\ref{eq_v5:reg-budget-constraint}}
		\end{align}

		\item Law of Motion for Capital:
		\begin{align}
			K_{\eta, t+1} = (1-\delta)K_{\eta t} + I_{\eta t} \tag{\ref{eq_v5:reg-law-of-motion-for-capital}}
		\end{align}
		...
		\begin{comment}
			...
			\begin{align}
				C_{\eta 1 t} &= \te \frac{\omega_{\eta 1}}{P_{1 t}} \tag{\ref{eq_v5:reg-Cn-Cn-2}}
			\end{align}
			
			\item Regional Consumption of good 2:
			\begin{align}
				C_{\eta 2 t} &= \te \frac{1 -\omega_{\eta 1}}{P_{2 t}} \tag{\ref{eq_v5:reg-Cn-Cv-2}}
			\end{align}
		...
		\begin{align}
			\te &= C_{\eta t} \left[ \frac{P_{1 t}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2 t}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} \tag{\ref{eq_v5:reg-total-expense-level}}
		\end{align}

		\item Labor Supply:
		\begin{align}
			\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{1-\sigma}} = \frac{W_t}{\te} \tag{\ref{eq_v5:reg-labor-supply}}
		\end{align}

		\item Euler equation for the bonds return:
		\begin{align}
			\frac{ C_{\eta t}^{1-\sigma}}{ \te} &= \beta (1 + R_{t}) \E \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{ \te[t+1]} \right\} \tag{\ref{eq_v5:reg-bonds-euler-equation}}
		\end{align}
		
		\item Euler equation for the capital return:
		\begin{align}
			\frac{ C_{\eta t}^{1-\sigma}}{ \te} P_{\eta t} &= \beta \mathbb{E}_t \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{ \te[t+1]} [(1-\delta) P_{\eta, t+1} + R_{K,t+1}] \right\} \tag{\ref{eq_v5:reg-capital-euler-equation}}
		\end{align}
		...
		\begin{align}
			Y_{\eta jt} = Z_{A\eta t} K_{\eta jt}^{\alpha_{}} L_{\eta jt}^{1-{\alpha_{}}} \tag{\ref{eq_v5:reg-int-good-firm-production-function}}
		\end{align}
		
		\item Capital Demand:
		\begin{align}
			K_{\eta jt} = {\alpha_{}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} \tag{\ref{eq_v5:reg-int-good-firm-FOC-Kt}}
		\end{align}
		
		\item Labor Demand:
		\begin{align}
			L_{\eta jt} = (1-{\alpha_{}}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_t} \tag{\ref{eq_v5:reg-int-good-firm-FOC-Lt}}
		\end{align}
		
		\item Marginal Cost:
		\begin{align}
			\Lambda_{\eta t} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W_t}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \tag{\ref{eq_v5:reg-int-good-firm-MC-2}}
		\end{align}
		...
		\begin{align}
			P_{t} &= \frac{P_{1t} Y_{1t} + P_{2t} Y_{2t}}{Y_{t}} \tag{\ref{eq_v5:national-price-level}} % P_{t} = \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t}
		\end{align}
		...
		\begin{align}
			Y_{\eta t} = C_{\eta t} + I_{\eta t} \tag{\ref{eq_v5:reg-regional-demand}}
		\end{align}
...
\begin{enumerate}
	...
	\begin{align}
	\begin{split}
		& P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} + P_{\eta t} I_{\eta t} + B_{\eta t} = \\ & \quad = W_t L_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t} \implies
	\end{split} \tag{\ref{eq_v5:reg-budget-constraint}}
	\\
	& P_{1} C_{\eta 1} + P_{2} C_{\eta 2} + P_{\eta} I_{\eta} = W L_{\eta} + R_{K} K_{\eta} + R B_{\eta} + \Pi_{\eta} \label{eq_v5:reg-ss-budget-constraint}
	\end{align}
	...
	\begin{alignat}{2}
		...
		I_{\eta} &= \delta K_{\eta} \label{eq_v5:reg-ss-law-of-motion-for-capital}
	\end{alignat}
	...
	\begin{align}
		...
		\frac{P_{1} C_{\eta 1}}{\omega_{\eta 1}} &= \frac{P_{2} C_{\eta 2}}{1 -\omega_{\eta 1}} \label{eq_v5:reg-ss-Cn1-Cn2}
	\end{align}
...
\begin{comment}
	...
	\item Regional Consumption of good 1:
\begin{align}
	C_{\eta 1 t} &= \te \frac{\omega_{\eta 1}}{P_{1 t}} \implies \tag{\ref{eq_v5:reg-Cn-Cn-2}} \\
	C_{\eta 1} &= \te[] \frac{\omega_{\eta 1}}{P_{1}} \label{eq_v5:reg-ss-C1-Cn-2}
\end{align}

\item Regional Consumption of good 2:
\begin{align}
	C_{\eta 2 t} &= \te \frac{1 -\omega_{\eta 1}}{P_{2 t}} \implies \tag{\ref{eq_v5:reg-Cn-Cv-2}} \\
	C_{\eta 2} &= \te[] \frac{1 -\omega_{\eta 1}}{P_{2}} \label{eq_v5:reg-ss-C2-Cn-2}
\end{align}
...
\end{comment}
	...
	\item Price Composition of Consumption Bundle:
	\begin{align}
		\te &= C_{\eta t} \left[ \frac{P_{1 t}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2 t}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} \implies \tag{\ref{eq_v5:reg-total-expense-level}} 
		\\
		\te[] &= C_{\eta} \left[ \frac{P_{1}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} \label{eq_v5:reg-ss-price-eta-level}
	\end{align}

	\item Labor Supply:
	\begin{align}
		\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{1-\sigma}} &= \frac{W_t}{\te} \implies \tag{\ref{eq_v5:reg-labor-supply}} \\
		\frac{\phi L_{\eta}^{\varphi}}{C_{\eta}^{1-\sigma}} &= \frac{W}{\te[]} \label{eq_v5:reg-ss-household-labor-supply}
	\end{align}

	\item Euler equation for the bonds return:
	\begin{alignat}{2}
		\frac{ C_{\eta t}^{1-\sigma}}{ \te} &= \beta (1 + R_{t}) \E \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{ \te[t+1]} \right\} &\implies \tag{\ref{eq_v5:reg-bonds-euler-equation}} 
		\\
		\frac{ C_{\eta}^{1-\sigma}}{ \te[]} &= \beta (1 + R) \frac{ C_{\eta}^{1-\sigma}}{ \te[]} &\implies \nonumber 
		\\
		\beta &= \frac{1}{(1 + R)} \label{eq_v5:reg-ss-bonds-euler-equation}
	\end{alignat}

	\item Euler equation for the capital return:
	\begin{alignat}{2}
		\frac{ C_{\eta t}^{1-\sigma}}{ \te} P_{\eta t} &= \beta \mathbb{E}_t \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{ \te[t+1]} [(1-\delta) P_{\eta, t+1} + R_{K,t+1}] \right\} &\implies \tag{\ref{eq_v5:reg-capital-euler-equation}} \\
		\frac{ C_{\eta}^{1-\sigma}}{ \te[]} P_{\eta} &= \beta \frac{ C_{\eta}^{1-\sigma}}{ \te[]} P_{\eta} \left[ (1-\delta) + \frac{R_{K}}{P_{\eta}} \right] &\implies \nonumber \\
		1 &= \beta \left[ (1-\delta) + \frac{R_{K}}{P_{\eta}} \right] \label{eq_v5:reg-ss-capital-euler-equation}
	\end{alignat}
	...
	\item Production Function:
	\begin{align}
		Y_{\eta jt} = Z_{A\eta t} K_{\eta jt}^{\alpha_{}} L_{\eta jt}^{1-{\alpha_{}}} \implies Y_{\eta j} = Z_{A\eta} K_{\eta j}^{\alpha_{}} L_{\eta j}^{1-{\alpha_{}}} \label{eq_v5:reg-ss-int-good-firm-production-function}
	\end{align}
	
	\item Capital Demand:
	\begin{align}
		K_{\eta jt} = {\alpha_{}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} \implies K_{\eta j} = {\alpha_{}} Y_{\eta j} \frac{\Lambda_{\eta}}{R_K} \label{eq_v5:reg-ss-int-good-firm-FOC-Kt}
	\end{align}
	
	\item Labor Demand:
	\begin{align}
		L_{\eta jt} = (1-{\alpha_{}}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_t} \implies L_{\eta j} = (1 -{\alpha_{}}) Y_{\eta j} \frac{\Lambda_{\eta}}{W} \label{eq_v5:reg-ss-int-good-firm-FOC-Lt}
	\end{align}
	
	\item Marginal Cost:
	\begin{align}
		\Lambda_{\eta t} &= \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W_t}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \implies \nonumber \\
		\Lambda_{\eta} &= \frac{1}{Z_{A\eta}} \left( \frac{R_K}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \label{eq_v5:reg-ss-int-good-firm-MC-2}
	\end{align}
	...
	\begin{alignat}{2}
		...
		P_{\eta}^{\ast} &= \frac{\psi}{\psi-1} \Lambda_{\eta} \label{eq_v5:reg-ss-int-good-firm-optimal-price-FOC-3}
	\end{alignat}
	...
	\begin{alignat}{2}
		...
		(1-\theta) P_{\eta}^{1-\psi} &= (1-\theta) P_{\eta}^{\ast 1-\psi} &&\implies P_{\eta} = P_{\eta}^{\ast} \label{eq_v5:reg-ss-general-price-level}
	\end{alignat}
	
	\item Monetary Policy:
	\begin{align}
		\label{eq_v5:reg-ss-monetary-policy}
		\frac{R_{t}}{R} =
		\left( \frac{R_{t-1}}{R} \right)^{\gamma_R}  \left[
		\left( \frac{\pi_t}{\pi} \right)^{\gamma_\pi}
		\left( \frac{Y_{t}}{Y} \right)^{\gamma_Y} \right]^{1-\gamma_R} Z_{Mt}
	...
	\item National Gross Inflation Rate:
	\begin{align}
		\pi_t = \frac{P_t}{P_{t-1}} \implies \pi = 1 \label{eq_v5:reg-ss-gross-inflation-rate}
	\end{align}
	
	\item National Price Level:
	\begin{align}
		P_t &= \frac{P_{1t} Y_{1t} + P_{2t} Y_{2t}}{Y_{t}} \implies P = \frac{P_{1} Y_{1} + P_{2} Y_{2}}{Y_{}} \label{eq_v5:ss-national-price-level} % P_{t} = \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t} \implies P = \theta_{P1} P_{1} + (1 -\theta_{P1}) P_{2} 
	\end{align}
	
	\item Regional Gross Inflation Rate:
	\begin{align}
		\pi_{\eta t} = \frac{P_{\eta t}}{P_{\eta, t-1}} \implies \pi_{\eta} = 1 \label{eq_v5:ss-regional-inflation}
	\end{align}
	...
	\item Market Clearing Condition:
	\begin{align}
		Y_{t} &= Y_{1 t} + Y_{2 t} \implies \tag{\ref{eq_v5:reg-market-clearing-condition-Yt}} \\
		Y &= Y_{1} + Y_{2} \label{eq_v5:reg-ss-market-clearing-condition}
	\end{align}
	
	\item Regional Market Clearing Condition:
	\begin{align}
		Y_{\eta t} &= C_{\eta t} + I_{\eta t} \implies \tag{\ref{eq_v5:reg-regional-demand}} \\
		Y_{\eta} &= C_{\eta} + I_{\eta} \label{eq_v5:reg-ss-total-yn}
	\end{align}
...
\subsubsection{Variables at Steady State}
	...
	\begin{align}
		\langle \begin{matrix} P_{1} & Z_{A1} & Z_{A2} \end{matrix} \rangle = \vec{\bm{1}} \label{eq_v5:reg-ss-p1-za1}
	\end{align}
	
	From \ref{eq_v5:reg-ss-monetary-policy}, \ref{eq_v5:reg-ss-gross-inflation-rate} and \ref{eq_v5:ss-regional-inflation}, the monetary shock, the national and regional gross inflation rates are:
	\begin{align}
...
\begin{alignat}{2}
	\Lambda_{\eta} &= \frac{1}{Z_{A\eta}} \left( \frac{R_K}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} &\implies \tag{\ref{eq_v5:reg-ss-int-good-firm-MC-2}} \\ 
	W &= (1-{\alpha_{}}) \left[ \Lambda_{} Z_{A1} \left( \frac{{\alpha_{}}}{R_K} \right)^{{\alpha_{}}} \right]^\frac{1}{1-{\alpha_{}}} & \label{eq_v5:reg-ss-nominal-wage}
\end{alignat}
...
\begin{comment}
	...
	\begin{align}
		\Lambda_{\eta} &= \frac{1}{Z_{A\eta}} \left( \frac{R_K}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \implies \tag{\ref{eq_v5:reg-ss-int-good-firm-MC-2}} \\
		Z_{A2} &= \frac{1}{\Lambda_{}} \left( \frac{R_K}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \label{eq_v5:reg-ss-za2}
	\end{align}
\end{comment}

Due to price parity in steady state, where prices are identical ($P_{\eta} = P_{\eta}^{\ast}$) and resulting in a gross inflation level of one ($\pi_{\eta} = 1$), all firms produce the same output level ($Y_{\eta j} = Y_{\eta}$) \cite[Lecture 13, p.12]{solis-garcia_ucb_2022}. As a consequence, they uniformly demand the same amount of factors ($K_{\eta}, L_{\eta}$), and equations \ref{eq_v5:reg-ss-int-good-firm-production-function}, \ref{eq_v5:reg-ss-int-good-firm-FOC-Kt} and \ref{eq_v5:reg-ss-int-good-firm-FOC-Lt} become: % In steady state, prices are the same ($P_{\eta} = P_{\eta}^{\ast}$), resulting in a gross inflation level of one ($\pi_{\eta} = 1$), and all firms producing the same output level ($Y_{\eta j} = Y_{\eta}$) due to the price parity \cite[Lecture 13, p.12]{solis-garcia_ucb_2022}. For this reason, they all demand the same amount of factors ($K_{\eta}, L_{\eta}$), and equations \ref{eq_v5:reg-ss-int-good-firm-production-function}, \ref{eq_v5:reg-ss-int-good-firm-FOC-Kt} and \ref{eq_v5:reg-ss-int-good-firm-FOC-Lt} become:
\begin{align}
	Y_{\eta} &= Z_{A\eta} K_{\eta}^{\alpha_{}} L_{\eta}^{1 -{\alpha_{}}} \label{eq_v5:reg-ss-int-good-firm-production-function-2} \\	
	K_{\eta} &= {\alpha_{}} Y_{\eta} \frac{\Lambda_{}}{R_K} \label{eq_v5:reg-ss-int-good-firm-FOC-Kt-2} \\
	L_{\eta} &= (1-{\alpha_{}}) Y_{\eta} \frac{\Lambda_{}}{W} \label{eq_v5:reg-ss-int-good-firm-FOC-Lt-2}
\end{align}
	
	Substitute \ref{eq_v5:reg-ss-int-good-firm-FOC-Kt-2} in \ref{eq_v5:reg-ss-law-of-motion-for-capital}:
	\begin{align}
		I_{\eta} &= \delta K_{\eta} \implies I_{\eta} = \delta {\alpha_{}} \frac{\Lambda_{}}{R_K} Y_{\eta} \implies \tag{\ref{eq_v5:reg-ss-law-of-motion-for-capital}} \\
		I_{\eta} &= b_{\eta} Y_{\eta} \label{eq_v5:reg-ss-investment} \\
		& \text{where:} \quad b_{\eta} = \delta {\alpha_{}} \frac{\Lambda_{}}{R_K} \label{eq_v5:reg-ss-b-eta}
	\end{align}
	...
	\begin{align}
		...
		& \text{where:} \quad a_{\eta} = \left[ \frac{W^{1 +\varphi} \omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}}{\phi P_{} \left[ (1 -\alpha_{}) \Lambda_{} \right]^{\varphi}} \right]^{\frac{1}{\sigma}} \label{eq_v5:reg-ss-a-eta}
	\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{align}
		...
		\\
		W &= (1-{\alpha_{}}) \left[ \Lambda_{} Z_{A1} \left( \frac{{\alpha_{}}}{R_K} \right)^{{\alpha_{}}} \right]^\frac{1}{1-{\alpha_{}}} \tag{\ref{eq_v5:reg-ss-nominal-wage}}
		\\ % Z_{A2} &= \frac{1}{\Lambda_{}} \left( \frac{R_K}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \tag{\ref{eq_v5:reg-ss-za2}}
		a_{\eta} &= \left[ \frac{W^{1 +\varphi} \omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}}{\phi P_{} \left[ (1 -\alpha_{}) \Lambda_{} \right]^{\varphi}} \right]^{\frac{1}{\sigma}} \tag{\ref{eq_v5:reg-ss-a-eta}}
		\\
		b_{\eta} &= \delta {\alpha_{}} \frac{\Lambda_{}}{R_K} \tag{\ref{eq_v5:reg-ss-b-eta}}
		\\
		...
		\\
		K_{\eta} &= {\alpha_{}} Y_{\eta} \frac{\Lambda_{}}{R_K} \tag{\ref{eq_v5:reg-ss-int-good-firm-FOC-Kt-2}}
		\\
		L_{\eta} &= (1-{\alpha_{}}) Y_{\eta} \frac{\Lambda_{}}{W} \tag{\ref{eq_v5:reg-ss-int-good-firm-FOC-Lt-2}}
	\end{align}
...
Log-linearize \ref{eq_v5:reg-Cn-Cn-2}:
\begin{alignat}{2}
	C_{\eta 1 t} &= \te \frac{\omega_{\eta 1}}{P_{1 t}} &\implies \tag{\ref{eq_v5:reg-Cn-Cn-2}} \\
	C_{\eta 1} (1 + \hat{C}_{\eta 1 t}) &= \mathscr{E}_{\eta} \frac{\omega_{\eta 1}}{P_{1}} (1 + \hat{\mathscr{E}}_{\eta t} - \hat{P}_{1 t}) &\implies \nonumber \\
	\hat{C}_{\eta 1 t} &= \hat{\mathscr{E}}_{\eta t} - \hat{P}_{1 t} \iff \hat{\mathscr{E}}_{\eta t} = \hat{C}_{\eta 1 t} + \hat{P}_{1 t} \label{eq_v5:reg-ll-Cn-Cn-2}
\end{alignat}

Log-linearize \ref{eq_v5:reg-Cn-Cv-2}:
\begin{alignat}{2}
	C_{\eta 2 t} &= \te \frac{1 - \omega_{\eta 1}}{P_{2 t}} &\implies \tag{\ref{eq_v5:reg-Cn-Cv-2}} \\
	C_{\eta 2} (1 + \hat{C}_{\eta 2 t}) &= \mathscr{E}_{\eta} \frac{1 - \omega_{\eta 1}}{P_{2}} (1 + \hat{\mathscr{E}}_{\eta t} - \hat{P}_{2 t}) &\implies \nonumber \\
	\hat{C}_{\eta 2 t} &= \hat{\mathscr{E}}_{\eta t} - \hat{P}_{2 t} \iff \hat{\mathscr{E}}_{\eta t} = \hat{C}_{\eta 2 t} + \hat{P}_{2 t} \label{eq_v5:reg-ll-Cn-Cv-2}
\end{alignat}

Match equations \ref{eq_v5:reg-ll-Cn-Cn-2} and \ref{eq_v5:reg-ll-Cn-Cv-2}:
\begin{align}
	\hat{\mathscr{E}}_{\eta t} = \hat{C}_{\eta 1 t} + \hat{P}_{1 t} &= \hat{C}_{\eta 2 t} + \hat{P}_{2 t} \implies \nonumber \\
	\hat{C}_{\eta 1 t} - \hat{C}_{\eta 2 t} &= \hat{P}_{2 t} - \hat{P}_{1 t} \label{eq_v5:reg-ll-regional-consumption-and-prices}
\end{align}

Equation \ref{eq_v5:reg-ll-regional-consumption-and-prices} shows that the variation of both goods consumption in each region correspond to the distance between the variations of the regional price  levels.	
...
\begin{alignat}{2}
	Y_{\eta jt} &= Z_{A\eta t} K_{\eta jt}^{\alpha_{}} L_{\eta jt}^{1-{\alpha_{}}} &\implies \tag{\ref{eq_v5:reg-int-good-firm-production-function}} \\
	...
	\hat{Y}_{\eta jt} &= \hat{Z}_{A\eta t} + {\alpha_{}} \hat{K}_{\eta jt} + (1-{\alpha_{}}) \hat{L}_{\eta jt} \label{eq_v5:reg-ll-int-good-firm-production-function}
\end{alignat}
...
\begin{alignat}{2}
	...
	\hat{Y}_{\eta t} &= \hat{Z}_{A\eta t} + {\alpha_{}} \int_{0}^{1} \hat{K}_{\eta jt} \dif j + (1-{\alpha_{}}) \int_{0}^{1} \hat{L}_{\eta jt} \dif j \label{eq_v5:reg-ll-final-goods-firm-bundle-rule-2}
\end{alignat}
...
\begin{align}
	...
	\hat{Y}_{\eta t} &= \hat{Z}_{A\eta t} + {\alpha_{}} \hat{K}_{\eta t} + (1-{\alpha_{}}) \hat{L}_{\eta t} \label{eq_v5:reg-ll-final-goods-firm-bundle-rule-3}
\end{align}
...
\begin{alignat}{2}
	K_{\eta jt} &= {\alpha_{}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} &\implies \tag{\ref{eq_v5:reg-int-good-firm-FOC-Kt}} \\
...
\begin{alignat}{2}
	L_{\eta jt} &= (1-{\alpha_{}}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{t}} &\implies \tag{\ref{eq_v5:reg-int-good-firm-FOC-Lt}} \\
...
\begin{alignat}{2}
	& \Lambda_{\eta t} = Z_{A\eta t}^{-1} \frac{R_{Kt}^{{\alpha_{}}} W_t^{1-{\alpha_{}}}}{{\alpha_{}}^{{\alpha_{}}} (1-{\alpha_{}})^{1-{\alpha_{}}}} \implies \tag{\ref{eq_v5:reg-int-good-firm-MC-2}} \\
	...
	& \hat{\Lambda}_{\eta t} = {\alpha_{}} \hat{R}_{Kt} + (1- {\alpha_{}}) \hat{W}_{t} - \hat{Z}_{A\eta t} \label{eq_v5:reg-ll-int-good-firm-MC-2}
\end{alignat}
...
\begin{alignat}{2}
	...
	\hat{\lambda}_{\eta t} &= {\alpha_{}} \hat{R}_{Kt} + (1- {\alpha_{}}) \hat{W}_{t} - \hat{Z}_{A\eta t} - \hat{P}_{\eta t} \label{eq_v5:reg-ll-int-good-firm-MC-3}
\end{alignat}
...
Log-linearize \ref{eq_v5:reg-regional-demand}:
\begin{align}
	Y_{\eta t} &= C_{\eta 1 t} + C_{\eta 2 t} + I_{\eta t} \implies \tag{\ref{eq_v5:reg-regional-demand}} \\
	Y_{\eta} (1 +\hat{Y}_{\eta t}) &= C_{\eta 1} (1 +\hat{C}_{\eta 1 t}) + C_{\eta 2} (1 +\hat{C}_{\eta 2 t}) + I_{\eta} (1 +\hat{I}_{\eta t}) \implies \nonumber \\
	\hat{Y}_{\eta t} &= \frac{C_{\eta 1}}{Y_{\eta}} \hat{C}_{\eta 1 t} + \frac{C_{\eta 2}}{Y_{\eta}} \hat{C}_{\eta 2 t} + \frac{I_{\eta}}{Y_{\eta}} \hat{I}_{\eta t} \label{eq_v5:reg-ll-total-yn}
\end{align}
...
\begin{align}
	\label{eq_v5:reg-ss-C-I-weight-in-Y}
...
Substitute \ref{eq_v5:reg-ss-C-I-weight-in-Y} in \ref{eq_v5:reg-ll-total-yn}:
\begin{align}
	\hat{Y}_{\eta t} &= \theta_{C\eta 1} \hat{C}_{\eta 1 t} + \theta_{C\eta 2} \hat{C}_{\eta 2 t} + (1 - \theta_{C\eta 1} - \theta_{C\eta 2}) \hat{I}_{\eta t} \label{eq_v5:reg-ll-total-yn-2}
\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
		...
		\item Production Function
		\begin{align}
			\hat{Y}_{\eta t} &= \hat{Z}_{A\eta t} + {\alpha_{}} \hat{K}_{\eta t} + (1-{\alpha_{}}) \hat{L}_{\eta t} \tag{\ref{eq_v5:reg-ll-final-goods-firm-bundle-rule-3}}
		\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\item Marginal Cost
		\begin{alignat}{2}
			\hat{\lambda}_{\eta t} &= {\alpha_{}} \hat{R}_{Kt} + (1- {\alpha_{}}) \hat{W}_{t} - \hat{Z}_{A\eta t} - \hat{P}_{\eta t} \tag{\ref{eq_v5:reg-ll-int-good-firm-MC-3}}
		\end{alignat}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{align}
			...
			\hat{Y}_{2 t} = \hat{Z}_{A2 t} + {\alpha_{}} \hat{K}_{2 t} + (1-{\alpha_{}}) \hat{L}_{2 t} \tag{\ref{eq_v5:reg-ll-final-goods-firm-bundle-rule-3}}
		\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{alignat}{2}
			...
			\hat{\lambda}_{2 t} = {\alpha_{}} \hat{R}_{Kt} + (1- {\alpha_{}}) \hat{W}_{t} - \hat{Z}_{A2 t} - \hat{P}_{2 t} \tag{\ref{eq_v5:reg-ll-int-good-firm-MC-3}}
		\end{alignat}
