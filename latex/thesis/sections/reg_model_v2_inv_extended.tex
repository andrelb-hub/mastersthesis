...
\subsection{Model Extended Development}
...
\begin{comment}
	...
	\item Capital Demand:
	\begin{align}
		K_{\eta jt} = {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} \tag{\ref{ext-mod:reg-int-good-firm-FOC-Kt}}
	\end{align}
...
\begin{comment}
	...
	\begin{alignat}{2}
		K_{\eta jt} &= {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} &\implies \tag{\ref{ext-mod:reg-int-good-firm-FOC-Kt}} \\
