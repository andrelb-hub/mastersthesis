...
{\singlespacing
	...
	\begin{enumerate}
		...
		\item Regional Market Clearing Condition: \colorbox{orange}{alterations}
		\begin{align}
...
\begin{enumerate}
	...
	\item Regional Consumption: \colorbox{orange}{alterations}
	\begin{align}
	...
	\item Regional Expense Weight: \colorbox{orange}{alterations}
	\begin{align}
...
\item Regional Consumption and Expense Weights \colorbox{orange}{alterations}
\begin{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
		...
		\item Capital and Labor Levels \colorbox{orange}{alterations}
		\begin{align}
