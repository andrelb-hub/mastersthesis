...
\begin{align}
	...
	C_{12} &= C_{1} \left( \frac{1 - \omega_{11}}{\omega_{11}} \right)^{\omega_{11}} \label{eq_v6:reg-ss-C12}
\end{align}
...
\begin{align}
	...
	C_{11} &= C_{1} \left( \frac{1 - \omega_{11}}{\omega_{11}} \right)^{\omega_{11} - 1} \label{eq_v6:reg-ss-C11}
\end{align}
...
\begin{align}
	...
	C_{21} &= C_{2} \left( \frac{1 - \omega_{21}}{\omega_{21}} \right)^{\omega_{21} - 1} \label{eq_v6:reg-ss-C21}
\end{align}
...
\begin{align}
	...
	C_{22} &= C_{2} \left( \frac{1 - \omega_{21}}{\omega_{21}} \right)^{\omega_{21}} \label{eq_v6:reg-ss-C22-b}
\end{align}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
