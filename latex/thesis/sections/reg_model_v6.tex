...
\subsubsection*{Cost Minimization Problem}
	...
	\begin{align}
		\min_{C_{\eta 1 t}, C_{\eta 1 t}}: &\quad Q_{\eta t} C_{\eta t} = P_{1 t} C_{\eta 1t} + P_{2 t} C_{\eta 2t} \label{eq_v6:reg-consumption-cost}
		\\
...
\begin{align}
	...
	\\
	B_{\eta t}: &\quad \beta^t \{-\mu_{\eta t}\} + \E \beta^{t+1} \{ -\mu_{\eta, t+1} [-(1 + R_{t})] \} = 0 \implies \\ &\quad \mu_{\eta t} = \beta (1 + R_{t}) \E{ \mu_{\eta, t+1}} \label{eq_v6:reg-FOC-Bt}
	\\
...
\begin{alignat}{2}
	...
	\mathbb{E}_{t} \left\{ \frac{C_{\eta t}^{-\sigma}}{C_{\eta, t+1}^{-\sigma}} \right\} &= \beta (1 + R_{t}) \mathbb{E}_{t} \left\{ \frac{Q_{\eta t}}{Q_{\eta, t+1}} \right\} \label{eq_v6:reg-bonds-euler-equation}
\end{alignat}

Equation \ref{eq_v6:reg-bonds-euler-equation} is the Euler equation for the bonds return.

Divide \ref{eq_v6:reg-bonds-euler-equation} of one region by the other:
...
\begin{align}
	\max_{Y_{\eta jt}}: &\quad \Pi_{\eta t} = P_{\eta t} Y_{\eta t} - \int_{0}^{1} P_{\eta jt} Y_{\eta jt} \dif j \label{eq_v6:reg-final-goods-firm-max-problem} \\
...
Divide equation \ref{eq_v6:reg-int-good-firm-FOC-Kt} by \ref{eq_v6:reg-int-good-firm-FOC-Lt}:
\begin{align}
	...
	\frac{K_{\eta jt}}{L_{\eta jt}} = \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_{\eta t}}{R_{Kt}} \label{eq_v6:reg-int-good-firm-TMRS}
\end{align}

Equation \ref{eq_v6:reg-int-good-firm-TMRS} demonstrates the relationship between the technical marginal rate of substitution (TMRS) and the economical marginal rate of substitution (EMRS). 

Substitute $L_{\eta jt}$ from equation \ref{eq_v6:reg-int-good-firm-TMRS} in \ref{eq_v6:reg-int-good-firm-production-function}:
\begin{alignat}{2}
	...
	K_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_{\eta t}}{R_{Kt}}\right]^{1-\alpha_{\eta}} \label{eq_v6:reg-int-good-firm-Kt-demand}
\end{alignat}

Equation \ref{eq_v6:reg-int-good-firm-Kt-demand} is the intermediate-goods firm demand for capital. 

Substitute \ref{eq_v6:reg-int-good-firm-Kt-demand} in \ref{eq_v6:reg-int-good-firm-TMRS}:
\begin{alignat}{2}
	...
	L_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_{\eta t}}{R_{Kt}}\right]^{-{\alpha_{\eta}}} \label{eq_v6:reg-int-good-firm-Lt-demand}
\end{alignat}

Equation \ref{eq_v6:reg-int-good-firm-Lt-demand} is the intermediate-goods firm demand for labor.

Calculate the total cost $TC$ using \ref{eq_v6:reg-int-good-firm-Kt-demand} and \ref{eq_v6:reg-int-good-firm-Lt-demand}:
\begin{alignat}{2}
	...
	TC_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_{\eta t}}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \label{eq_v6:reg-int-good-firm-TC}
\end{alignat}

%%%%%

Calculate the marginal cost $\Lambda$ using \ref{eq_v6:reg-int-good-firm-TC}: 
\begin{align}
	\Lambda_{\eta jt} & = \frac{\partial TC_{\eta jt}}{\partial Y_{\eta jt}} \implies 
	\Lambda_{\eta jt} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_{\eta t}}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \label{eq_v6:reg-int-good-firm-MC}
\end{align}
...
\begin{align}
	\label{eq_v6:reg-int-good-firm-MC-2}
...
notice that:
\begin{align}
	% \label{eq_v6:reg-int-good-firm-TC-MC}
...
\begin{align}
	P_{t} Y_{t} &= P_{1t} Y_{1t} + P_{2t} Y_{2t} \iff P_{t} = \frac{P_{1t} Y_{1t} + P_{2t} Y_{2t}}{Y_{t}} \label{eq_v6:national-price-level}
\end{align}
...
\begin{comment}
	\begin{align}
		...
		P_{t} &= \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t} %\label{eq_v6:national-price-level}
	\end{align}
...
\begin{align}
	\pi_{\eta t} = \frac{P_{\eta t}}{P_{\eta, t-1}} \label{eq_v6:regional-inflation}
\end{align}
...
\begin{align}
	\ln{Z_{A\eta t}} = (1-\rho_{A\eta})\ln{Z_{A\eta}} + \rho_{A\eta}\ln{Z_{A\eta,t-1}} + \varepsilon_{A\eta t} \label{eq_v6:reg-productivity-shock}
\end{align}
...
\begin{align}
	\ln{Z_{Mt}} = (1-\rho_M)\ln{Z_{M}} + \rho_M\ln{Z_{M,t-1}} + \varepsilon_{Mt} \label{eq_v6:reg-monetary-shock}
\end{align}
...
\subsubsection{Equilibrium Conditions}
	...
	\begin{align}
		...
		& \text{where:} \quad Y_{\eta t} = C_{1 \eta t} + C_{2 \eta t} \label{eq_v6:reg-regional-demand} \\
...
\begin{align}
	% Y_{t} &= Y_{1 t} + Y_{2 t} \label{eq_v6:reg-market-clearing-condition-Yt} \\
	& \text{where:} \quad Y_{\eta t} = C_{\eta 1 t} + C_{\eta 2 t} + I_{\eta t} % \label{eq_v6:reg-regional-demand} \\
	L_{\eta t} &= \int_{0}^{1} L_{\eta jt} \dif j % \label{eq_v6:reg-market-clearing-condition-Lt}
\end{align}
...
{\singlespacing
	...
	\begin{enumerate}
		...
		\end{split} \tag{\ref{eq_v6:reg-budget-constraint}}
		\end{align}
		...
		\begin{align}
			\frac{C_{11t}(1-\omega_{11})}{C_{21t}(1-\omega_{21})} &= \frac{C_{12t}(\omega_{11})}{C_{22t}(\omega_{21})} \tag{\ref{eq_v6:reg-Cn1-Cn2-b}}
		\end{align}
		
		\colorbox{orange}{or below, which closes 35 equations:}
		
		\begin{align}
			\frac{P_{1 t} C_{\eta 1 t}}{\omega_{\eta 1}} &= \frac{P_{2 t} C_{\eta 2 t}}{1 -\omega_{\eta 1}} \tag{\ref{eq_v6:reg-Cn1-Cn2}}
		\end{align}
		...
		\begin{align}
			Q_{\eta t} &= C_{\eta t} \left[ \frac{P_{1 t}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2 t}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} \tag{\ref{eq_v6:reg-total-expense-level}}
		\end{align}

		\item Labor Supply:
		\begin{align}
			\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{1-\sigma}} = \frac{W_{\eta t}}{Q_{\eta t}} \tag{\ref{eq_v6:reg-labor-supply}}
		\end{align}

		\item Euler equation for the bonds return:
		\begin{align}
			\frac{ C_{\eta t}^{1-\sigma}}{Q_{\eta t}} &= \beta (1 + R_{t}) \E \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{Q_{\eta, t+1}} \right\} \tag{\ref{eq_v6:reg-bonds-euler-equation}}
		\end{align}
		...
		\begin{align}
			\frac{R_{t}}{R} = \left( \frac{R_{t-1}}{R} \right)^{\gamma_R} \left[ \left( \frac{\pi_t}{\pi} \right)^{\gamma_\pi} \left( \frac{Y_{t}}{Y} \right)^{\gamma_Y} \right]^{1-\gamma_R} Z_{Mt} \tag{\ref{eq_v6:reg-monetary-policy}}
		\end{align}
		
		\item National Gross Inflation Rate:
		\begin{align}
			\pi_t = \frac{P_t}{P_{t-1}} \tag{\ref{eq_v6:reg-gross-inflation-rate}}
		\end{align}
		
		\item National Price Level:
		\begin{align}
			P_{t} &= \frac{P_{1t} Y_{1t} + P_{2t} Y_{2t}}{Y_{t}} \tag{\ref{eq_v6:national-price-level}} % P_{t} = \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t}
		\end{align}
		
		\item Regional Gross Inflation Rate:
		\begin{align}
			\pi_{\eta t} = \frac{P_{\eta t}}{P_{\eta, t-1}} \tag{\ref{eq_v6:regional-inflation}}
		\end{align}
		...
		\begin{align}
			Y_{\eta t} = C_{1\eta t} + C_{2\eta t} \tag{\ref{eq_v6:reg-regional-demand}}
		\end{align}
...
\begin{comment}
	...
	\begin{align}
		K_{\eta, t+1} = (1-\delta)K_{\eta t} + I_{\eta t} \tag{\ref{eq_v6:reg-law-of-motion-for-capital}}
	\end{align}
	
	\item Regional Consumption of good 1:
	\begin{align}
		C_{\eta 1 t} &= Q_{\eta t} \frac{\omega_{\eta 1}}{P_{1 t}} \tag{\ref{eq_v6:reg-Cn-Cn-2}}
	\end{align}
	
	\item Regional Consumption of good 2:
	\begin{align}
		C_{\eta 2 t} &= Q_{\eta t} \frac{1 -\omega_{\eta 1}}{P_{2 t}} \tag{\ref{eq_v6:reg-Cn-Cv-2}}
	\end{align}
	
	\item Euler equation for the capital return:
	\begin{align}
		\frac{ C_{\eta t}^{1-\sigma}}{Q_{\eta t}} P_{\eta t} &= \beta \mathbb{E}_t \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{Q_{\eta, t+1}} [(1-\delta) P_{\eta, t+1} + R_{K,t+1}] \right\} \tag{\ref{eq_v6:reg-capital-euler-equation}}
	\end{align}
	
	\item Capital Demand:
	\begin{align}
		K_{\eta jt} = {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} \tag{\ref{eq_v6:reg-int-good-firm-FOC-Kt}}
	\end{align}
	
	
	\item Labor Demand:
	\begin{align}
		L_{\eta jt} = (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{\eta t}} \tag{\ref{eq_v6:reg-int-good-firm-FOC-Lt}}
	\end{align}
	
	\begin{align}
		\Lambda_{\eta t} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_{\eta t}}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \tag{\ref{eq_v6:reg-int-good-firm-MC-2}}
	\end{align}
...
\begin{enumerate}
	...
	\begin{align}
		...
		& P_{1} C_{\eta 1} + P_{2} C_{\eta 2} = W_{\eta} L_{\eta} + R_{} B_{\eta} + \Pi_{\eta} \label{eq_v6:reg-ss-budget-constrain}
	\end{align}
	
	\item Regional Consumption:
	\begin{align}
		C_{\eta} &= C_{\eta 1}^{\omega_{\eta 1}} C_{\eta 2}^{1-\omega_{\eta 1}} \label{eq_v6:reg-ss-consumption-aggregation}
	\end{align}
	
	\item Regional Expense Weight:
	\begin{align}
		\frac{C_{11}(1-\omega_{11})}{C_{21}(1-\omega_{21})} &= \frac{C_{12}(\omega_{11})}{C_{22}(\omega_{21})} \label{eq_v6:reg-ss-Cn1-Cn2-b}
	\end{align}
	
	\colorbox{orange}{or below, which closes 35 equations:}
	
	\begin{align}
		\frac{P_{1} C_{\eta 1}}{\omega_{\eta 1}} &= \frac{P_{2} C_{\eta 2}}{1 -\omega_{\eta 1}} \tag{\ref{eq_v6:reg-Cn1-Cn2}}
	\end{align}
	
	\item Price Composition of Consumption Bundle:
	\begin{align}
		Q_{\eta} &= C_{\eta} \left[ \frac{P_{1}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} \label{eq_v6:reg-ss-total-expense-level}
	\end{align}
	
	\item Labor Supply:
	\begin{align}
		\frac{\phi L_{\eta}^{\varphi}}{C_{\eta}^{1-\sigma}} = \frac{W_{\eta}}{Q_{\eta}} \label{eq_v6:reg-ss-labor-supply}
	\end{align}
	...
	\item Marginal Cost:
	\begin{align}
		\Lambda_{\eta} = \frac{W_{\eta}}{Z_{A\eta}} \label{eq_v6:reg-ss-int-good-firm-FOC-L}
	\end{align}
	...
	\begin{align}
		...
		P_{\eta}^{\ast} &= \frac{\psi}{\psi-1} \cdot \Lambda_{\eta} \label{eq_v6:reg-ss-int-good-firm-optimal-price-FOC-3}
	\end{align}
	...
	\begin{align}
		...
		\pi_t &= 1 \label{eq_v6:reg-ss-gross-inflation-rate}
	\end{align}
	...
	\begin{align}
		...
		\pi_{\eta} &= 1 \label{eq_v6:reg-ss-regional-inflation}
	\end{align}
	...
	\item Market Clearing Condition:
	\begin{align}
		Y_{} &= Y_{1} + Y_{2} \label{eq_v6:reg-ss-market-clearing-condition-Y}
	\end{align}
	
	\item Regional Market Clearing Condition: \colorbox{orange}{version 02}
	\begin{align}
		Y_{\eta} &= C_{1\eta} + C_{2\eta} \label{eq_v6:reg-ss-regional-demand}
	\end{align}
	
	\item Labor Regional Market Clearing Condition: \colorbox{orange}{version 02}
	\begin{align}
		L_{\eta} &= \int_{0}^{1} L_{\eta j} \dif j \label{eq_v6:reg-ss-market-clearing-condition-L}
	\end{align}
...
\subsubsection{Variables at Steady State}
	...
	\begin{align}
		...
		Z_{A2} = \theta_{A1} Z_{A1} \label{eq_v6:reg-ss-za2-0}
	\end{align}
	...
	\begin{align}
		\beta &= \frac{1}{(1 + R)} \implies \tag{\ref{eq_v6:reg-ss-bonds-euler-equation}} \\
		R &= \frac{1}{\beta} - 1 \label{eq_v6:reg-ss-R}
	\end{align}

\begin{comment}
	
	From \ref{eq_v6:reg-ss-capital-euler-equation}, the return on capital $R_K$ for $\eta = 1$ is:
	\begin{align}
		1 &= \beta \left[ (1-\delta) + \frac{R_K}{P_{1}} \right] \implies \tag{\ref{eq_v6:reg-ss-capital-euler-equation}} \\
		R_K &= P_{1} \left[ \frac{1}{\beta} - (1-\delta) \right] \label{eq_v6:reg-ss-RK}
	\end{align}

	Divide \ref{eq_v6:reg-ss-RK} for $\eta = 1$ by \ref{eq_v6:reg-ss-RK} for $\eta = 2$:
	\begin{align}
		\frac{R_K}{R_K} &= \frac{P_{1} \left[ \frac{1}{\beta} - (1-\delta) \right]}{P_{2} \left[ \frac{1}{\beta} - (1-\delta) \right]} \implies \nonumber \\
		1 &= \frac{P_{1}}{P_{2}} \implies P_{1} = P_{2} \label{eq_v6:reg-ss-p1-p2}
	\end{align}

\end{comment}

From \ref{eq_v6:reg-ss-general-price-level} and \ref{eq_v6:reg-ss-p1-p2}, the regional optimal price $P_{\eta}^{\ast}$ is:
\begin{align}
	P_{\eta}^{\ast} = P_{\eta} \implies \langle \begin{matrix} P_{1}^{\ast} & P_{2}^{\ast} \end{matrix} \rangle = \langle \begin{matrix} P_{1} & P_{2} \end{matrix} \rangle = \langle \begin{matrix} P_{1} & P_{1} \end{matrix} \rangle \tag{\ref{eq_v6:reg-ss-general-price-level}}
\end{align}

Substitute \ref{eq_v6:reg-ss-p1-p2} and then \ref{eq_v6:reg-ss-total-yn} in \ref{eq_v6:ss-national-price-level} for the national price level:
	\begin{align}
		P_{} &= \frac{P_{1} Y_{1} + P_{2} Y_{2}}{Y_{}} = \frac{P_{1} Y_{1} + P_{1} Y_{2}}{Y_{}} \tag{\ref{eq_v6:ss-national-price-level}} \implies \nonumber \\
		P_{} &= P_{1} = P_{2} \label{eq_v6:reg-ss-P1-P2-P}
	\end{align}

Substitute \ref{eq_v6:reg-ss-P1-P2-P} in \ref{eq_v6:reg-ss-price-eta-level} for the price composition of consumption bundle $\te[]$:
\begin{align}
	\te[] &= C_{\eta} \left[ \frac{P_{1}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} = C_{\eta} \left[ \frac{P_{}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} \implies \tag{\ref{eq_v6:reg-ss-price-eta-level}} \\
	\te[] &= \frac{P_{} C_{\eta}}{\omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}} \label{eq_v6:reg-ss-te}
\end{align}

Substitute \ref{eq_v6:reg-ss-general-price-level} and \ref{eq_v6:reg-ss-P1-P2-P} in \ref{eq_v6:reg-ss-int-good-firm-optimal-price-FOC-3} for the marginal cost $\Lambda_{\eta}$:
\begin{align}
	P_{\eta}^{\ast} &= \frac{\psi}{\psi-1} \Lambda_{\eta} \implies \tag{\ref{eq_v6:reg-ss-int-good-firm-optimal-price-FOC-3}} \\
	\Lambda_{\eta} &= P_{} \frac{\psi-1}{\psi} = \Lambda_{} \label{eq_v6:reg-ss-marginal-cost}
\end{align}

Substitute \ref{eq_v6:reg-ss-p1-za1} and \ref{eq_v6:reg-ss-marginal-cost} in \ref{eq_v6:reg-ss-int-good-firm-MC-2} for the nominal wage $W$ in terms of region 1:
\begin{alignat}{2}
	...
	W &= (1-\alpha_{\eta}) \left[ \Lambda_{} Z_{A1} \left( \frac{{\alpha_{\eta}}}{R_K} \right)^{{\alpha_{\eta}}} \right]^\frac{1}{1-\alpha_{\eta}} & \label{eq_v6:reg-ss-nominal-wage}
\end{alignat}
...
Due to price parity in steady state, where prices are identical ($P_{\eta} = P_{\eta}^{\ast}$) and resulting in a gross inflation level of one ($\pi_{\eta} = 1$), all firms produce the same output level ($Y_{\eta j} = Y_{\eta}$) \cite[Lecture 13, p.12]{solis-garcia_ucb_2022}. As a consequence, they uniformly demand the same amount of factors ($K_{\eta}, L_{\eta}$), and equations \ref{eq_v6:reg-ss-int-good-firm-production-function}, \ref{eq_v6:reg-ss-int-good-firm-FOC-Kt} and \ref{eq_v6:reg-ss-int-good-firm-FOC-Lt} become: % In steady state, prices are the same ($P_{\eta} = P_{\eta}^{\ast}$), resulting in a gross inflation level of one ($\pi_{\eta} = 1$), and all firms producing the same output level ($Y_{\eta j} = Y_{\eta}$) due to the price parity \cite[Lecture 13, p.12]{solis-garcia_ucb_2022}. For this reason, they all demand the same amount of factors ($K_{\eta}, L_{\eta}$), and equations \ref{eq_v6:reg-ss-int-good-firm-production-function}, \ref{eq_v6:reg-ss-int-good-firm-FOC-Kt} and \ref{eq_v6:reg-ss-int-good-firm-FOC-Lt} become:
\begin{align}
	Y_{\eta} &= Z_{A\eta} K_{\eta}^{\alpha_{\eta}} L_{\eta}^{1 -{\alpha_{\eta}}} \label{eq_v6:reg-ss-int-good-firm-production-function-2} \\	
	K_{\eta} &= {\alpha_{\eta}} Y_{\eta} \frac{\Lambda_{}}{R_K} \label{eq_v6:reg-ss-int-good-firm-FOC-Kt-2} \\
	L_{\eta} &= (1-\alpha_{\eta}) Y_{\eta} \frac{\Lambda_{}}{W} \label{eq_v6:reg-ss-int-good-firm-FOC-Lt-2}
\end{align}
	...
	Isolate $C_{\eta}$ in \ref{eq_v6:reg-ss-household-labor-supply} and then substitute \ref{eq_v6:reg-ss-te} and \ref{eq_v6:reg-ss-int-good-firm-FOC-Lt-2}:
	\begin{align}
		...
		& \text{where:} \quad a_{\eta} = \left[ \frac{W^{1 +\varphi} \omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}}{\phi P_{} \left[ (1 -\alpha_{\eta}) \Lambda_{} \right]^{\varphi}} \right]^{\frac{1}{\sigma}} \label{eq_v6:reg-ss-a-eta}
	\end{align}

	Substitute \ref{eq_v6:reg-ss-consumption} in \ref{eq_v6:reg-ss-te}:
	\begin{align}
		\te[] &= \frac{P_{} C_{\eta}}{\omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}} \implies \tag{\ref{eq_v6:reg-ss-te}} \\
		\te[] &= \frac{P_{} a_{\eta} Y_{\eta}^{\frac{-\varphi}{\sigma}}}{\omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}} \label{eq_v6:reg-ss-te-2}
	\end{align}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Isolate $C_{\eta 1}$ in \ref{eq_v6:reg-ss-Cn1-Cn2} and substitute in \ref{eq_v6:reg-ss-consumption-aggregation}:
\begin{align}
	C_{\eta} &= C_{\eta 1}^{\omega_{\eta 1}} C_{\eta 2}^{1-\omega_{\eta 1}} \tag{\ref{eq_v6:reg-ss-consumption-aggregation}} \implies \\
	C_{\eta} &= \left[ \frac{\omega_{\eta 1} P_{2} C_{\eta 2}}{(1 -\omega_{\eta 1}) P_{1}} \right]^{\omega_{\eta 1}} C_{\eta 2}^{1-\omega_{\eta 1}} \implies \nonumber \\
	C_{\eta 2} &= C_{\eta} \left[ \frac{(1 - \omega_{\eta 1}) P_{1}}{\omega_{\eta 1} P_{2}} \right]^{\omega_{\eta 1}} \label{eq_v6:reg-ss-C2-Cn-3}
\end{align}

Isolate $C_{\eta 2}$ in \ref{eq_v6:reg-ss-Cn1-Cn2} and substitute in \ref{eq_v6:reg-ss-consumption-aggregation}:
\begin{align}
	C_{\eta} &= C_{\eta 1}^{\omega_{\eta 1}} C_{\eta 2}^{1-\omega_{\eta 1}} \tag{\ref{eq_v6:reg-ss-consumption-aggregation}} \implies \\
	C_{\eta} &= C_{\eta 1}^{\omega_{\eta 1}} \left[ \frac{(1 -\omega_{\eta 1}) P_{1} C_{\eta 1}}{\omega_{\eta 1} P_{2}} \right]^{1-\omega_{\eta 1}} \implies \nonumber \\
	C_{\eta 1} &= C_{\eta} \left[ \frac{\omega_{\eta 1} P_{2}}{(1 - \omega_{\eta 1}) P_{1}} \right]^{1-\omega_{\eta 1}} \label{eq_v6:reg-ss-C1-Cn-3}
\end{align}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Substitute \ref{eq_v6:reg-ss-investment}, \ref{eq_v6:reg-ss-consumption} in \ref{eq_v6:reg-ss-total-yn}:
	\begin{alignat}{2}
		Y_{\eta} &= C_{\eta} + I_{\eta} &\implies \tag{\ref{eq_v6:reg-ss-total-yn}} \\
		Y_{\eta} &= a_{\eta} Y_{\eta}^{\frac{-\varphi}{\sigma}} + b_{\eta} Y_{\eta} &\implies \nonumber \\
		Y_{\eta} &= \left( \frac{a_{\eta}}{1 - b_{\eta}} \right)^{\frac{\sigma}{\sigma + \varphi}} \label{eq_v6:reg-ss-total-yn-2}
	\end{alignat}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

	The result of \ref{eq_v6:reg-ss-total-yn-2} determines $Y, I_{\eta}, C_{\eta}, \te[],  C_{\eta 1}, C_{\eta 2}, K_{\eta}, L_{\eta}$ in \ref{eq_v6:reg-ss-market-clearing-condition}, \ref{eq_v6:reg-ss-investment}, \ref{eq_v6:reg-ss-consumption}, \ref{eq_v6:reg-ss-te},  \ref{eq_v6:reg-ss-C1-Cn-3}, \ref{eq_v6:reg-ss-C2-Cn-3}, \ref{eq_v6:reg-ss-int-good-firm-FOC-Kt-2} and \ref{eq_v6:reg-ss-int-good-firm-FOC-Lt-2}, respectively.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{align}
		\vec{\bm{1}} &= \langle \begin{matrix} P & P_{1} & P_{2} & Z_{A1} & Z_{A2} & Z_{M} & \pi & \pi_{1} & \pi_{2} \end{matrix} \rangle \label{eq_v6:reg-unity-vector}
		\\
		...
		\\
		R_K &= P_{} \left[ \frac{1}{\beta} - (1-\delta) \right] \tag{\ref{eq_v6:reg-ss-RK}}
		\\
		\Lambda_{} &= P_{} \frac{\psi-1}{\psi} \tag{\ref{eq_v6:reg-ss-marginal-cost}}
		\\
		W &= (1-\alpha_{\eta}) \left[ \Lambda_{} Z_{A1} \left( \frac{{\alpha_{\eta}}}{R_K} \right)^{{\alpha_{\eta}}} \right]^\frac{1}{1-\alpha_{\eta}} \tag{\ref{eq_v6:reg-ss-nominal-wage}}
		\\ % Z_{A2} &= \frac{1}{\Lambda_{}} \left( \frac{R_K}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \tag{\ref{eq_v6:reg-ss-za2}}
		a_{\eta} &= \left[ \frac{W^{1 +\varphi} \omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}}{\phi P_{} \left[ (1 -\alpha_{\eta}) \Lambda_{} \right]^{\varphi}} \right]^{\frac{1}{\sigma}} \tag{\ref{eq_v6:reg-ss-a-eta}}
		\\
		b_{\eta} &= \delta {\alpha_{\eta}} \frac{\Lambda_{}}{R_K} \tag{\ref{eq_v6:reg-ss-b-eta}}
		\\
		Y_{\eta} &= \left( \frac{a_{\eta}}{1 - b_{\eta}} \right)^{\frac{\sigma}{\sigma + \varphi}} \tag{\ref{eq_v6:reg-ss-total-yn-2}}
		\\
		Y &= Y_{1} + Y_{2} \tag{\ref{eq_v6:reg-ss-market-clearing-condition}}
		\\
		I_{\eta} &= b_{\eta} Y_{\eta} \tag{\ref{eq_v6:reg-ss-investment}}
		\\
		C_{\eta} &= a_{\eta} Y_{\eta}^{\frac{-\varphi}{\sigma}} \tag{\ref{eq_v6:reg-ss-consumption}}
		\\
		\te[] &= \frac{P_{} C_{\eta}}{\omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}} \tag{\ref{eq_v6:reg-ss-te}}
		\\
		C_{\eta 1} &= C_{\eta} \left[ \frac{\omega_{\eta 1} P_{2}}{(1 - \omega_{\eta 1}) P_{1}} \right]^{1-\omega_{\eta 1}} \tag{\ref{eq_v6:reg-ss-C1-Cn-3}}
		\\
		C_{\eta 2} &= C_{\eta} \left[ \frac{(1 - \omega_{\eta 1}) P_{1}}{\omega_{\eta 1} P_{2}} \right]^{\omega_{\eta 1}} \tag{\ref{eq_v6:reg-ss-C2-Cn-3}}
		\\
		K_{\eta} &= {\alpha_{\eta}} Y_{\eta} \frac{\Lambda_{}}{R_K} \tag{\ref{eq_v6:reg-ss-int-good-firm-FOC-Kt-2}}
		\\
		L_{\eta} &= (1-\alpha_{\eta}) Y_{\eta} \frac{\Lambda_{}}{W} \tag{\ref{eq_v6:reg-ss-int-good-firm-FOC-Lt-2}}
	\end{align}

		\begin{comment}
			Y_{1} &= \left[ \left( \frac{a_{1}}{1 - b_{1}} \right) \left( \frac{1}{\omega_{11}^{\omega_{11}} (1 - \omega_{11})^{1 - \omega_{11}}} \right) \right]^{\frac{\sigma}{\sigma + \varphi}} \tag{\ref{eq_v6:reg-ss-total-y1}}
			\\
			Y_{2} &= \left[ \left( \frac{a_{2}}{1 - b_{2}} \right) \left( \frac{1}{\omega_{21}^{\omega_{21}} (1 - \omega_{21})^{1 - \omega_{21}}} \right) \right]^{\frac{\sigma}{\sigma + \varphi}} \tag{\ref{eq_v6:reg-ss-total-y2}}
			\\
		\end{comment}
...
\end{align}
	...
	Log-linearize \ref{eq_v6:regional-inflation} and define the level deviation of regional inflation rate $\hat{\pi}_{\eta t}$:
	\begin{align}
		\pi_{\eta t} &= \frac{P_{\eta t}}{P_{\eta, t-1}} \tag{\ref{eq_v6:regional-inflation}} \\
...
Log-linearize \ref{eq_v6:reg-law-of-motion-for-capital}:
	\begin{alignat}{2}
		K_{\eta, t+1} &= (1-\delta)K_{\eta t} + I_{\eta t} &\implies \tag{\ref{eq_v6:reg-law-of-motion-for-capital}} \\
		K_{\eta} (1 + \hat{K}_{\eta, t+1}) &= (1-\delta) K_{\eta} (1 + \hat{K}_{\eta t}) + I_{\eta} (1 + \hat{I}_{\eta t}) &\implies \nonumber \\
		\hat{K}_{\eta, t+1} &= (1-\delta) \hat{K}_{\eta t} + \delta \hat{I}_{\eta t} \label{eq_v6:reg-ll-law-of-motion-for-capital}
	\end{alignat}
...
\subsubsection*{Regional Consumption}
	...
	Log-linearize \ref{eq_v6:reg-consumption-aggregation}:
	\begin{align}
		C_{\eta t} &= C_{\eta 1 t}^{\omega_{\eta 1}} C_{\eta 2 t}^{1-\omega_{\eta 1}} \tag{\ref{eq_v6:reg-consumption-aggregation}} \implies \\
		\hat{C}_{\eta t} &= \omega_{\eta 1} \hat{C}_{\eta 1 t} + (1-\omega_{\eta 1}) \hat{C}_{\eta 2 t} \label{eq_v6:reg-ll-consumption-aggregation}
	\end{align}
	
\subsubsection*{Regional Consumption and Expense Weights}
	
	Log-linearize \ref{eq_v6:reg-Cn1-Cn2}:
	\begin{align}
		\frac{P_{1 t} C_{\eta 1 t}}{\omega_{\eta 1}} &= \frac{P_{2 t} C_{\eta 2 t}}{1 -\omega_{\eta 1}} \tag{\ref{eq_v6:reg-Cn1-Cn2}} \implies \\
		\hat{P}_{1 t} - \hat{P}_{2 t} &= \hat{C}_{\eta 2 t} - \hat{C}_{\eta 1 t} \label{eq_v6:reg-ll-Cn1-Cn2}
	\end{align}
	
	Subtract \ref{eq_v6:reg-ll-Cn1-Cn2} of one region from the other:
	\begin{align}
		(\hat{P}_{1 t} - \hat{P}_{2 t}) - (\hat{P}_{1 t} - \hat{P}_{2 t}) &= (\hat{C}_{12t} - \hat{C}_{11t}) - (\hat{C}_{22t} - \hat{C}_{21t}) \implies \nonumber \\
		\hat{C}_{11t} - \hat{C}_{12t} &= \hat{C}_{22t} - \hat{C}_{21t} \label{eq_v6:reg-ll-Cn1-Cn2-b}
	\end{align}
...
Log-linearize \ref{eq_v6:reg-Cn-Cn-2}:
\begin{alignat}{2}
	C_{\eta 1 t} &= Q_{\eta t} \frac{\omega_{\eta 1}}{P_{1 t}} &\implies \tag{\ref{eq_v6:reg-Cn-Cn-2}} \\
	C_{\eta 1} (1 + \hat{C}_{\eta 1 t}) &= \mathscr{E}_{\eta} \frac{\omega_{\eta 1}}{P_{1}} (1 + \hat{\mathscr{E}}_{\eta t} - \hat{P}_{1 t}) &\implies \nonumber \\
	\hat{C}_{\eta 1 t} &= \hat{\mathscr{E}}_{\eta t} - \hat{P}_{1 t} \iff \hat{\mathscr{E}}_{\eta t} = \hat{C}_{\eta 1 t} + \hat{P}_{1 t} \label{eq_v6:reg-ll-Cn-Cn-2}
\end{alignat}

Log-linearize \ref{eq_v6:reg-Cn-Cv-2}:
\begin{alignat}{2}
	C_{\eta 2 t} &= Q_{\eta t} \frac{1 - \omega_{\eta 1}}{P_{2 t}} &\implies \tag{\ref{eq_v6:reg-Cn-Cv-2}} \\
	C_{\eta 2} (1 + \hat{C}_{\eta 2 t}) &= \mathscr{E}_{\eta} \frac{1 - \omega_{\eta 1}}{P_{2}} (1 + \hat{\mathscr{E}}_{\eta t} - \hat{P}_{2 t}) &\implies \nonumber \\
	\hat{C}_{\eta 2 t} &= \hat{\mathscr{E}}_{\eta t} - \hat{P}_{2 t} \iff \hat{\mathscr{E}}_{\eta t} = \hat{C}_{\eta 2 t} + \hat{P}_{2 t} \label{eq_v6:reg-ll-Cn-Cv-2}
\end{alignat}

Match equations \ref{eq_v6:reg-ll-Cn-Cn-2} and \ref{eq_v6:reg-ll-Cn-Cv-2}:
\begin{align}
	\hat{\mathscr{E}}_{\eta t} = \hat{C}_{\eta 1 t} + \hat{P}_{1 t} &= \hat{C}_{\eta 2 t} + \hat{P}_{2 t} \implies \nonumber \\
	\hat{C}_{\eta 1 t} - \hat{C}_{\eta 2 t} &= \hat{P}_{2 t} - \hat{P}_{1 t} \label{eq_v6:reg-ll-regional-consumption-and-prices}
\end{align}

Equation \ref{eq_v6:reg-ll-regional-consumption-and-prices} shows that the variation of both goods consumption in each region correspond to the distance between the variations of the regional price  levels.	
...
Log-linearize \ref{eq_v6:reg-total-expense-level}:
	\begin{alignat}{2}
		Q_{\eta t} &= C_{\eta t} \left[ \frac{P_{1 t}}{\omega_{\eta 1}} \right]^{\omega_{\eta 1}} \left[ \frac{P_{2 t}}{1 -\omega_{\eta 1}} \right]^{1 -\omega_{\eta 1}} &\implies \tag{\ref{eq_v6:reg-total-expense-level}} \\
		...
		\hat{\mathscr{E}}_{\eta t} &= \hat{C}_{\eta t} + \omega_{\eta 1} \hat{P}_{1 t} + (1 -\omega_{\eta 1}) \hat{P}_{2 t} \label{eq_v6:reg-ll-total-expense-level}
	\end{alignat}
...
Isolate $\hat{\mathscr{E}}_{\eta t}$ in \ref{eq_v6:reg-ll-regional-consumption-and-prices} and substitute in \ref{eq_v6:reg-ll-total-expense-level}:
\begin{align}
	\hat{C}_{\eta 1 t} &= \hat{\mathscr{E}}_{\eta t} - \hat{P}_{\eta t} \iff \hat{\mathscr{E}}_{\eta t} = \hat{C}_{\eta 1 t} + \hat{P}_{\eta t} \tag{\ref{eq_v6:reg-ll-regional-consumption-and-prices}} \\
	\hat{C}_{\eta 1 t} + \hat{P}_{\eta t} &= \hat{C}_{\eta t} + \omega_{\eta 1} \hat{P}_{\eta t} + (1 -\omega_{\eta 1}) \hat{P}_{\nu t} \implies \nonumber \\
	\hat{C}_{\eta t} - \hat{C}_{\eta 1 t} &= (1 -\omega_{\eta 1}) (\hat{P}_{\eta t} - \hat{P}_{\nu t}) \label{eq_v6:reg-ll-total-expense-level-2}
\end{align}

Equation \ref{eq_v6:reg-ll-total-expense-level-2} shows that the distance between the regional consumption and the good $\eta$ consumption is proportional to the distance between the variations of both regional price levels.	
...
Log-linearize \ref{eq_v6:reg-labor-supply}:
\begin{alignat}{2}
	\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{1-\sigma}} &= \frac{W_{\eta t}}{Q_{\eta t}} &\implies \tag{\ref{eq_v6:reg-labor-supply}} \\
	\varphi \hat{L}_{\eta t} - (1 -\sigma) \hat{C}_{\eta t} &= \hat{W}_t - \hat{ \mathscr{E} }_{\eta t} & \label{eq_v6:reg-ll-labor-supply}
\end{alignat}
...
\begin{alignat}{2}
	& \frac{ C_{\eta t}^{1-\sigma}}{Q_{\eta t}} = \beta (1 + R_{t}) \E \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{Q_{\eta, t+1}} \right\} \implies \tag{\ref{eq_v6:reg-bonds-euler-equation}}\\
	...
	\end{split} \nonumber \\
	& \E \left\{ \hat{\mathscr{E}}_{\eta, t+1} - (1 -\sigma) \hat{C}_{\eta, t+1} \right\} - [\hat{\mathscr{E}}_{\eta t} - (1 -\sigma) \hat{C}_{\eta t}] = (1 -\beta) \hat{R}_{t} \label{eq_v6:reg-ll-bonds-euler-equation}
\end{alignat}
...
\begin{alignat}{2}
	...
	\hat{Y}_{\eta jt} &= \hat{Z}_{A\eta t} + {\alpha_{\eta}} \hat{K}_{\eta jt} + (1-\alpha_{\eta}) \hat{L}_{\eta jt} \label{eq_v6:reg-ll-int-good-firm-production-function}
\end{alignat}
...
\begin{alignat}{2}
	...
	\hat{Y}_{\eta t} &= \hat{Z}_{A\eta t} + {\alpha_{\eta}} \int_{0}^{1} \hat{K}_{\eta jt} \dif j + (1-\alpha_{\eta}) \int_{0}^{1} \hat{L}_{\eta jt} \dif j \label{eq_v6:reg-ll-final-goods-firm-bundle-rule-2}
\end{alignat}
...
Substitute \ref{eq_v6:reg-ll-market-clearing-condition-Lt} and \ref{eq_v6:reg-ll-capital-clearing-condition} in \ref{eq_v6:reg-ll-final-goods-firm-bundle-rule-2}:
\begin{align}
	\tag{\ref{eq_v6:reg-ll-final-goods-firm-bundle-rule-2}}
	...
	\hat{Y}_{\eta t} &= \hat{Z}_{A\eta t} + {\alpha_{\eta}} \hat{K}_{\eta t} + (1-\alpha_{\eta}) \hat{L}_{\eta t} \label{eq_v6:reg-ll-final-goods-firm-bundle-rule-3}
\end{align}
...
Log-linearize \ref{eq_v6:reg-int-good-firm-FOC-Kt}:
\begin{alignat}{2}
	K_{\eta jt} &= {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} &\implies \tag{\ref{eq_v6:reg-int-good-firm-FOC-Kt}} \\
...
Integrate both sides and then substitute \ref{eq_v6:reg-ll-capital-clearing-condition} and \ref{eq_v6:reg-ll-final-goods-firm-bundle-rule}:
\begin{alignat}{2}
	\int_{0}^{1} \hat{K}_{\eta jt} \dif j &= \int_{0}^{1} \left( \hat{Y}_{\eta jt} + \hat{\Lambda}_{\eta t} - \hat{R}_{K t} \right) \dif j \quad &\implies \nonumber \\
	\hat{K}_{\eta t} &= \hat{Y}_{\eta t} + \hat{\Lambda}_{\eta t} - \hat{R}_{K t} \label{eq_v6:reg-ll-int-good-firm-FOC-Kt}
\end{alignat}
...
Log-linearize \ref{eq_v6:reg-int-good-firm-FOC-Lt}:
\begin{alignat}{2}
	L_{\eta jt} &= (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{\eta t}} &\implies \tag{\ref{eq_v6:reg-int-good-firm-FOC-Lt}} \\
...
Integrate both sides and then substitute \ref{eq_v6:reg-ll-market-clearing-condition-Lt} and \ref{eq_v6:reg-ll-final-goods-firm-bundle-rule}:
\begin{align}
	...
	\label{eq_v6:reg-ll-int-good-firm-FOC-Lt}
\end{align}
...
Subtract \ref{eq_v6:reg-ll-int-good-firm-FOC-Lt} from \ref{eq_v6:reg-ll-int-good-firm-FOC-Kt}:
\begin{align}
	...
	\hat{K}_{\eta t} - \hat{L}_{\eta t} &= \hat{W}_{t} - \hat{R}_{K t} \label{eq_v6:reg-ll-int-good-firm-TMRS}
\end{align}

Equation \ref{eq_v6:reg-ll-int-good-firm-TMRS} is the log-linearized version of \ref{eq_v6:reg-int-good-firm-TMRS}.
...
\subsubsection*{Capital and Labor Levels}
	...
	Subtract \ref{eq_v6:reg-ll-int-good-firm-TMRS} of one region from the other:
	\begin{align}
		(\hat{K}_{1t} - \hat{L}_{1t}) - (\hat{K}_{2t} - \hat{L}_{2t}) &= (\hat{W}_{t} - \hat{R}_{K t}) - (\hat{W}_{t} - \hat{R}_{K t}) \implies \nonumber \\
		\hat{K}_{1t} - \hat{L}_{1t} &= \hat{K}_{2t} - \hat{L}_{2t} \label{eq_v6:reg-ll-int-good-firm-TMRS-b}
	\end{align}
...
Log-linearize \ref{eq_v6:reg-int-good-firm-MC-2}:
\begin{alignat}{2}
	& \Lambda_{\eta t} = Z_{A\eta t}^{-1} \frac{R_{Kt}^{{\alpha_{\eta}}} W_{\eta t}^{1-\alpha_{\eta}}}{{\alpha_{\eta}}^{{\alpha_{\eta}}} (1-\alpha_{\eta})^{1-\alpha_{\eta}}} \implies \tag{\ref{eq_v6:reg-int-good-firm-MC-2}} \\
	...
	& \hat{\Lambda}_{\eta t} = {\alpha_{\eta}} \hat{R}_{Kt} + (1- {\alpha_{\eta}}) \hat{W}_{t} - \hat{Z}_{A\eta t} \label{eq_v6:reg-ll-int-good-firm-MC-2}
\end{alignat}

Substitute \ref{eq_v6:reg-hat-real-marginal-cost} in \ref{eq_v6:reg-ll-int-good-firm-MC-2}:
\begin{alignat}{2}
	...
	\hat{\lambda}_{\eta t} &= {\alpha_{\eta}} \hat{R}_{Kt} + (1- {\alpha_{\eta}}) \hat{W}_{t} - \hat{Z}_{A\eta t} - \hat{P}_{\eta t} \label{eq_v6:reg-ll-int-good-firm-MC-3}
\end{alignat}
...
\begin{align}
	...
	\end{split} \nonumber \\
	& \hat{R}_t = \gamma_R \hat{R}_{t-1} + (1-\gamma_R)(\gamma_\pi \hat{\pi}_t + \gamma_Y \hat{Y}_t) + \hat{Z}_{Mt} \label{eq_v6:reg-ll-monetary-policy}
\end{align}
...
Log-linearize \ref{eq_v6:reg-gross-inflation-rate} and define the level deviation of gross inflation rate $\hat{\pi}_t$:
\begin{align}
	\tag{\ref{eq_v6:reg-gross-inflation-rate}}
	\pi_{t} &= \frac{P_{t}}{P_{t-1}} \implies \\
	\hat{\pi}_{t} &= \hat{P}_{t} - \hat{P}_{t-1}
	\label{eq_v6:reg-level-dev-gross-inflation-rate}
\end{align}
...
\begin{align}
	\left\langle \begin{matrix} \theta_{Y1} & (1-\theta_{Y1}) \end{matrix} \right\rangle \coloneq \left\langle \begin{matrix} \frac{Y_{1}}{Y} & \frac{Y_{2}}{Y} \end{matrix} \right\rangle \label{eq_v6:reg-ss-Y1-Y2-weight-in-Y}
\end{align}
...
\begin{align}
	\hat{Y}_{t} &= \theta_{Y1} \hat{Y}_{1t} + (1-\theta_{Y1}) \hat{Y}_{2t} \label{eq_v6:reg-ll-market-clearing-condition-Yt-3}
\end{align}
...
Log-linearize \ref{eq_v6:national-price-level}:
\begin{alignat}{2}
	P_{t} Y_{t} &= P_{1t} Y_{1t} + P_{2t} Y_{2t} & \implies \tag{\ref{eq_v6:national-price-level}} \\ 
...
\begin{alignat}{2}
	\hat{P}_{t} + \hat{Y}_{t} &= \theta_{Y1} (\hat{P}_{1t} + \hat{Y}_{1t}) + (1-\theta_{Y1}) (\hat{P}_{2t} + \hat{Y}_{2t})  \label{eq_v6:reg-ll-national-price-level-2}
\end{alignat}
...
\begin{alignat}{2}
	...
	\hat{P}_{t} &= \theta_{Y1} \hat{P}_{1t} + (1-\theta_{Y1}) \hat{P}_{2t} \label{eq_v6:reg-ll-national-price-level-3}
\end{alignat}
...
Log-linearize \ref{eq_v6:reg-regional-demand}:
\begin{align}
	Y_{\eta t} &= C_{\eta t} + I_{\eta t} \implies \tag{\ref{eq_v6:reg-regional-demand}} \\
	Y_{\eta} (1 +\hat{Y}_{\eta t}) &= C_{\eta} (1 +\hat{C}_{\eta t}) + I_{\eta} (1 +\hat{I}_{\eta t}) \implies \nonumber \\
	\hat{Y}_{\eta t} &= \frac{C_{\eta}}{Y_{\eta}} \hat{C}_{\eta 1 t} + \frac{I_{\eta}}{Y_{\eta}} \hat{I}_{\eta t} \label{eq_v6:reg-ll-total-yn}
\end{align}
...
\begin{align}
	\left\langle \begin{matrix} \theta_{C\eta} & (1 - \theta_{C\eta}) \end{matrix} \right\rangle \coloneq \left\langle \begin{matrix} \frac{C_{\eta}}{Y_{\eta}} & \frac{I_{\eta}}{Y_{\eta}} \end{matrix} \right\rangle \label{eq_v6:reg-ss-C-I-weight-in-Y}
\end{align}

Substitute \ref{eq_v6:reg-ss-C-I-weight-in-Y} in \ref{eq_v6:reg-ll-total-yn}:
\begin{align}
	\hat{Y}_{\eta t} &= \theta_{C\eta} \hat{C}_{\eta t} + (1 - \theta_{C\eta}) \hat{I}_{\eta t} \label{eq_v6:reg-ll-total-yn-2}
\end{align}
...
Log-linearize \ref{eq_v6:reg-regional-demand}:
\begin{align}
	Y_{\eta t} &= C_{\eta 1 t} + C_{\eta 2 t} + I_{\eta t} \implies \tag{\ref{eq_v6:reg-regional-demand}} \\
	Y_{\eta} (1 +\hat{Y}_{\eta t}) &= C_{\eta 1} (1 +\hat{C}_{\eta 1 t}) + C_{\eta 2} (1 +\hat{C}_{\eta 2 t}) + I_{\eta} (1 +\hat{I}_{\eta t}) \implies \nonumber \\
	\hat{Y}_{\eta t} &= \frac{C_{\eta 1}}{Y_{\eta}} \hat{C}_{\eta 1 t} + \frac{C_{\eta 2}}{Y_{\eta}} \hat{C}_{\eta 2 t} + \frac{I_{\eta}}{Y_{\eta}} \hat{I}_{\eta t} \label{eq_v6:reg-ll-total-yn}
\end{align}
...
\begin{align}
	\label{eq_v6:reg-ss-C-I-weight-in-Y}
...
Substitute \ref{eq_v6:reg-ss-C-I-weight-in-Y} in \ref{eq_v6:reg-ll-total-yn}:
\begin{align}
	\hat{Y}_{\eta t} &= \theta_{C\eta 1} \hat{C}_{\eta 1 t} + \theta_{C\eta 2} \hat{C}_{\eta 2 t} + (1 - \theta_{C\eta 1} - \theta_{C\eta 2}) \hat{I}_{\eta t} \label{eq_v6:reg-ll-total-yn-2}
\end{align}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Law of Motion for Capital
		\begin{alignat}{2}
			\hat{K}_{\eta, t+1} &= (1-\delta) \hat{K}_{\eta t} + \delta \hat{I}_{\eta t} \tag{\ref{eq_v6:reg-ll-law-of-motion-for-capital}}
		\end{alignat}
...
\begin{align}
	\hat{C}_{\eta t} &= \omega_{\eta 1} \hat{C}_{\eta 1 t} + (1-\omega_{\eta 1}) \hat{C}_{\eta 2 t} \tag{\ref{eq_v6:reg-ll-consumption-aggregation}}
\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{align}
			\hat{C}_{\eta 1 t} - \hat{C}_{\eta 2 t} &= \hat{P}_{2 t} - \hat{P}_{1 t} \tag{\ref{eq_v6:reg-ll-regional-consumption-and-prices}}
		\end{align}	
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
		...
		\item Total Expenses
		\begin{align}
			\hat{\mathscr{E}}_{\eta t} &= \hat{C}_{\eta t} + \omega_{\eta 1} \hat{P}_{1 t} + (1 -\omega_{\eta 1}) \hat{P}_{2 t} \tag{\ref{eq_v6:reg-ll-total-expense-level}}
		\end{align}

		\item Labor Supply
		\begin{alignat}{2}
			\varphi \hat{L}_{\eta t} - (1 -\sigma) \hat{C}_{\eta t} &= \hat{W}_t - \hat{ \mathscr{E} }_{\eta t} \tag{\ref{eq_v6:reg-ll-labor-supply}}
		\end{alignat}
		
		\item Euler equation for the bonds return
		\begin{alignat}{2}
			& \E \left\{ \hat{\mathscr{E}}_{\eta, t+1} - (1 -\sigma)\hat{C}_{\eta, t+1} \right\} - \nonumber \\ & \qquad - [\hat{\mathscr{E}}_{\eta t} - (1 -\sigma)\hat{C}_{\eta t}] = (1 -\beta) \hat{R}_{t} \tag{\ref{eq_v6:reg-ll-bonds-euler-equation}}
		\end{alignat}
		
		\item Euler equation for the capital return
		\begin{alignat}{2}
			& \E \left\{ \hat{\mathscr{E}}_{\eta, t+1} - \hat{P}_{\eta, t+1}  - (1 -\sigma) \hat{C}_{\eta, t+1} \right\} - (\hat{\mathscr{E}}_{\eta t} - \hat{P}_{\eta t} - (1 -\sigma) \hat{C}_{\eta t}) = \nonumber \\
			& \qquad = \beta r_{K} \mathbb{E}_t \left\{ \hat{R}_{K, t+1} - \hat{P}_{\eta, t+1} \right\} \tag{\ref{eq_v6:reg-ll-capital-euler-equation}}
		\end{alignat}
		
		\item Production Function
		\begin{align}
			\hat{Y}_{\eta t} &= \hat{Z}_{A\eta t} + {\alpha_{\eta}} \hat{K}_{\eta t} + (1-\alpha_{\eta}) \hat{L}_{\eta t} \tag{\ref{eq_v6:reg-ll-final-goods-firm-bundle-rule-3}}
		\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{align}
			\hat{K}_{\eta t} - \hat{L}_{\eta t} &= \hat{W}_{t} - \hat{R}_{K t} \tag{\ref{eq_v6:reg-ll-int-good-firm-TMRS}}
		\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\item Marginal Cost
		\begin{alignat}{2}
			\hat{\lambda}_{\eta t} &= {\alpha_{\eta}} \hat{R}_{Kt} + (1- {\alpha_{\eta}}) \hat{W}_{t} - \hat{Z}_{A\eta t} - \hat{P}_{\eta t} \tag{\ref{eq_v6:reg-ll-int-good-firm-MC-3}}
		\end{alignat}
		
		\item Monetary Policy
		\begin{align}
			& \hat{R}_t = \gamma_R \hat{R}_{t-1} + (1-\gamma_R)(\gamma_\pi \hat{\pi}_t + \gamma_Y \hat{Y}_t) + \hat{Z}_{Mt} \tag{\ref{eq_v6:reg-ll-monetary-policy}}
		\end{align}
		...
		\item National Price Level
		\begin{alignat}{2}
			\hat{P}_{t} &= \theta_{Y1} \hat{P}_{1t} + (1-\theta_{Y1}) \hat{P}_{2t} \tag{\ref{eq_v6:reg-ll-national-price-level-3}}
		\end{alignat}
		...
		\item Market Clearing Condition
		\begin{align}
			\hat{Y}_{t} &= \theta_{Y1} \hat{Y}_{1t} + (1-\theta_{Y1}) \hat{Y}_{2t} \tag{\ref{eq_v6:reg-ll-market-clearing-condition-Yt-3}}
		\end{align}
		
		\item Regional Market Clearing Condition
		\begin{align}
			\hat{Y}_{\eta t} &= \theta_{C\eta} \hat{C}_{\eta t} + (1 - \theta_{C\eta}) \hat{I}_{\eta t} \tag{\ref{eq_v6:reg-ll-total-yn-2}}
		\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{alignat}{2}
			...
			\varphi \hat{L}_{2 t} - (1 -\sigma) \hat{C}_{2 t} = \hat{W}_t - \hat{ \mathscr{E} }_{2 t} \tag{\ref{eq_v6:reg-ll-labor-supply}}
		\end{alignat}
