...
Substitute \ref{eq_v6:reg-ss-p1-za1} and \ref{eq_v6:reg-ss-marginal-cost} in \ref{eq_v6:reg-ss-int-good-firm-FOC-Lt} for the nominal wage $W_{\eta}$:
\begin{alignat}{2}
...
\end{comment}
	...
	\begin{align}
		...
		& \text{where:} \quad a_{\eta} = \left[ \frac{\Lambda_{} Z_{A\eta}^{1 + \varphi}}{\phi  Q_{\eta}} \right]^{\frac{1}{\sigma}} \label{eq_v6:reg-ss-a-eta}
	\end{align}
...
\begin{align}
	...
	& \text{where: } b_{1} = \left( \frac{1 - \omega_{11}}{\omega_{11} \theta_{P}} \right) \label{eq_v6:reg-ss-b1}
\end{align}
...
\begin{align}
	...
	C_{22} &= C_{21} \left( \frac{1 - \omega_{21}}{\omega_{21} \theta_{P}} \right) \label{eq_v6:reg-ss-C22}
\end{align}

Substitute \ref{eq_v6:reg-ss-C22} in \ref{eq_v6:reg-ss-consumption-aggregation}:
\begin{align}
	C_{2} &= C_{21}^{\omega_{21}} C_{22}^{1-\omega_{21}} = C_{21}^{\omega_{21}} \left[ C_{21} \left( \frac{1 - \omega_{21}}{\omega_{21} \theta_{P}} \right) \right]^{1-\omega_{21}} \tag{\ref{eq_v6:reg-ss-consumption-aggregation}} \implies \\
	C_{21} &= C_{2} b_{2}^{\omega_{21} - 1} \label{eq_v6:reg-ss-C21} \\
	& \text{where: } b_{2} = \left( \frac{1 - \omega_{21}}{\omega_{21} \theta_{P}} \right) \label{eq_v6:reg-ss-b2}
\end{align}
...
Substitute \ref{eq_v6:reg-ss-C11}, \ref{eq_v6:reg-ss-C12} and \ref{eq_v6:reg-ss-consumption} in \ref{eq_v6:reg-ss-regional-demand}:
	\begin{alignat}{2}
		P_{1} Y_{1} &= P_{1} C_{11} + P_{2} C_{12} &\implies \tag{\ref{eq_v6:reg-ss-regional-demand}} \\
		P_{1} Y_{1} &= P_{1} C_{1} b_{1}^{\omega_{11} - 1} + \theta_{P} P_{1} C_{1} b_{1}^{\omega_{11}} &\implies \nonumber \\
		Y_{1} &= \left[ a_{1} b_{1}^{\omega_{11}} \left( \theta_{P} + \frac{1}{b_{1}} \right) \right]^{\frac{\sigma}{\sigma + \varphi}} \label{eq_v6:reg-ss-y1}
...
Substitute \ref{eq_v6:reg-ss-C21}, \ref{eq_v6:reg-ss-C22} and \ref{eq_v6:reg-ss-consumption} in \ref{eq_v6:reg-ss-regional-demand}:
\begin{alignat}{2}
	P_{2} Y_{2} &= P_{1} C_{21} + P_{2} C_{22} &\implies \tag{\ref{eq_v6:reg-ss-regional-demand}} \\
	\theta_{P} Y_{2} &= C_{2} b_{2}^{\omega_{21} - 1} + \theta_{P} C_{2} b_{2}^{\omega_{21}} &\implies \nonumber \\
	Y_{2} &= \left[ a_{2} b_{2}^{\omega_{21}} \left( 1 + \frac{1}{\theta_{P} b_{2}} \right) \right]^{\frac{\sigma}{\sigma + \varphi}} \label{eq_v6:reg-ss-y2}
	% a_{2} b_{2}^{\omega_{21}} Y_{2}^{\sfrac{-\varphi}{\sigma}} &= b_{2} \left( Y_{1} - a_{1} b_{1}^{\omega_{11} - 1} Y_{1}^{\sfrac{-\varphi}{\sigma}} \right) \\
	% Y_{2} &= \left[ \frac{b_{2} \left( Y_{1} - a_{1} b_{1}^{\omega_{11} - 1} Y_{1}^{\sfrac{-\varphi}{\sigma}} \right) }{a_{2} b_{2}^{\omega_{21}}} \right]^{\sfrac{-\sigma}{\varphi}} \label{eq_v6:reg-ss-total-yn-2}
\end{alignat}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	% The result of \ref{eq_v6:reg-ss-y1} and \ref{eq_v6:reg-ss-y2} determines $Y, C_{\eta}, \te[],  C_{\eta 1}, C_{\eta 2}, K_{\eta}, L_{\eta}$ in \ref{eq_v6:reg-ss-market-clearing-condition}, \ref{eq_v6:reg-ss-investment}, \ref{eq_v6:reg-ss-consumption}, \ref{eq_v6:reg-ss-q1},  \ref{eq_v6:reg-ss-C1-Cn-3}, \ref{eq_v6:reg-ss-C12}, \ref{eq_v6:reg-ss-int-good-firm-FOC-Kt-2} and \ref{eq_v6:reg-ss-int-good-firm-FOC-Lt-2}, respectively.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{align}
		...
		\\
		\te[] &= \frac{P_{} C_{\eta}}{\omega_{\eta 1}^{\omega_{\eta 1}} (1 -\omega_{\eta 1})^{1 -\omega_{\eta 1}}} \tag{\ref{eq_v6:reg-ss-q1}}
		\\
...
\subsubsection*{Region 1 Consumption Weights}

Log-linearize \ref{eq_v6:reg-C-eta-12-t}:
\begin{align}
	\frac{C_{11t}}{C_{12t}} &= \frac{\omega_{11} P_{2t}}{(1 - \omega_{11}) P_{1t}} \tag{\ref{eq_v6:reg-C-eta-12-t}} \implies \\
	\hat{P}_{1 t} - \hat{P}_{2 t} &= \hat{C}_{\eta 2 t} - \hat{C}_{\eta 1 t} \label{eq_v6:reg-ll-C-eta-12-t}
\end{align}	
