...
\begin{align}
	...
	\begin{split}
		...
		% \\ & \quad = 
		W_t L_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t}
...
% The maximization problem with restrictions can be transformed into one without restriction using the Lagrangian function $\mathcal{L}$ formed by \ref{eq_v5:reg-utility-function} and \ref{eq_v5:reg-budget-constraint-2}:
\begin{align}
	\begin{split}
	...
	\\ & \qquad - \mu_{\eta t} \Big[ P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} + B_{\eta t} \left. - ( W_t L_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t} ) \Big] \right\} \label{eq_v5:reg-household-lagrangian}
	\end{split}
\end{align}
...
\begin{align}
	...
	\\
	L_{\eta t}: \quad & -\phi L_{\eta t}^{\varphi} +\mu_{\eta t} W_t = 0 \implies \mu_{\eta t} = \frac{\phi L_{\eta t}^{\varphi}}{W_t} \label{eq_v5:reg-household-FOC-Lt} 
	\\
	\begin{split}
	...
	\\
	\begin{split}
		\mu_{\eta t}: \quad & P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} + P_{\eta t} [ K_{\eta, t+1} - (1-\delta)K_{\eta t} ] + B_{\eta t} = \\ & \qquad = W_t L_{\eta t} + R_{Kt} K_{\eta t} + (1 + R_{t-1}) B_{\eta,t-1} + \Pi_{\eta t}
...
\begin{align}
	Q_{\eta t} C_{\eta t} = P_{1 t} C_{\eta 1 t} + P_{2 t} C_{\eta 2 t} \label{eq_v5:reg-total-expense}
\end{align}
...
\begin{alignat}{2}
	...
	C_{\eta 2 t} &= \frac{Q_{\eta t} C_{\eta t}}{P_{2 t}} (1 -\omega_{\eta 1}) \label{eq_v5:reg-Cn-Cv-2}
\end{alignat}
...
Rewrite \ref{eq_v5:reg-Cn-Cn} in terms of \ref{eq_v5:reg-total-expense-level} and isolate $(\sfrac{1}{Q_{\eta t}})$:
	\begin{alignat}{2}
		...
		C_{\eta 1 t} &= \frac{Q_{\eta t} C_{\eta t}}{P_{1 t}} \omega_{\eta 1} \iff \frac{1}{Q_{\eta t}} = \frac{\omega_{\eta 1} C_{\eta t}}{P_{1 t} C_{\eta 1 t}} \label{eq_v5:reg-Cn-Cn-2}
	\end{alignat}
...
\begin{align}
	\frac{C_{\eta 1 t}}{C_{\eta 2 t}} &= \frac{\frac{Q_{\eta t} C_{\eta t}}{P_{1 t}} \omega_{\eta 1}}{\frac{Q_{\eta t} C_{\eta t}}{P_{2 t}} (1 -\omega_{\eta 1})} \implies \nonumber \\
...
\begin{align}
	...
	\mu_{\eta t} &= \frac{ C_{\eta t}^{-\sigma}}{Q_{\eta t}} \label{eq_v5:reg-FOC-C1-eta-t2}
\end{align}

Match \ref{eq_v5:reg-FOC-C1-eta-t2} and \ref{eq_v5:reg-household-FOC-Lt}:
\begin{align}
	\mu_{\eta t} = \frac{ C_{\eta t}^{-\sigma}}{Q_{\eta t}} &= \frac{\phi L_{\eta t}^{\varphi}}{W_t} \implies \nonumber \\
	\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{-\sigma}} &= \frac{W_t}{Q_{\eta t}} \label{eq_v5:reg-labor-supply}
\end{align}
...
\begin{alignat}{2}
	...
	\\
	\frac{ C_{\eta t}^{-\sigma}}{Q_{\eta t}} &= \beta (1 + R_{t}) \E \left\{ \frac{ C_{\eta, t+1}^{-\sigma}}{Q_{\eta, t+1}} \right\} \label{eq_v5:reg-bonds-euler-equation}
\end{alignat}
...
\begin{align}
	...
	\min_{L_{\eta jt}}: \quad & W_t L_{\eta jt} \\
	\label{eq_v5:reg-int-good-firm-production-function}
	\st: \quad & Y_{\eta jt} = Z_{A\eta t} L_{\eta jt}^{1-\alpha_{\eta}}
\end{align}

where $Y_{\eta jt}$ is the output obtained by the technology level $Z_{A\eta t}$ that transforms labor $L_{\eta jt}$ into intermediate goods, with returns to scale determined by $(1-\alpha_{\eta})$.\footnote{the production technology level $Z_{A\eta t}$ will be submitted to a productivity shock, detailed in section \ref{sec_v5:reg-productivity-shock}.}
...
\begin{align}
	...
	\mathcal{L} = (W_t L_{\eta jt}) - \Lambda_{\eta jt} (Z_{A\eta t} L_{\eta jt}^{1-\alpha_{\eta}} - Y_{\eta jt})
\end{align}
...
The first-order condition is:
\begin{alignat}{2}
	L_{\eta jt}: \quad & W_t - \Lambda_{\eta jt} Z_{A\eta t} (1-\alpha_{\eta}) L_{\eta jt}^{-{\alpha_{\eta}}} = 0 \quad &&\implies \nonumber \\ 
	& L_{\eta jt} = (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta jt}}{W_t} \label{eq_v5:reg-int-good-firm-FOC-Lt} \\
	\Lambda_{\eta jt}: \quad & Y_{\eta jt} = Z_{A\eta t} L_{\eta jt}^{1-\alpha_{\eta}} \tag{\ref{eq_v5:reg-int-good-firm-production-function}}
\end{alignat}
...
\begin{align}
	...
	\frac{K_{\eta jt}}{L_{\eta jt}} = \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_t}{R_{Kt}} \label{eq_v5:reg-int-good-firm-TMRS}
\end{align}
...
\begin{alignat}{2}
	...
	K_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_t}{R_{Kt}}\right]^{1-\alpha_{\eta}} \label{eq_v5:reg-int-good-firm-Kt-demand}
\end{alignat}
...
\begin{alignat}{2}
	...
	L_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left[ \left( \frac{{\alpha_{\eta}}}{1-\alpha_{\eta}} \right) \frac{W_t}{R_{Kt}}\right]^{-{\alpha_{\eta}}} \label{eq_v5:reg-int-good-firm-Lt-demand}
\end{alignat}
...
\begin{alignat}{2}
	...
	TC_{\eta jt} & = \frac{Y_{\eta jt}}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_t}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \label{eq_v5:reg-int-good-firm-TC}
\end{alignat}
...
\begin{align}
	...
	\Lambda_{\eta jt} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_t}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \label{eq_v5:reg-int-good-firm-MC}
\end{align}
...
Notice that:
\begin{align}
	TC_{\eta jt} &= W_{t} N_{\eta jt} = (1-\alpha) \Lambda_{\eta jt} Y_{\eta jt} \nonumber \\
	MC_{\eta jt} &= \frac{\partial TC_{\eta jt}}{\partial Y_{\eta jt}} =  (1-\alpha_{\eta}) \Lambda_{\eta jt} \nonumber \\
	TC_{\eta jt} &= MC_{\eta jt} Y_{\eta jt} \label{eq_v5:reg-int-good-firm-TC-MC}
\end{align}
...
{\singlespacing
	...
	\begin{itemize}
		...
		\item from the household problem: $\langle \begin{smallmatrix} C_{\eta t} & L_{\eta t} & B_{\eta t} & K_{\eta, t+1} & C_{\eta 1t} & C_{\eta 2t} & Q_{\eta t} \end{smallmatrix} \rangle$;
	...
	\begin{enumerate}
		...
		\begin{comment}
			...
			\begin{align}
				C_{\eta 1 t} &= Q_{\eta t} \frac{\omega_{\eta 1}}{P_{1 t}} \tag{\ref{eq_v5:reg-Cn-Cn-2}}
			\end{align}
			
			\item Regional Consumption of good 2:
			\begin{align}
				C_{\eta 2 t} &= Q_{\eta t} \frac{1 -\omega_{\eta 1}}{P_{2 t}} \tag{\ref{eq_v5:reg-Cn-Cv-2}}
			\end{align}
		...
		\item Labor Supply:
		\begin{align}
			\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{1-\sigma}} = \frac{W_t}{Q_{\eta t}} \tag{\ref{eq_v5:reg-labor-supply}}
		\end{align}
		...
		\begin{align}
			\frac{ C_{\eta t}^{1-\sigma}}{Q_{\eta t}} P_{\eta t} &= \beta \mathbb{E}_t \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{Q_{\eta, t+1}} [(1-\delta) P_{\eta, t+1} + R_{K,t+1}] \right\} \tag{\ref{eq_v5:reg-capital-euler-equation}}
		\end{align}
		...
		\begin{align}
			Y_{\eta jt} = Z_{A\eta t} K_{\eta jt}^{\alpha_{\eta}} L_{\eta jt}^{1-\alpha_{\eta}} \tag{\ref{eq_v5:reg-int-good-firm-production-function}}
		\end{align}
		
		\item Capital Demand:
		\begin{align}
			K_{\eta jt} = {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} \tag{\ref{eq_v5:reg-int-good-firm-FOC-Kt}}
		\end{align}
		
		\item Labor Demand:
		\begin{align}
			L_{\eta jt} = (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_t} \tag{\ref{eq_v5:reg-int-good-firm-FOC-Lt}}
		\end{align}
		
		\item Marginal Cost:
		\begin{align}
			\Lambda_{\eta t} = \frac{1}{Z_{A\eta t}} \left( \frac{R_{Kt}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W_t}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \tag{\ref{eq_v5:reg-int-good-firm-MC-2}}
		\end{align}
...
\begin{comment}
	...
	\item Regional Consumption of good 1:
\begin{align}
	C_{\eta 1 t} &= Q_{\eta t} \frac{\omega_{\eta 1}}{P_{1 t}} \implies \tag{\ref{eq_v5:reg-Cn-Cn-2}} \\
	C_{\eta 1} &= \te[] \frac{\omega_{\eta 1}}{P_{1}} \label{eq_v5:reg-ss-C1-Cn-2}
\end{align}

\item Regional Consumption of good 2:
\begin{align}
	C_{\eta 2 t} &= Q_{\eta t} \frac{1 -\omega_{\eta 1}}{P_{2 t}} \implies \tag{\ref{eq_v5:reg-Cn-Cv-2}} \\
...
\end{comment}
	...
	\item Labor Supply:
	\begin{align}
		\frac{\phi L_{\eta t}^{\varphi}}{C_{\eta t}^{1-\sigma}} &= \frac{W_t}{Q_{\eta t}} \implies \tag{\ref{eq_v5:reg-labor-supply}} \\
	...
	\item Production Function:
	\begin{align}
		Y_{\eta jt} = Z_{A\eta t} K_{\eta jt}^{\alpha_{\eta}} L_{\eta jt}^{1-\alpha_{\eta}} \implies Y_{\eta j} = Z_{A\eta} K_{\eta j}^{\alpha_{\eta}} L_{\eta j}^{1-\alpha_{\eta}} \label{eq_v5:reg-ss-int-good-firm-production-function}
	\end{align}
	
	\item Capital Demand:
	\begin{align}
		K_{\eta jt} = {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{Kt}} \implies K_{\eta j} = {\alpha_{\eta}} Y_{\eta j} \frac{\Lambda_{\eta}}{R_K} \label{eq_v5:reg-ss-int-good-firm-FOC-Kt}
	\end{align}
	
	\item Labor Demand:
	\begin{align}
		L_{\eta jt} = (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_t} \implies L_{\eta j} = (1 -{\alpha_{\eta}}) Y_{\eta j} \frac{\Lambda_{\eta}}{W} \label{eq_v5:reg-ss-int-good-firm-FOC-Lt}
	\end{align}
	...
	\begin{align}
		...
		\Lambda_{\eta} &= \frac{1}{Z_{A\eta}} \left( \frac{R_K}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \label{eq_v5:reg-ss-int-good-firm-MC-2}
	\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{align}
		...
		\\ % Z_{A2} &= \frac{1}{\Lambda_{}} \left( \frac{R_K}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} \tag{\ref{eq_v5:reg-ss-za2}}
...
\begin{alignat}{2}
	L_{\eta jt} &= (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{t}} &\implies \tag{\ref{eq_v5:reg-int-good-firm-FOC-Lt}} \\
...
\begin{alignat}{2}
	& \Lambda_{\eta t} = Z_{A\eta t}^{-1} \frac{R_{Kt}^{{\alpha_{\eta}}} W_t^{1-\alpha_{\eta}}}{{\alpha_{\eta}}^{{\alpha_{\eta}}} (1-\alpha_{\eta})^{1-\alpha_{\eta}}} \implies \tag{\ref{eq_v5:reg-int-good-firm-MC-2}} \\
