...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{align}
		...
		\\ % Z_{A2} &= \frac{1}{\Lambda_{}} \left( \frac{R_K}{{\alpha_{}}} \right)^{{\alpha_{}}} \left( \frac{W}{1-{\alpha_{}}} \right)^{1-{\alpha_{}}} \tag{\ref{eq:reg-ss-za2}}
...
Log-linearize \ref{eq:reg-capital-euler-equation}:
	\begin{alignat}{2}
		...
		& \qquad = \beta r_{K\eta} \mathbb{E}_t \left\{ \hat{R}_{K, t+1} - \hat{P}_{\eta, t+1} \right\} \label{eq:reg-ll-capital-euler-equation} \\
		& \qquad \text{where: } r_{K\eta} = \frac{R_{K}}{P_{\eta}} \label{eq:reg-rk-eta}
	\end{alignat}
...
\begin{comment}
	...
	\hat{P}_{t} &= \theta_{P1} \hat{P}_{1t} + (1 -\theta_{P1}) \hat{P}_{2t} % \label{eq:reg-ll-national-price-level}	
\end{comment}
...
\begin{enumerate}
	...
	\item Law of Motion for Capital
	\begin{alignat}{2}
		\hat{K}_{2, t+1} = (1-\delta) \hat{K}_{2 t} + \delta \hat{I}_{2 t}
	\end{alignat}
	...
	\item Regional Levels of Consumption and Prices
	\begin{align}
		\hat{C}_{2 1 t} - \hat{C}_{2 2 t} = \hat{P}_{2 t} - \hat{P}_{1 t}
	\end{align}
	...
	\item Total Expenses
	\begin{align}
		\hat{\mathscr{E}}_{2 t} = \hat{C}_{2 t} + \omega_{2 1} \hat{P}_{1 t} + (1 -\omega_{2 1}) \hat{P}_{2 t}
	\end{align}
	...
	\item Labor Supply
	\begin{alignat}{2}
		\varphi \hat{L}_{2 t} - (1 -\sigma) \hat{C}_{2 t} = \hat{W}_t - \hat{ \mathscr{E} }_{2 t}
	\end{alignat}
	
	\item Euler equation for the bonds return
	\begin{alignat}{2}
		\E \left\{ \hat{\mathscr{E}}_{1, t+1} - (1 -\sigma)\hat{C}_{1, t+1} \right\} - \nonumber \\  \qquad - [\hat{\mathscr{E}}_{1 t} - (1 -\sigma)\hat{C}_{1 t}] = (1 -\beta) \hat{R}_{t}
	\end{alignat}
	
	\item Euler equation for the bonds return
	\begin{alignat}{2}
		\E \left\{ \hat{\mathscr{E}}_{2, t+1} - (1 -\sigma)\hat{C}_{2, t+1} \right\} - \nonumber \\  \qquad - [\hat{\mathscr{E}}_{2 t} - (1 -\sigma)\hat{C}_{2 t}] = (1 -\beta) \hat{R}_{t}
	\end{alignat}
	
	\item Euler equation for the capital return
	\begin{alignat}{2}
		\E \left\{ \hat{\mathscr{E}}_{1, t+1} - \hat{P}_{1, t+1}  - (1 -\sigma) \hat{C}_{1, t+1} \right\} - (\hat{\mathscr{E}}_{1 t} - \hat{P}_{1 t} - (1 -\sigma) \hat{C}_{1 t}) = \nonumber \\
		\qquad = \beta \frac{R_{K}}{P_{1}} \mathbb{E}_t \left\{ \hat{R}_{K, t+1} - \hat{P}_{1, t+1} \right\}
	\end{alignat}
	
	\item Euler equation for the capital return
	\begin{alignat}{2}
		\E \left\{ \hat{\mathscr{E}}_{2, t+1} - \hat{P}_{2, t+1}  - (1 -\sigma) \hat{C}_{2, t+1} \right\} - (\hat{\mathscr{E}}_{2 t} - \hat{P}_{2 t} - (1 -\sigma) \hat{C}_{2 t}) = \nonumber \\
		\qquad = \beta \frac{R_{K}}{P_{2}} \mathbb{E}_t \left\{ \hat{R}_{K, t+1} - \hat{P}_{2, t+1} \right\}
	\end{alignat}
	...
	\item Production Function
	\begin{align}
		\hat{Y}_{2 t} = \hat{Z}_{A2 t} + {\alpha_{}} \hat{K}_{2 t} + (1-{\alpha_{}}) \hat{L}_{2 t}
	\end{align}
	...
	\item Marginal Rates of Substitution of Factors
	\begin{align}
		\hat{K}_{2 t} - \hat{L}_{2 t} = \hat{W}_{t} - \hat{R}_{K t}
	\end{align}
	...
	\item Marginal Cost
	\begin{alignat}{2}
		\hat{\lambda}_{2 t} = {\alpha_{}} \hat{R}_{Kt} + (1- {\alpha_{}}) \hat{W}_{t} - \hat{Z}_{A2 t} - \hat{P}_{2 t}
	\end{alignat}
	...
	\item Productivity Shock
	\begin{alignat}{2}
		\hat{Z}_{A1 t} = \rho_{A1} \hat{Z}_{A\eta, t-1} + \varepsilon_{A1}
	\end{alignat}
	
	\item Productivity Shock
	\begin{alignat}{2}
		\hat{Z}_{A2 t} = \rho_{A2} \hat{Z}_{A\eta, t-1} + \varepsilon_{A2}
	\end{alignat}
	...
	\item Regional Market Clearing Condition
	\begin{align}
		\hat{Y}_{2 t} = \theta_{C2 1} \hat{C}_{2 1 t} + \theta_{C2 2} \hat{C}_{2 2 t} + (1 - \theta_{C2 1} - \theta_{C2 2}) \hat{I}_{2 t}
	\end{align}
