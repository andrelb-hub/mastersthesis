...
if T_flag
    T = reg_model_v2_inv.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(34, 1);
lhs = y(37);
rhs = y(31)-y(4);
...
residual(27) = lhs - rhs;
lhs = y(36);
rhs = 0.6819999999999999*y(38)+0.318*y(37);
residual(28) = lhs - rhs;
lhs = y(25);
rhs = 0.6819999999999999*y(24)+0.318*y(23);
residual(29) = lhs - rhs;
lhs = y(23);
rhs = y(11)*T(4)+y(17)*(1-T(4));
residual(30) = lhs - rhs;
lhs = y(24);
rhs = y(12)*T(5)+y(18)*(1-T(5));
residual(31) = lhs - rhs;
lhs = y(26);
