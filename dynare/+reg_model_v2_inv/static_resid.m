...
if T_flag
    T = reg_model_v2_inv.static_resid_tt(T, y, x, params);
end
residual = zeros(34, 1);
residual(1) = y(27);
residual(2) = y(28);
...
residual(27) = lhs - rhs;
lhs = y(26);
rhs = 0.6819999999999999*y(28)+0.318*y(27);
residual(28) = lhs - rhs;
lhs = y(15);
rhs = 0.6819999999999999*y(14)+0.318*y(13);
residual(29) = lhs - rhs;
lhs = y(13);
rhs = T(4)*y(1)+y(7)*(1-T(4));
residual(30) = lhs - rhs;
lhs = y(14);
rhs = T(5)*y(2)+y(8)*(1-T(5));
residual(31) = lhs - rhs;
lhs = y(16);
