...
text(time_vector(end)*.95, C1t_e_M(end)*1.05, 'C1', 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Color', get(h1, 'Color')); 
hold on; 
h2 = plot(time_vector, C2t_e_M, 'LineWidth', 1.5);
text(time_vector(end), C2t_e_M(end), 'C2', 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Color', get(h2, 'Color')); 
hold on; 
h3 = plot(time_vector, I1t_e_M, 'LineWidth', 1.5);
text(time_vector(end)*.95, I1t_e_M(end)*1.05, 'I1', 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Color', get(h3, 'Color')); 
hold on; 
h4 = plot(time_vector, I2t_e_M, 'LineWidth', 1.5);
text(time_vector(end), I2t_e_M(end), 'I2', 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Color', get(h4, 'Color')); 
hold on; 
h5 = plot(time_vector, Y1t_e_M, 'LineWidth', 1.5);
text(time_vector(end)*.95, Y1t_e_M(end)*1.05, 'Y1', 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Color', get(h5, 'Color')); 
hold on; 
h6 = plot(time_vector, Y2t_e_M, 'LineWidth', 1.5);
text(time_vector(end), Y2t_e_M(end), 'Y2', 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Color', get(h6, 'Color')); 
hold on; 
hline = refline(0, 0);
set(hline, 'LineWidth', 2, 'Color', [0.75, 0.75, 0.75]); 
uistack(hline, 'bottom'); 
...
text(time_vector(end)*.95, variables{pair_indices(i)}(end)*1.05, variable_names{pair_indices(i)}, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Color', get(line_handles(i), 'Color')); 
end
hold off;
hline = refline(0, 0);
set(hline, 'LineWidth', 2, 'Color', [0.75, 0.75, 0.75]); 
