...
if T_flag
    T = reg_model_v2_inv_v2.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(34, 1);
lhs = y(37);
rhs = y(31)-y(4);
...
residual(27) = lhs - rhs;
lhs = y(36);
rhs = y(37)*T(11)+y(38)*(1-T(11));
residual(28) = lhs - rhs;
lhs = y(25);
rhs = y(23)*T(11)+y(24)*(1-T(11));
residual(29) = lhs - rhs;
lhs = y(23);
rhs = y(19)*T(12)+y(20)*T(13)+y(17)*(1-T(12)-T(13));
residual(30) = lhs - rhs;
lhs = y(24);
rhs = y(21)*T(14)+y(22)*T(15)+y(18)*(1-T(14)-T(15));
residual(31) = lhs - rhs;
lhs = y(26);
