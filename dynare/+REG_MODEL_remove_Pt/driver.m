...
M_.endo_names(20) = {'P1t'};
M_.endo_names_tex(20) = {'{\hat{P}_{1}}'};
M_.endo_names_long(20) = {'Price level of region 1'};
M_.endo_names(21) = {'P2t'};
M_.endo_names_tex(21) = {'{\hat{P}_{2}}'};
M_.endo_names_long(21) = {'Price level of region 2'};
M_.endo_names(22) = {'Rt'};
M_.endo_names_tex(22) = {'{\hat{R}}'};
M_.endo_names_long(22) = {'Interest rate'};
M_.endo_names(23) = {'RKt'};
M_.endo_names_tex(23) = {'{\hat{R}_{K}}'};
M_.endo_names_long(23) = {'Return on capital'};
M_.endo_names(24) = {'Wt'};
M_.endo_names_tex(24) = {'{\hat{W}}'};
M_.endo_names_long(24) = {'Wages'};
M_.endo_names(25) = {'pit'};
M_.endo_names_tex(25) = {'{\hat{\pi}}'};
M_.endo_names_long(25) = {'National gross inflation rate'};
M_.endo_names(26) = {'pi1t'};
M_.endo_names_tex(26) = {'{\hat{\pi}_{1}}'};
M_.endo_names_long(26) = {'Gross inflation rate in region 1'};
M_.endo_names(27) = {'pi2t'};
M_.endo_names_tex(27) = {'{\hat{\pi}_{2}}'};
M_.endo_names_long(27) = {'Gross inflation rate in region 2'};
M_.endo_names(28) = {'lambda1t'};
M_.endo_names_tex(28) = {'{\hat{\lambda}_{1}}'};
M_.endo_names_long(28) = {'Marginal cost in region 1'};
M_.endo_names(29) = {'lambda2t'};
M_.endo_names_tex(29) = {'{\hat{\lambda}_{2}}'};
M_.endo_names_long(29) = {'Marginal cost in region 2'};
M_.endo_names(30) = {'ZMt'};
M_.endo_names_tex(30) = {'{\hat{Z}_M}'};
M_.endo_names_long(30) = {'Monetary Policy'};
...
M_.equations_tags = {
  ...
  25 , 'name' , 'Market Clearing Condition' ;
  26 , 'name' , 'Regional Market Clearing Condition' ;
  27 , 'name' , '27' ;
  28 , 'name' , 'Productivity Shock' ;
  29 , 'name' , 'ZA2t' ;
  30 , 'name' , 'Monetary Shock' ;
};
M_.mapping.C1t.eqidx = [9 11 13 15 ];
M_.mapping.C2t.eqidx = [10 12 14 16 ];
M_.mapping.C11t.eqidx = [7 26 ];
M_.mapping.C21t.eqidx = [8 27 ];
M_.mapping.C12t.eqidx = [7 26 ];
M_.mapping.C22t.eqidx = [8 27 ];
M_.mapping.L1t.eqidx = [11 17 19 ];
M_.mapping.L2t.eqidx = [12 18 20 ];
M_.mapping.K1t.eqidx = [5 17 19 ];
M_.mapping.K2t.eqidx = [6 18 20 ];
M_.mapping.Yt.eqidx = [23 25 ];
M_.mapping.Y1t.eqidx = [17 25 26 ];
M_.mapping.Y2t.eqidx = [18 25 27 ];
M_.mapping.I1t.eqidx = [5 26 ];
M_.mapping.I2t.eqidx = [6 27 ];
M_.mapping.ZA1t.eqidx = [17 21 28 ];
M_.mapping.ZA2t.eqidx = [18 22 29 ];
M_.mapping.E1t.eqidx = [9 11 13 15 ];
M_.mapping.E2t.eqidx = [10 12 14 16 ];
M_.mapping.P1t.eqidx = [1 7 8 9 10 15 21 ];
M_.mapping.P2t.eqidx = [2 7 8 9 10 16 22 ];
...
M_.mapping.pi1t.eqidx = [1 3 24 ];
M_.mapping.pi2t.eqidx = [2 4 24 ];
M_.mapping.lambda1t.eqidx = [3 21 ];
M_.mapping.lambda2t.eqidx = [4 22 ];
M_.mapping.ZMt.eqidx = [23 30 ];
M_.mapping.e_A1.eqidx = [28 ];
M_.mapping.e_A2.eqidx = [29 ];
M_.mapping.e_M.eqidx = [30 ];
M_.static_and_dynamic_models_differ = false;
M_.has_external_function = false;
M_.state_var = [9 10 16 17 20 21 22 30 ];
...
save([M_.dname filesep 'Output' filesep 'REG_MODEL_remove_Pt_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_remove_Pt_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_remove_Pt_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_remove_Pt_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_remove_Pt_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_remove_Pt_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_remove_Pt_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
