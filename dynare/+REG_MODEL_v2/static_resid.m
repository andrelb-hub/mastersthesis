...
if T_flag
    T = REG_MODEL_v2.static_resid_tt(T, y, x, params);
end
residual = zeros(31, 1);
residual(1) = y(27);
residual(2) = y(28);
...
residual(6) = lhs - rhs;
lhs = y(1);
rhs = params(15)*y(3)+(1-params(15))*y(5);
residual(7) = lhs - rhs;
lhs = y(2);
rhs = params(16)*y(4)+(1-params(16))*y(6);
residual(8) = lhs - rhs;
lhs = y(3)-y(5);
rhs = y(6)-y(4);
residual(9) = lhs - rhs;
lhs = y(18);
rhs = y(1)+params(15)*y(21)+(1-params(15))*y(22);
residual(10) = lhs - rhs;
lhs = y(19);
rhs = y(2)+params(16)*y(21)+(1-params(16))*y(22);
residual(11) = lhs - rhs;
...
residual(24) = y(26);
lhs = y(20);
rhs = T(12)*y(21)+y(22)*(1-T(12));
residual(25) = lhs - rhs;
lhs = y(11);
rhs = T(12)*y(12)+y(13)*(1-T(12));
residual(26) = lhs - rhs;
lhs = y(12);
rhs = T(13)*y(1)+y(14)*(1-T(13));
residual(27) = lhs - rhs;
lhs = y(13);
rhs = T(13)*y(2)+y(15)*T(15);
residual(28) = lhs - rhs;
lhs = y(16);
