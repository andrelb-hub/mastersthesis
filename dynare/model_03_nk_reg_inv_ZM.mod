% command to run dynare and write a new file with all the choices:
% dynare model_03_nk_reg_inv savemacro=model_03_nk_reg_inv_ZM.mod
% dynare model_03_nk_reg_inv savemacro=model_03_nk_reg_inv_ZA1.mod
% dynare model_03_nk_reg_inv savemacro=model_03_nk_reg_inv_ZA2.mod
% diagnostic command:
...
% Parameter determined by real data:
thetaY  ${\theta_{Y}}$  (long_name='weight of region 1 in total production')
thetaC1 ${\theta_{C1}}$ (long_name='weight of consumption on production of region 1')
thetaC2 ${\theta_{C2}}$ (long_name='weight of consumption on production of region 2')
thetaZ  ${\theta_{C2}}$ (long_name='ZA2ss and ZA1ss ratio')
% -------------------------------------------------- % 
...
% teste:
thetaY  = 0.318  ; % weight of region 1 in total production
thetaC1 = 0.65   ; % weight of consumption on production of region 1
thetaC2 = 0.65   ; % weight of consumption on production of region 2
thetaZ  = 0.7076 ; % ZA2ss and ZA1ss ratio
% -------------------------------------------------- % 
