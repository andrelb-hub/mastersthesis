...
% Equation 3
\begin{dmath}
{{\hat{\pi}}}={{\beta}}\, {{\hat{\pi}}}+\frac{{{\hat{\lambda}_{}}}\, \left(1-{{\theta}}\right)\, \left(1-{{\beta}}\, {{\theta}}\right)}{{{\theta}}}
\end{dmath}
% Equation 4
\begin{dmath}
{{\hat{C}_{1 2}}}-{{\hat{C}_{1 1}}}={{\hat{C}_{2 2}}}-{{\hat{C}_{2 1}}}
\end{dmath}
% Equation 5
\begin{dmath}
...
% Equation 6
\begin{dmath}
\frac{{{\hat{C}_{1}}}-{{\hat{C}_{1 1}}}}{1-{{\omega_{11}}}}=\frac{{{\hat{C}_{2}}}-{{\hat{C}_{2 1}}}}{1-{{\omega_{21}}}}
\end{dmath}
% Equation 7
\begin{dmath}
...
% Equation 9
\begin{dmath}
{{\varphi}}\, {{\hat{L}_{1}}}+{{\sigma}}\, {{\hat{C}_{1}}}-\left({{\varphi}}\, {{\hat{L}_{2}}}+{{\sigma}}\, {{\hat{C}_{2}}}\right)={{\hat{W}_{1}}}-{{\hat{W}_{2}}}
\end{dmath}
% Equation 10
\begin{dmath}
...
% Equation 14
\begin{dmath}
{{\hat{\lambda}_{}}}={{\hat{W}_{1}}}-{{\hat{Z}_{A1}}}-{{\hat{P}_{1}}}
\end{dmath}
% Equation 15
\begin{dmath}
{{\hat{W}_{1}}}-{{\hat{Z}_{A1}}}-{{\hat{P}_{1}}}-\left({{\hat{W}_{2}}}-{{\hat{Z}_{A2}}}-{{\hat{P}_{2}}}\right)=0
\end{dmath}
% Equation 16
\begin{dmath}
{{\hat{R}}}={{\hat{R}}}\, {{\gamma_{R}}}+\left(1-{{\gamma_{R}}}\right)\, \left({{\hat{\pi}}}\, {{\gamma_{pi}}}+{{\gamma_{Y}}}\, {{\hat{Y}}}\right)+{{\hat{Z}_M}}
\end{dmath}
% Equation 17
\begin{dmath}
