...
if T_flag
    T = reg_model_v1_bonds.static_resid_tt(T, y, x, params);
end
residual = zeros(27, 1);
residual(1) = y(22);
residual(2) = y(23);
lhs = y(22);
rhs = params(1)*y(26)+y(24)*(1-params(5))*(1-params(1)*params(5))/params(5);
residual(3) = lhs - rhs;
lhs = y(22)-y(26);
rhs = x(4);
residual(4) = lhs - rhs;
lhs = y(23);
rhs = params(1)*y(27)+(1-params(1)*params(5))*(1-params(5))*y(25)/params(5);
residual(5) = lhs - rhs;
lhs = y(23)-y(27);
rhs = x(5);
residual(6) = lhs - rhs;
...
residual(20) = lhs - rhs;
lhs = y(21);
rhs = T(6)*y(22)+y(23)*(1-T(6));
residual(21) = lhs - rhs;
lhs = y(9);
rhs = T(4)/(T(4)+T(5))*y(10)+y(11)*(1-T(4)/(T(4)+T(5)));
residual(22) = lhs - rhs;
lhs = y(16)+y(10);
rhs = y(1)+y(15);
residual(23) = lhs - rhs;
