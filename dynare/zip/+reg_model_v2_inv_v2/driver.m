...
M_.mapping.C1t.eqidx = [9 13 19 ];
M_.mapping.C2t.eqidx = [10 14 20 ];
...
M_.mapping.C11t.eqidx = [7 9 30 ];
M_.mapping.C21t.eqidx = [8 10 30 ];
M_.mapping.C12t.eqidx = [7 31 ];
M_.mapping.C22t.eqidx = [8 31 ];
...
save([M_.dname filesep 'Output' filesep 'reg_model_v2_inv_v2_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'reg_model_v2_inv_v2_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'reg_model_v2_inv_v2_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'reg_model_v2_inv_v2_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'reg_model_v2_inv_v2_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'reg_model_v2_inv_v2_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'reg_model_v2_inv_v2_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
