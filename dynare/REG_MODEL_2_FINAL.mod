...
% dynare REG_MODEL_2 savemacro=REG_MODEL_2_FINAL.mod
% diagnostic command:
...
W1t       ${\hat{W}}$        (long_name='Wages in region 1')
W2t       ${\hat{W}}$        (long_name='Wages in region 2')
...
K2t(-1) - L2t = W2t - RKt;
[name='Marginal Cost']
lambda1t = alppha * RKt + (1 - alppha) * W1t - ZA1t - P1t;
lambda2t = alppha * RKt + (1 - alppha) * W2t - ZA2t - P2t;
