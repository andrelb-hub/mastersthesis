...
if T_flag
    T = REG_MODEL_v3.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(32, 1);
lhs = y(36);
rhs = y(29)-y(5);
...
residual(9) = lhs - rhs;
lhs = y(26);
rhs = y(9)+params(16)*y(29)+(1-params(16))*y(30);
residual(10) = lhs - rhs;
lhs = y(27);
rhs = y(10)+params(17)*y(29)+(1-params(17))*y(30);
residual(11) = lhs - rhs;
lhs = params(14)*y(15)-y(9)*(1-params(12));
rhs = y(33)-y(26);
residual(12) = lhs - rhs;
lhs = params(14)*y(16)-y(10)*(1-params(12));
rhs = y(34)-y(27);
residual(13) = lhs - rhs;
lhs = y(43)-(1-params(12))*y(41)-(y(26)-y(9)*(1-params(12)));
rhs = (1-params(3))*y(31);
residual(14) = lhs - rhs;
lhs = y(44)-(1-params(12))*y(42)-(y(27)-y(10)*(1-params(12)));
rhs = (1-params(3))*y(31);
residual(15) = lhs - rhs;
lhs = y(43)-y(45)-(1-params(12))*y(41)-(y(26)-y(29)-y(9)*(1-params(12)));
rhs = (y(47)-y(45))*params(3)*T(1);
residual(16) = lhs - rhs;
lhs = y(44)-y(46)-(1-params(12))*y(42)-(y(27)-y(30)-y(10)*(1-params(12)));
