...
if T_flag
    T = model_03_nk_reg_inv.static_resid_tt(T, y, x, params);
end
residual = zeros(34, 1);
residual(1) = y(27);
residual(2) = y(28);
...
residual(27) = lhs - rhs;
lhs = y(26);
rhs = T(6)*y(27)+y(28)*(1-T(6));
residual(28) = lhs - rhs;
lhs = y(15);
rhs = y(13)*params(18)+y(14)*(1-params(18));
residual(29) = lhs - rhs;
lhs = y(13);
rhs = y(1)*params(19)+(1-params(19))*y(7);
residual(30) = lhs - rhs;
lhs = y(14);
rhs = y(2)*params(20)+(1-params(20))*y(8);
residual(31) = lhs - rhs;
lhs = y(16);
