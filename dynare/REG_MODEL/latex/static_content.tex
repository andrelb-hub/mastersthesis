...
% Equation 25
\begin{dmath}
{{\hat{Y}}}+{{\hat{P}}}={{\theta_{PY1}}}\, \left({{\hat{P}_{1}}}+{{\hat{Y}_{1}}}\right)+\left(1-{{\theta_{PY1}}}\right)\, \left({{\hat{P}_{2}}}+{{\hat{Y}_{2}}}\right)
\end{dmath}
% Equation 26
\begin{dmath}
{{\hat{Y}}}={{\hat{Y}_{1}}}\, {{\theta_{Y1}}}+{{\hat{Y}_{2}}}\, \left(1-{{\theta_{Y1}}}\right)
\end{dmath}
% Equation 27
\begin{dmath}
{{\hat{Y}_{1}}}={{\hat{C}_{1 1}}}\, {{\theta_{C11}}}+{{\hat{C}_{1 2}}}\, {{\theta_{C12}}}+{{\hat{I}_{1}}}\, \left(1-{{\theta_{C11}}}-{{\theta_{C12}}}\right)
\end{dmath}
% Equation 28
\begin{dmath}
{{\hat{Y}_{2}}}={{\hat{C}_{2 1}}}\, {{\theta_{C21}}}+{{\hat{C}_{2 2}}}\, {{\theta_{C22}}}+{{\hat{I}_{2}}}\, \left(1-{{\theta_{C21}}}-{{\theta_{C22}}}\right)
\end{dmath}
% Equation 29
\begin{dmath}
