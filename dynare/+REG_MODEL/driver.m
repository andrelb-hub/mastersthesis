...
M_.param_names(8) = {'thetaC11'};
M_.param_names_tex(8) = {'{\theta_{C11}}'};
M_.param_names_long(8) = {'weight of good 1 in demand of region 1'};
M_.param_names(9) = {'thetaC12'};
M_.param_names_tex(9) = {'{\theta_{C12}}'};
M_.param_names_long(9) = {'weight of good 2 in demand of region 1'};
M_.param_names(10) = {'thetaC21'};
M_.param_names_tex(10) = {'{\theta_{C21}}'};
M_.param_names_long(10) = {'weight of good 1 in demand of region 2'};
M_.param_names(11) = {'thetaC22'};
M_.param_names_tex(11) = {'{\theta_{C22}}'};
M_.param_names_long(11) = {'weight of good 2 in demand of region 2'};
M_.param_names(12) = {'thetaPY1'};
M_.param_names_tex(12) = {'{\theta_{PY1}}'};
M_.param_names_long(12) = {'weight of region 1 in gross domestic product'};
M_.param_names(13) = {'thetaY1'};
M_.param_names_tex(13) = {'{\theta_{Y1}}'};
M_.param_names_long(13) = {'weight of region 1 in total production'};
M_.param_names(14) = {'rhoA1'};
M_.param_names_tex(14) = {'{\rho_{A1}}'};
M_.param_names_long(14) = {'autoregressive parameter of productivity in region 1'};
M_.param_names(15) = {'rhoA2'};
M_.param_names_tex(15) = {'{\rho_{A2}}'};
M_.param_names_long(15) = {'autoregressive parameter of productivity in region 2'};
M_.param_names(16) = {'rhoM'};
M_.param_names_tex(16) = {'{\rho_{M}}'};
M_.param_names_long(16) = {'autoregressive parameter of monetary policy'};
M_.param_names(17) = {'siggma'};
M_.param_names_tex(17) = {'{\sigma}'};
M_.param_names_long(17) = {'relative risk aversion coefficient'};
M_.param_names(18) = {'phhi'};
M_.param_names_tex(18) = {'{\phi}'};
M_.param_names_long(18) = {'relative labor weight in utility'};
M_.param_names(19) = {'varphhi'};
M_.param_names_tex(19) = {'{\varphi}'};
M_.param_names_long(19) = {'marginal disutility of labor supply'};
M_.param_names(20) = {'pssi'};
M_.param_names_tex(20) = {'{\psi}'};
M_.param_names_long(20) = {'elasticity of substitution between intermediate goods'};
M_.param_names(21) = {'omega11'};
M_.param_names_tex(21) = {'{\omega_{11}}'};
M_.param_names_long(21) = {'weight of good 1 in consumption composition of region 1'};
M_.param_names(22) = {'omega21'};
M_.param_names_tex(22) = {'{\omega_{21}}'};
M_.param_names_long(22) = {'weight of good 1 in consumption composition of region 2'};
M_.param_names(23) = {'sigmaA1'};
M_.param_names_tex(23) = {'{\sigma_{A1}}'};
M_.param_names_long(23) = {'Standard Error of productivity shock 1'};
M_.param_names(24) = {'sigmaA2'};
M_.param_names_tex(24) = {'{\sigma_{A2}}'};
M_.param_names_long(24) = {'Standard Error of productivity shock 2'};
M_.param_names(25) = {'sigmaM'};
M_.param_names_tex(25) = {'{\sigma_M}'};
M_.param_names_long(25) = {'Standard Error of monetary shock'};
...
M_.mapping.Yt.eqidx = [23 25 26 ];
M_.mapping.Y1t.eqidx = [17 25 26 27 ];
M_.mapping.Y2t.eqidx = [18 25 26 28 ];
...
thetta = M_.params(7);
M_.params(8) = 0.85;
thetaC11 = M_.params(8);
M_.params(9) = 0.05;
thetaC12 = M_.params(9);
M_.params(10) = 0.25;
thetaC21 = M_.params(10);
M_.params(11) = 0.7;
thetaC22 = M_.params(11);
M_.params(12) = 0.6;
thetaPY1 = M_.params(12);
M_.params(13) = 0.6;
thetaY1 = M_.params(13);
M_.params(14) = 0.95;
rhoA1 = M_.params(14);
M_.params(15) = 0.95;
rhoA2 = M_.params(15);
...
phhi = M_.params(18);
M_.params(19) = 1.5;
varphhi = M_.params(19);
M_.params(20) = 8;
pssi = M_.params(20);
M_.params(21) = 0.8;
omega11 = M_.params(21);
M_.params(22) = 0.7;
omega21 = M_.params(22);
M_.params(23) = 0.01;
sigmaA1 = M_.params(23);
M_.params(24) = 0.01;
sigmaA2 = M_.params(24);
M_.params(25) = 0.01;
sigmaM = M_.params(25);
steady;
