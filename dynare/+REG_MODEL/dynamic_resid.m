...
residual(24) = lhs - rhs;
lhs = y(29);
rhs = y(30)*T(16)+y(31)*(1-T(16));
residual(25) = lhs - rhs;
lhs = y(20);
rhs = y(21)*T(16)+y(22)*(1-T(16));
residual(26) = lhs - rhs;
lhs = y(21);
rhs = y(12)*T(14)+y(14)*T(15)+y(23)*(1-T(14)-T(15));
residual(27) = lhs - rhs;
lhs = y(22);
rhs = y(13)*(1-params(15))*T(12)/T(11)+y(15)*(1-params(16))*T(13)/T(11)+y(24)*T(18);
residual(28) = lhs - rhs;
lhs = y(25);
