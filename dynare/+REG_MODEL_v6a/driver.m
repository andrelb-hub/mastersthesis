...
M_.endo_names(22) = {'lambdat'};
M_.endo_names_tex(22) = {'{\hat{\lambda}_{}}'};
M_.endo_names_long(22) = {'Marginal cost'};
...
M_.equations_tags = {
  ...
  4 , 'name' , 'Regional Consumption Weight' ;
  5 , 'name' , 'Regional Consumption of Good 1' ;
  6 , 'name' , '6' ;
  7 , 'name' , 'Region 1 Price Index' ;
  8 , 'name' , 'Labor Supply' ;
  9 , 'name' , '9' ;
  10 , 'name' , 'Region 1 Euler equation for the bonds return' ;
  11 , 'name' , 'Euler equation for regional consumption' ;
  12 , 'name' , 'Production Function' ;
  13 , 'name' , 'Y2t' ;
  14 , 'name' , 'Marginal Cost' ;
  15 , 'name' , '15' ;
  16 , 'name' , 'Monetary Policy' ;
  17 , 'name' , 'Market Clearing Condition' ;
  18 , 'name' , 'Regional Market Clearing Condition' ;
  19 , 'name' , '19' ;
  20 , 'name' , 'Productivity Shock' ;
  21 , 'name' , 'ZA2t' ;
  22 , 'name' , 'Monetary Shock' ;
};
M_.mapping.C1t.eqidx = [5 6 8 9 10 11 18 ];
M_.mapping.C2t.eqidx = [6 9 11 19 ];
M_.mapping.L1t.eqidx = [8 9 12 ];
M_.mapping.L2t.eqidx = [9 13 ];
M_.mapping.C11t.eqidx = [4 5 6 ];
M_.mapping.C21t.eqidx = [4 6 ];
M_.mapping.C12t.eqidx = [4 ];
M_.mapping.C22t.eqidx = [4 ];
M_.mapping.Yt.eqidx = [16 17 ];
M_.mapping.Y1t.eqidx = [12 17 18 ];
M_.mapping.Y2t.eqidx = [13 17 19 ];
M_.mapping.ZA1t.eqidx = [12 14 15 20 ];
M_.mapping.ZA2t.eqidx = [13 15 21 ];
M_.mapping.ZMt.eqidx = [16 22 ];
M_.mapping.Q1t.eqidx = [7 8 10 18 19 ];
M_.mapping.P1t.eqidx = [1 2 5 7 14 15 18 ];
M_.mapping.P2t.eqidx = [2 5 7 15 19 ];
M_.mapping.Rt.eqidx = [10 16 ];
M_.mapping.W1t.eqidx = [8 9 14 15 ];
M_.mapping.W2t.eqidx = [9 15 ];
M_.mapping.pit.eqidx = [1 3 16 ];
M_.mapping.lambdat.eqidx = [3 14 ];
M_.mapping.e_A1.eqidx = [20 ];
M_.mapping.e_A2.eqidx = [21 ];
M_.mapping.e_M.eqidx = [22 ];
...
options_.order = 1;
options_.qz_zero_threshold = 1e-20;
var_list_ = {'ZMt';'ZA1t';'Rt';'W1t';'C1t';'L1t';'Y1t';'P1t';'pit'};
...
save([M_.dname filesep 'Output' filesep 'REG_MODEL_v6a_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_v6a_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_v6a_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_v6a_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_v6a_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_v6a_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'REG_MODEL_v6a_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
