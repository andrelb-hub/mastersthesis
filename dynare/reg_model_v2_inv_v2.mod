...
% dynare reg_model_v2_inv_v2 savemacro=reg_model_v2_inv_ZM_v2.mod
...
thetaC11 % weight of C11 on Y1
thetaC21 % weight of C21 on Y1
thetaC12 % weight of C12 on Y2
thetaC22 % weight of C22 on Y2
;
...
# thetaC11 = C11ss / Y1ss ; % weight of C11 on Y1
# thetaC21 = C21ss / Y1ss ; % weight of C21 on Y1
# thetaC12 = C12ss / Y2ss ; % weight of C12 on Y2
# thetaC22 = C22ss / Y2ss ; % weight of C22 on Y2
...
Y1t = thetaC11 * C11t + thetaC21 * C21t + (1 - thetaC11 - thetaC21) * I1t;
Y2t = thetaC12 * C12t + thetaC22 * C22t + (1 - thetaC12 - thetaC22) * I2t;
