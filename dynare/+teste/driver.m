...
set_param_value('irf', nperiods); 
set_param_value('order', 1); 
set_param_value('qz_zero_threshold', 1e-20); 
...
options_.order = 1;
options_.qz_zero_threshold = 1e-20;
var_list_ = {'ZA1t';'Rt';'I1t';'I2t';'K1t';'K2t';'lambda1t';'lambda2t';'Yt';'Y1t';'Y2t';'C1t';'C2t';'C11t';'C21t';'C12t';'C22t';'L1t';'L2t';'W1t';'W2t';'P1t';'P2t';'Q1t';'Q2t';'pi1t';'pi2t';'pit';'ZMt';'ZA2t'};
