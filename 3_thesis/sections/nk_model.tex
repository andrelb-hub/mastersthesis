...
\subsection{Firms}
	...
	\footnotetext{the production technology level $Z_{At}$ will be submitted to a productivity shock, detailed in section \ref{sec_v0:productivity shock}.}
	...
	{\singlespacing
		...
		\begin{itemize}
			...
			\begin{enumerate}
				...
				% \item Marginal Rate of Substitution of Factors (\ref{eq_v0:int-good-firm-TMRS}):
	...
	\begin{enumerate}
		...
		\item Market Clearing Condition:
		\begin{align}
			\label{eq_v0:ss-market-clearing-condition}
			Y_t = C_t + I_t \implies Y = C + I
		\end{align}
		
		\item Monetary Policy:
		\begin{align}
			\label{eq_v0:ss-monetary-policy}
			\frac{R_t}{R} =
			\left( \frac{R_{t-1}}{R} \right)^{\gamma_R}  \left[
			\left( \frac{\pi_t}{\pi} \right)^{\gamma_\pi}
			\left( \frac{Y_t}{Y} \right)^{\gamma_Y} \right]^{1-\gamma_R} Z_{Mt}
		...
		\item Gross Inflation Rate:
		\begin{align}
			\label{eq_v0:ss-gross-inflation-rate}
		...
		\begin{alignat}{2}
			...
			\varepsilon_{A} &= 0 \label{eq_v0:ss-productivity-shock}
		\end{alignat}
		...
		\begin{alignat}{2}
			...
			\varepsilon_{M} &= 0 \label{eq_v0:ss-monetary-shock}
		\end{alignat}
	...
	{\singlespacing
		...
		\begin{itemize}
			...
			\begin{enumerate}
				...
				%	\begin{align}
					%		\hat{Y}_t &= \int_{0}^{1} \hat{Y}_{jt} \dif j 
					%		\tag{\ref{eq_v0:ll-final-good-firm-bundle-rule}}
					%	\end{align}
				...
				%	\begin{align}
					...
					%		\tag{\ref{eq_v0:ll-int-good-firm-FOC-Kt}}
					%	\end{align}
				%	
				%	\item Labor Demand:
				%	\begin{align}
					%		\hat{L}_t &= \hat{Y}_t + \hat{\Lambda}_t - \hat{W}_t
					%		\tag{\ref{eq_v0:ll-int-good-firm-FOC-Lt}}
					%	\end{align}
