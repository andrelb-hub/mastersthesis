...
\begin{align}
	...
	% \\ &\quad \mu_{\eta t} = \beta (1 + R_{t}) \E{ \mu_{\eta, t+1}} \label{ext-mod:reg-FOC-Bt}
	\\
...
\begin{align}
	...
	%\label{ext-mod:reg-int-good-firm-TC-MC} \\
...
\end{align}
	...
	\begin{align}
		...
		P_{t} &= \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t} %\label{ext-mod:reg-national-price-level}
	\end{align}
...
\begin{align}
	\ln{Z_{A\eta t}} = (1-\rho_{A\eta})\ln{Z_{A\eta}} + \rho_{A\eta}\ln{Z_{A\eta,t-1}} + \varepsilon_{A\eta t} \label{ext-mod:reg-productivity-shock}
\end{align}
...
\begin{align}
	\ln{Z_{Mt}} = (1-\rho_M)\ln{Z_{M}} + \rho_M\ln{Z_{M,t-1}} + \varepsilon_{Mt} \label{ext-mod:reg-monetary-shock}
\end{align}
...
\subsubsection{Equilibrium Conditions}
	...
	\begin{align}
		...
		% \\
		% & B_{1t} + B_{2t} = 0 \label{ext-mod:reg-market-clearing-condition-Bt}
	\end{align}
...
\begin{align}
	% Y_{t} &= Y_{1 t} + Y_{2 t} \label{ext-mod:reg-market-clearing-condition-Yt} \\
	& \text{where:} \quad Y_{\eta t} = C_{\eta 1 t} + C_{\eta 2 t} + I_{\eta t} % \label{ext-mod:reg-regional-demand} \\
	L_{\eta t} &= \int_{0}^{1} L_{\eta jt} \dif j % \label{ext-mod:reg-market-clearing-condition-Lt}
\end{align}
...
\end{comment}
		...
		\begin{align}
			P_{t} &= \frac{P_{1t} Y_{1t} + P_{2t} Y_{2t}}{Y_{t}} \tag{\ref{ext-mod:reg-national-price-level}} % P_{t} = \theta_{P1} P_{1t} + (1 -\theta_{P1}) P_{2t}
		\end{align}			
		\end{comment}
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{comment}
	...
	\item Law of Motion for Capital:
	\begin{align}
		K_{\eta, t+1} = (1-\delta)K_{\eta t} + I_{\eta t} \tag{\ref{ext-mod:reg-law-of-motion-for-capital}}
	\end{align}
	
	\item Regional Consumption of good 1:
	\begin{align}
		C_{\eta 1 t} &= Q_{\eta t} \frac{\omega_{\eta 1}}{P_{1 t}} \tag{\ref{ext-mod:reg-Cn-Cn-2}}
	\end{align}
	
	\item Regional Consumption of good 2:
	\begin{align}
		C_{\eta 2 t} &= Q_{\eta t} \frac{1 -\omega_{\eta 1}}{P_{2 t}} \tag{\ref{ext-mod:reg-Cn-Cv-2}}
	\end{align}
	
	\item Euler equation for the capital return:
	\begin{align}
		\frac{ C_{\eta t}^{1-\sigma}}{Q_{\eta t}} P_{\eta t} &= \beta \mathbb{E}_t \left\{ \frac{ C_{\eta, t+1}^{1-\sigma}}{Q_{\eta, t+1}} [(1-\delta) P_{\eta, t+1} + R_{K,t+1}] \right\} \tag{\ref{ext-mod:reg-capital-euler-equation}}
	\end{align}
	
	\item Capital Demand:
	\begin{align}
		K_{\eta jt} = {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{t}} \tag{\ref{ext-mod:reg-int-good-firm-FOC-Kt}}
	\end{align}
	
	
	\item Labor Demand:
	\begin{align}
		L_{\eta jt} = (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{\eta t}} \tag{\ref{ext-mod:reg-int-good-firm-prod-function}}
	\end{align}
...
\begin{enumerate}
	...
	\begin{comment}
		\item National Price Level:
		\begin{align}
			P_{} &= \frac{P_{1} Y_{1} + P_{2} Y_{2}}{Y_{}} \label{ext-mod:reg-ss-national-price-level} % P_{t} = \theta_{P1} P_{1} + (1 -\theta_{P1}) P_{2}
		\end{align}	
	\end{comment}
...
Isolate $C_{11}$ in \ref{ext-mod:reg-ss-C-eta-12-t} and substitute in \ref{ext-mod:reg-ss-consumption-aggregation}:
\begin{align}
	C_{11} &= C_{12} \frac{\omega_{11} P_{2}}{(1 - \omega_{11}) P_{1}} \tag{\ref{ext-mod:reg-ss-C-eta-12-t}} \\
	C_{1} &= C_{11}^{\omega_{11}} C_{12}^{1-\omega_{11}} = \left[ C_{12} \frac{\omega_{11} P_{2}}{(1 - \omega_{11}) P_{1}} \right]^{\omega_{11}} C_{12}^{1-\omega_{11}} \tag{\ref{ext-mod:reg-ss-consumption-aggregation}} \implies \\
	C_{12} &= C_{1} b_{1}^{\omega_{11}} \label{ext-mod:reg-ss-C12} \\
	& \text{where: } b_{1} = \left( \frac{1 - \omega_{11}}{\omega_{11} \theta_{P}} \right) \label{ext-mod:reg-ss-b1}
\end{align}

Substitute \ref{ext-mod:reg-ss-C12} and \ref{ext-mod:reg-ss-budget-constraint-4} in \ref{ext-mod:reg-ss-C-eta-12-t}:
\begin{align}
	C_{11} &= C_{12} \frac{\omega_{11} P_{2}}{(1 - \omega_{11}) P_{1}} = C_{1} \left( \frac{1 - \omega_{11}}{\omega_{11}} \right)^{\omega_{11}} \frac{\omega_{11} P_{2}}{(1 - \omega_{11}) P_{1}} \tag{\ref{ext-mod:reg-ss-C-eta-12-t}} \implies \\
	C_{11} &= C_{1} b_{1}^{\omega_{11} - 1} \label{ext-mod:reg-ss-C11}
\end{align}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Substitute \ref{ext-mod:reg-ss-C12} and \ref{ext-mod:reg-ss-C11} in \ref{ext-mod:reg-ss-C-12-12-t}:
\begin{align}
	\frac{C_{11} C_{22}}{C_{21} C_{12}} &= \frac{\omega_{11} (1 - \omega_{21})}{\omega_{21} (1 - \omega_{11})} \tag{\ref{ext-mod:reg-ss-C-12-12-t}} \implies \\
	C_{22} &= C_{21} \left( \frac{1 - \omega_{21}}{\omega_{21} \theta_{P}} \right) \label{ext-mod:reg-ss-C22}
\end{align}

Substitute \ref{ext-mod:reg-ss-C22} in \ref{ext-mod:reg-ss-consumption-aggregation}:
\begin{align}
	C_{2} &= C_{21}^{\omega_{21}} C_{22}^{1-\omega_{21}} = C_{21}^{\omega_{21}} \left[ C_{21} \left( \frac{1 - \omega_{21}}{\omega_{21} \theta_{P}} \right) \right]^{1-\omega_{21}} \tag{\ref{ext-mod:reg-ss-consumption-aggregation}} \implies \\
	C_{21} &= C_{2} b_{2}^{\omega_{21} - 1} \label{ext-mod:reg-ss-C21} \\
	& \text{where: } b_{2} = \left( \frac{1 - \omega_{21}}{\omega_{21} \theta_{P}} \right) \label{ext-mod:reg-ss-b2}
\end{align}
...
\begin{comment}
	...
	\begin{align}
		\frac{\mathbb{E}_{t} \left\{Q_{1, t+1} C_{1, t+1}^{\sigma} \right\}}{Q_{1t} C_{1t}^{\sigma}} &= \beta (1 + R_{t}) \tag{\ref{ext-mod:reg-capital-euler-equation}} \implies \\
		\hat{Q}_{1, t+1} - \hat{Q}_{1t} + \sigma (\hat{C}_{1, t+1} - \hat{C}_{1t}) &= (1 - \beta) \hat{R}_{t} \label{ext-mod:reg-bonds-euler-equation-ll}
	\end{align}

\subsubsection*{Euler equation for regional consumption}

Log-linearize \ref{ext-mod:reg-capital-euler-equation} and then substitute \ref{ext-mod:reg-total-expense-level-2-ll}:
\begin{align}
	& \frac{\mathbb{E}_{t} \left\{ Q_{1, t+1} C_{1, t+1}^{\sigma} \right\}}{Q_{1t} C_{1t}^{\sigma}} = \frac{\mathbb{E}_{t} \left\{ Q_{2, t+1} C_{2, t+1}^{\sigma} \right\}}{Q_{2t} C_{2t}^{\sigma}} \tag{\ref{ext-mod:reg-bonds-euler-equation-2}} \implies \\
	...
	& \hat{C}_{1, t+1} - \hat{C}_{1t} = \hat{C}_{2, t+1} - \hat{C}_{2t} \label{ext-mod:reg-bonds-euler-equation-2-ll}
\end{align}
...
\begin{align}
	...
	& \qquad = \beta \left[ (1-\delta) + \frac{R_{}}{P_{\eta}} \mathbb{E}_t \left\{ 1 + \hat{R}_{t+1} -\hat{P}_{\eta, t+1} \right\} \right] \implies \nonumber \\
	...
	& \qquad = \beta R_{} \mathbb{E}_t \left\{ \hat{R}_{t+1} - \hat{P}_{\eta, t+1} \right\} \label{ext-mod:reg-ll-capital-euler-equation} \\
...
\begin{alignat}{2}
	...
	\hat{Y}_{\eta jt} &= \hat{Z}_{A\eta t} + \hat{L}_{\eta jt} %\label{ext-mod:reg-ll-int-good-firm-production-function}
\end{alignat}	
...
\begin{comment}
	...
	Log-linearize \ref{ext-mod:reg-int-good-firm-FOC-Kt}:
	\begin{alignat}{2}
		K_{\eta jt} &= {\alpha_{\eta}} Y_{\eta jt} \frac{\Lambda_{\eta t}}{R_{t}} &\implies \tag{\ref{ext-mod:reg-int-good-firm-FOC-Kt}} \\
		K_{\eta j} (1+ \hat{K}_{\eta jt}) &= {\alpha_{\eta}} Y_{\eta j} \frac{\Lambda_{\eta}}{R_{}} (1+ \hat{Y}_{\eta jt} + \hat{\Lambda}_{\eta t} - \hat{R}_{t}) \quad &\implies \nonumber \\
		\hat{K}_{\eta jt} &= \hat{Y}_{\eta jt} + \hat{\Lambda}_{\eta t} - \hat{R}_{t} \nonumber
	\end{alignat}
	
	Integrate both sides and then substitute \ref{ext-mod:reg-ll-capital-clearing-condition} and \ref{ext-mod:reg-ll-final-goods-firm-bundle-rule}:
	\begin{alignat}{2}
		\int_{0}^{1} \hat{K}_{\eta jt} \dif j &= \int_{0}^{1} \left( \hat{Y}_{\eta jt} + \hat{\Lambda}_{\eta t} - \hat{R}_{t} \right) \dif j \quad &\implies \nonumber \\
		\hat{K}_{\eta t} &= \hat{Y}_{\eta t} + \hat{\Lambda}_{\eta t} - \hat{R}_{t} \label{ext-mod:reg-ll-int-good-firm-FOC-Kt}
	\end{alignat}
	...
	Log-linearize \ref{ext-mod:reg-int-good-firm-prod-function}:
	\begin{alignat}{2}
		L_{\eta jt} &= (1-\alpha_{\eta}) Y_{\eta jt} \frac{\Lambda_{\eta t}}{W_{\eta t}} &\implies \tag{\ref{ext-mod:reg-int-good-firm-prod-function}} \\
	...
	Integrate both sides and then substitute \ref{ext-mod:reg-ll-market-clearing-condition-Lt} and \ref{ext-mod:reg-ll-final-goods-firm-bundle-rule}:
	\begin{align}
		...
		\label{ext-mod:reg-ll-int-good-firm-FOC-Lt}
	\end{align}
	
	Subtract \ref{ext-mod:reg-ll-int-good-firm-FOC-Lt} from \ref{ext-mod:reg-ll-int-good-firm-FOC-Kt}:
	\begin{align}
		\hat{K}_{\eta t} - \hat{L}_{\eta t} &= \hat{Y}_{\eta t} + \hat{\Lambda}_{\eta t} - \hat{R}_{t} - (\hat{Y}_{\eta t} + \hat{\Lambda}_{\eta t} - \hat{W}_{\eta t}) \implies \nonumber \\
		\hat{K}_{\eta t} - \hat{L}_{\eta t} &= \hat{W}_{\eta t} - \hat{R}_{t} \label{ext-mod:reg-ll-int-good-firm-TMRS}
	\end{align}
...
\begin{align}
	...
	\hat{\Lambda}_{\eta t} &= {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} - \hat{Z}_{A\eta t} \label{ext-mod:reg-ll-int-good-firm-MC-2}
\end{align}

Substitute \ref{ext-mod:reg-hat-real-marginal-cost} in \ref{ext-mod:reg-ll-int-good-firm-MC-2}:
\begin{alignat}{2}
	\hat{\Lambda}_{\eta t} &= {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} - \hat{Z}_{A\eta t} &\implies \nonumber \\
	\hat{P}_{\eta t} + \hat{\lambda}_{\eta t} &= {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} - \hat{Z}_{A\eta t} &\implies \nonumber \\
	\hat{\lambda}_{\eta t} &= {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} - \hat{Z}_{A\eta t} - \hat{P}_{\eta t} \label{ext-mod:reg-ll-int-good-firm-MC-3}
\end{alignat}
...
\begin{alignat}{2}
	...
	& \Lambda (1+ \hat{\Lambda}_{\eta t}) = \nonumber \\ & \qquad = \frac{1}{Z_{A\eta}} \left( \frac{R_{}}{{\alpha_{\eta}}} \right)^{{\alpha_{\eta}}} \left( \frac{W}{1-\alpha_{\eta}} \right)^{1-\alpha_{\eta}} (1- \hat{Z}_{A\eta t} + {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} ) \implies \nonumber \\
	& \hat{\Lambda}_{\eta t} = {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} - \hat{Z}_{A\eta t} \label{ext-mod:reg-ll-int-good-firm-MC-2}
\end{alignat}
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black]
	...
	\begin{align}
		(\hat{K}_{1t} - \hat{L}_{1t}) - (\hat{K}_{2t} - \hat{L}_{2t}) &= (\hat{W}_{\eta t} - \hat{R}_{t}) - (\hat{W}_{\eta t} - \hat{R}_{t}) \implies \nonumber \\
...
\begin{comment}
	...
	Log-linearize \ref{ext-mod:reg-national-price-level}:
	\begin{alignat}{2}
		P_{t} Y_{t} &= P_{1t} Y_{1t} + P_{2t} Y_{2t} & \implies \tag{\ref{ext-mod:reg-national-price-level}} \\ 
		P Y (1 + \hat{P}_{t} + \hat{Y}_{t}) &= P_{1} Y_{1} (1 + \hat{P}_{1t} + \hat{Y}_{1t}) + P_{2} Y_{2} (1 + \hat{P}_{2t} + \hat{Y}_{2t}) &\implies \nonumber \\
		\hat{P}_{t} + \hat{Y}_{t} &= \frac{Y_{1}}{Y} (\hat{P}_{1t} + \hat{Y}_{1t}) + \frac{Y_{2}}{Y} (\hat{P}_{2t} + \hat{Y}_{2t}) \label{ext-mod:reg-ll-national-price-level}
	\end{alignat}	
	
	Substitute \ref{ext-mod:reg-ss-Y1-Y2-weight-in-Y} in \ref{ext-mod:reg-ll-national-price-level}:
	\begin{alignat}{2}
		\hat{P}_{t} + \hat{Y}_{t} &= \theta_{Y} (\hat{P}_{1t} + \hat{Y}_{1t}) + (1-\theta_{Y}) (\hat{P}_{2t} + \hat{Y}_{2t})  \label{ext-mod:reg-ll-national-price-level-2}
	\end{alignat}
	
	Subtract \ref{ext-mod:reg-ll-market-clearing-condition-Yt-3} from \ref{ext-mod:reg-ll-national-price-level-2}:
	\begin{alignat}{2}
		...
		\hat{P}_{t} &= \theta_{Y} \hat{P}_{1t} + (1-\theta_{Y}) \hat{P}_{2t} \label{ext-mod:reg-ll-national-price-level-3}
	\end{alignat}
...
\begin{align}
	Q_{\eta t} C_{\eta t} + B_{\eta t} &= (1 + R_{t-1}) B_{\eta,t-1} + P_{\eta t} \int_{0}^{1} Y_{\eta jt} \dif j \tag{\ref{ext-mod:reg-budget-constraint-3}} \implies \\
	\hat{P}_{\eta t} + \hat{Y}_{\eta t} &= \hat{Q}_{1t} + \hat{C}_{\eta t} \label{ext-mod:reg-budget-constraint-4}
\end{align}
	
Substitute \ref{ext-mod:reg-regional-demand-ll} in \ref{ext-mod:reg-regional-demand-ll-2}:
\begin{align}
	\hat{Q}_{1t} = \hat{B}_{\eta t} - \hat{C}_{\eta t} \label{ext-mod:reg-regional-demand-ll-3}
\end{align}

Equation \ref{ext-mod:reg-regional-demand-ll-3} demonstrates that the variation on the price level composition will affect the variation of consumption levels.

Log-linearize \ref{ext-mod:reg-regional-demand}:
\begin{align}
	Y_{\eta t} &= C_{\eta 1 t} + C_{\eta 2 t} + I_{\eta t} \implies \tag{\ref{ext-mod:reg-regional-demand}} \\
	Y_{\eta} (1 +\hat{Y}_{\eta t}) &= C_{\eta 1} (1 +\hat{C}_{\eta 1 t}) + C_{\eta 2} (1 +\hat{C}_{\eta 2 t}) + I_{\eta} (1 +\hat{I}_{\eta t}) \implies \nonumber \\
	\hat{Y}_{\eta t} &= \frac{C_{\eta 1}}{Y_{\eta}} \hat{C}_{\eta 1 t} + \frac{C_{\eta 2}}{Y_{\eta}} \hat{C}_{\eta 2 t} + \frac{I_{\eta}}{Y_{\eta}} \hat{I}_{\eta t} \label{ext-mod:reg-ll-total-yn}
\end{align}
...
\begin{align}
	\label{ext-mod:reg-ss-C-I-weight-in-Y}
...
Substitute \ref{ext-mod:reg-ss-C-I-weight-in-Y} in \ref{ext-mod:reg-ll-total-yn}:
\begin{align}
	\hat{Y}_{\eta t} &= \theta_{C\eta 1} \hat{C}_{\eta 1 t} + \theta_{C\eta 2} \hat{C}_{\eta 2 t} + (1 - \theta_{C\eta 1} - \theta_{C\eta 2}) \hat{I}_{\eta t} \label{ext-mod:reg-ll-total-yn-2}
\end{align}
...
{\singlespacing
	...
	\begin{itemize}
		...
		\begin{enumerate}
			...
			\begin{align}
				\hat{K}_{\eta t} - \hat{L}_{\eta t} &= \hat{W}_{\eta t} - \hat{R}_{t} \tag{\ref{ext-mod:reg-ll-int-good-firm-TMRS}}
			\end{align}
			
			\item Marginal Cost
			\begin{align}
				\hat{\lambda}_{\eta t} &= {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} - \hat{Z}_{A\eta t} - \hat{P}_{\eta t} \tag{\ref{ext-mod:reg-ll-int-good-firm-MC-3}}
			\end{align}
...
{\singlespacing
		...
		\begin{itemize}
			...
			\item Regional Gross Inflation Rate
			\begin{align}
				\hat{\pi}_{1t} &= \hat{P}_{1t} - \hat{P}_{1, t-1} \tag{\ref{ext-mod:level-dev-regional-inflation}a} \\
				\hat{\pi}_{2t} &= \hat{P}_{2t} - \hat{P}_{2, t-1} \tag{\ref{ext-mod:level-dev-regional-inflation}b}
			\end{align}
			
			\item New Keynesian Phillips Curve
			\begin{align}
				\hat{\pi}_{1 t} &= \beta \E \hat{\pi}_{1, t+1} + \frac{(1-\theta) (1- \theta \beta)}{\theta} \hat{\lambda}_{1 t} \tag{\ref{ext-mod:reg-nk-phillips-curve-mc}a} \\
				\hat{\pi}_{2 t} &= \beta \E \hat{\pi}_{2, t+1} + \frac{(1-\theta) (1- \theta \beta)}{\theta} \hat{\lambda}_{2 t} \tag{\ref{ext-mod:reg-nk-phillips-curve-mc}b}
			\end{align}
			
			\item Regional Consumption Weight
			\begin{align}
				\hat{C}_{1 2t} - \hat{C}_{1 1t} &= \hat{P}_{1t} - \hat{P}_{2t} \tag{\ref{ext-mod:reg-C-eta-12-t-ll}a} \\
				\hat{C}_{2 2t} - \hat{C}_{2 1t} &= \hat{P}_{1t} - \hat{P}_{2t} \tag{\ref{ext-mod:reg-C-eta-12-t-ll}b}
			\end{align}
			
			\item Regional Consumption of Good 1
			\begin{align}
				\hat{C}_{1 t} - \hat{C}_{1 1 t} &= (1 - \omega_{1 1}) (\hat{P}_{1t} - \hat{P}_{2t}) \tag{\ref{ext-mod:reg-C-eta-1-t-ll}a} \\
				\hat{C}_{2 t} - \hat{C}_{2 1 t} &= (1 - \omega_{2 1}) (\hat{P}_{1t} - \hat{P}_{2t}) \tag{\ref{ext-mod:reg-C-eta-1-t-ll}b}
			\end{align}
			
			\item Region 1 Price Index
			\begin{align}
				\hat{Q}_{1t} &= \omega_{11} \hat{P}_{1 t} + (1 -\omega_{11}) \hat{P}_{2 t} \tag{\ref{ext-mod:reg-total-expense-level-ll}}
			\end{align}
			
			\item Labor Supply
			\begin{alignat}{2}
				\varphi \hat{L}_{1 t} + \sigma \hat{C}_{1 t} &= \hat{W}_{1 t} - \hat{Q}_{1t} \tag{\ref{ext-mod:reg-ll-labor-supply}a} \\
				\varphi \hat{L}_{2 t} + \sigma \hat{C}_{2 t} &= \hat{W}_{2 t} - \hat{Q}_{1t} \tag{\ref{ext-mod:reg-ll-labor-supply}b}
			\end{alignat}
			...
			\item Production Function
			\begin{align}
				\hat{Y}_{1 t} &= \hat{Z}_{A1 t} + \hat{L}_{1 t} \tag{\ref{ext-mod:reg-ll-final-goods-firm-bundle-rule-3}a} \\
				\hat{Y}_{2 t} &= \hat{Z}_{A2 t} + \hat{L}_{2 t} \tag{\ref{ext-mod:reg-ll-final-goods-firm-bundle-rule-3}b} 
			\end{align}
			
			\item Marginal Cost
			\begin{align}
				\hat{P}_{1 t} + \hat{\lambda}_{1 t} &= \hat{W}_{1 t} - \hat{Z}_{A1 t} \tag{\ref{ext-mod:reg-int-good-firm-FOC-Lt-ll}a} \\
				\hat{P}_{2 t} + \hat{\lambda}_{2 t} &= \hat{W}_{2 t} - \hat{Z}_{A2 t} \tag{\ref{ext-mod:reg-int-good-firm-FOC-Lt-ll}b}
			\end{align}
			...
			\item Productivity Shock
			\begin{alignat}{2}
				\hat{Z}_{A1 t} &= \rho_{A1} \hat{Z}_{A1, t-1} + \varepsilon_{A1} \tag{\ref{ext-mod:reg-ll-productivity-shock}a} \\
				\hat{Z}_{A2 t} &= \rho_{A2} \hat{Z}_{A2, t-1} + \varepsilon_{A2} \tag{\ref{ext-mod:reg-ll-productivity-shock}b}
			\end{alignat}
			...
			\begin{align}
				\hat{P}_{1 t} + \hat{Y}_{1 t} &= \hat{Q}_{1t} + \hat{C}_{1 t} \tag{\ref{ext-mod:reg-regional-demand-ll}a} \\
				\hat{P}_{2 t} + \hat{Y}_{2 t} &= \hat{Q}_{1t} + \hat{C}_{2 t} \tag{\ref{ext-mod:reg-regional-demand-ll}b}
			\end{align}
...
\begin{comment}
	...
	\subsubsection{Equations with $\eta$}
		...
		\begin{enumerate}
			...
			\begin{alignat}{2}
				\E \left\{ \hat{\mathscr{E}}_{\eta, t+1} - \hat{P}_{\eta, t+1}  - (1 -\sigma) \hat{C}_{\eta, t+1} \right\} - (\hat{\mathscr{E}}_{\eta t} - \hat{P}_{\eta t} - (1 -\sigma) \hat{C}_{\eta t}) = \nonumber \\
				\qquad = \beta \frac{R_{}}{P_{\eta}} \mathbb{E}_t \left\{ \hat{R}_{t+1} - \hat{P}_{\eta, t+1} \right\}
			\end{alignat}
			...
			\begin{align}
				\hat{K}_{\eta t} - \hat{L}_{\eta t} = \hat{W}_{\eta t} - \hat{R}_{t}
			\end{align}
			
			\item Marginal Cost
			\begin{alignat}{2}
				\hat{\lambda}_{\eta t} = {\alpha_{\eta}} \hat{R}_{t} + (1- {\alpha_{\eta}}) \hat{W}_{\eta t} - \hat{Z}_{A\eta t} - \hat{P}_{\eta t}
			\end{alignat}
