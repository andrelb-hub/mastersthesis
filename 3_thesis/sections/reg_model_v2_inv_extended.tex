...
\begin{comment}
	...
	\begin{alignat}{2}
		...
		K_{\eta j} (1+ \hat{K}_{\eta jt}) &= {\alpha_{\eta}} Y_{\eta j} \frac{\Lambda_{\eta}}{R_{}} (1+ \hat{Y}_{\eta jt} + \hat{\Lambda}_{\eta t} - \hat{R}_{K t}) \quad &\implies \nonumber \\
	...
	\begin{alignat}{2}
		...
		\hat{K}_{\eta t} &= \hat{Y}_{\eta t} + \hat{\Lambda}_{\eta t} - \hat{R}_{K t} \label{ext-mod:reg-ll-int-good-firm-FOC-Kt}
	\end{alignat}
...
\begin{comment}
	...
	\subsubsection{Equations with $\eta$}
		...
		\begin{enumerate}
			...
			\begin{alignat}{2}
				\E \left\{ \hat{\mathscr{E}}_{\eta, t+1} - \hat{P}_{\eta, t+1}  - (1 -\sigma) \hat{C}_{\eta, t+1} \right\} - (\hat{\mathscr{E}}_{\eta t} - \hat{P}_{\eta t} - (1 -\sigma) \hat{C}_{\eta t}) = \nonumber \\
				\qquad = \beta \frac{R_{}}{P_{\eta}} \mathbb{E}_t \left\{ \hat{R}_{K, t+1} - \hat{P}_{\eta, t+1} \right\}
			\end{alignat}
